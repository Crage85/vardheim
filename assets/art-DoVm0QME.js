...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function os(e,t,n){return new ba({name:`SphericalGaussianBlur`,defines:{SAMPLES:Go,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:ls(),fragmentShader:`
	...
	`}var us=class extends Mt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
#endif`)}var Ou=null;function ku(){return Ou||(Ou=new wa,Ou.onBeforeCompile=Du,Ou.customProgramCacheKey=()=>`voxel-character-depth`),Ou}var Au=.32,ju=.12;function Mu(e,t,n=null){let r=new Sa({vertexColors:!0,roughness:.8,metalness:.05});r.emissive.setRGB(t,t,t);let i=new G(n??0);return r.onBeforeCompile=t=>{Du(t),t.uniforms.uGlow={value:e},t.uniforms.uStatus={value:i},t.uniforms.uStatusMix={value:n===null?0:Au},t.uniforms.uStatusGlow={value:n===null?0:ju},t.vertexShader=`attribute float glow;
varying float vGlow;
varying vec3 vGrain;
...
`+t.fragmentShader.replace(`#include <color_fragment>`,`#include <color_fragment>
	...
	totalEmissiveRadiance += glowColor * vGlow * uGlow + uStatus * uStatusGlow;`)},r.customProgramCacheKey=()=>`voxel-character-glow`,r}var Nu=new Map;function Pu(e=null){let t=e??-1,n=Nu.get(t);return n||(n={base:Mu(1,0,e),charged:Mu(2.2,0,e),flashHot:Mu(2,.55,e),flashWarm:Mu(1.5,.25,e)},Nu.set(t,n)),n}var Fu=[0,16,28];function Iu(e){let t=e.rig,n=(e,t=1)=>new V(e[0]*t,e[1],e[2]),r=Array(17),i=Array(17),a=(e,t,n)=>{r[e]=n,i[e]=t};a(J.body,-1,new V),a(J.hips,J.body,n(t.hips)),a(J.torso,J.hips,n(t.torso)),a(J.head,J.torso,n(t.head)),a(J.armL,J.torso,n(t.shoulder)),a(J.armR,J.torso,n(t.shoulder,-1)),a(J.foreL,J.armL,new V(0,-t.upperLen,0)),a(J.foreR,J.armR,new V(0,-t.upperLen,0)),a(J.thighL,J.hips,n(t.hip)),a(J.thighR,J.hips,n(t.hip,-1)),a(J.shinL,J.thighL,new V(0,-t.thighLen,0)),a(J.shinR,J.thighR,new V(0,-t.thighLen,0));let o=e.carry;a(J.weapon,J.torso,new V(o[0],o[1],o[2])),a(J.extra,J.weapon,t.extra?n(t.extra):new V),a(J.cape,J.torso,t.cape?n(t.cape):new V);let s=t.bowString;return a(J.stringT,J.weapon,s?new V(0,s.half,s.z):new V),a(J.stringB,J.weapon,s?new V(0,-s.half,s.z):new V),{rest:r,parent:i}}var Lu=new Map;function Ru(e,t){let n=`${e.kind}:${t}`,r=Lu.get(n);if(r)return r;let{rest:i,parent:a}=Iu(e),o=[];for(let e=0;e<17;e++)o[e]=i[e].clone(),a[e]>=0&&o[e].add(o[a[e]]);let s=[],c=[];for(let n of Xl){Ql(n);let r=new lu;for(let{bone:n,part:i}of e.parts(t)){let e=o[J[n]];r.add(i,J[n],e.x,e.y,e.z)}s.push(r.build()),c.push(r.idx.length/3)}return Ql(Yl),r={def:e,geometries:s,rest:i,parent:a,inverses:o.map(e=>new W().makeTranslation(-e.x,-e.y,-e.z)),triangles:c},Lu.set(n,r),r}var zu=new V(0,-1,0),Bu=new V,Vu=new V,Hu=new V,Uu=new V,Wu=new V,Gu=new pt,Ku=new pt,qu=new pt,Ju=[.75,-.6,-.45],Yu=[-.75,-.6,-.45],Xu=0,Zu=class{root=new ln;kind;height;def;bones=[];meshes=[];skeleton;rest;scaleVar;ctx;state=`idle`;loop=`idle`;speed=1;rate=1;t=0;clock=0;phase=0;flash=0;status=null;groundSpeed=null;dead=!1;blend=1;blendDur=.2;from=new Float32Array(45);cur=new Float32Array(45);out=new Float32Array(45);muzzleBone;muzzleLocal;constructor(e,t){this.def=e,this.kind=e.kind;let n=Ru(e,t.tint??e.defaultTint);this.rest=n.rest;let r=Xu++,i=(r*.6180339887%1+1)%1;this.ctx={seed:i,flip:1},this.scaleVar=e.kind.startsWith(`warden`)?1:.95+.1*((r*.7548776662%1+1)%1),this.height=e.height*this.scaleVar;for(let e=0;e<17;e++){let t=new vi;t.position.copy(n.rest[e]),this.bones.push(t)}for(let e=0;e<17;e++){let t=n.parent[e];t>=0&&this.bones[t].add(this.bones[e])}let a=Pu();this.skeleton=new Si(this.bones,n.inverses),this.root.add(this.bones[J.body]);let o=new Vr;n.geometries.forEach((e,t)=>{let n=new _i(e,a.base);n.castShadow=!0,n.receiveShadow=!0,n.customDepthMaterial=ku(),n.boundingSphere=new ar(new V(0,this.height*.5,0),this.height*1.15),n.bind(this.skeleton,new W),o.addLevel(n,Fu[t],.1),this.meshes.push(n)}),this.root.add(o),this.muzzleBone=this.bones[e.muzzle.bone===`extra`?J.extra:J.weapon],this.muzzleLocal=new V(...e.muzzle.p),Eu(e,`idle`,`idle`,0,0,0,this.ctx,this.out),this.from.set(this.out),this.apply(this.out)}play(e,t=1){if(!this.dead){if(e===`idle`||e===`walk`||e===`run`){if(this.speed=t,e===this.loop)return;this.loop=e,(this.state===`idle`||this.state===`walk`||this.state===`run`)&&this.startBlend(e,.22);return}this.rate=e===`attack`||e===`reload`?t:1,e===`hit`&&(this.flash=.14,this.ctx.flip=-this.ctx.flip),e===`death`&&(this.dead=!0,this.ctx.flip=this.ctx.seed<.6?1:-1),this.startBlend(e,e===`hit`?.04:e===`death`?.1:.07),this.t=0}}setStatusTint(e){this.status=e}setGroundSpeed(e){this.groundSpeed=e}cycleLength(){let e=this.def.rig,t=this.def.loco,n=(e.hips[1]+e.hip[1])*this.scaleVar*this.root.scale.y;return Math.max(.1,4*n*Math.sin(this.loop===`run`?t.runStride:t.stride))}reset(){this.dead=!1,this.loop=`idle`,this.state=`idle`,this.t=0,this.flash=0,Eu(this.def,`idle`,`idle`,0,this.clock,0,this.ctx,this.out),this.blend=1,this.apply(this.out)}startBlend(e,t){this.from.set(this.out),this.state=e,this.blend=0,this.blendDur=t}update(e){let t=this.def;if(this.clock+=e,this.loop!==`idle`&&!this.dead){let n=this.loop===`run`?t.loco.runHz:t.loco.walkHz,r=this.groundSpeed===null?n*this.speed:this.groundSpeed/this.cycleLength();this.phase=((this.phase+e*r)%1+1)%1}if(this.state!==`idle`&&this.state!==`walk`&&this.state!==`run`){this.t+=e*this.rate;let n=yu(t,this.state);this.t>=n&&(this.state===`death`?this.t=n:this.startBlend(this.loop,.22))}this.flash>0&&(this.flash-=e),Eu(t,this.state,this.loop,this.t,this.clock,this.phase,this.ctx,this.cur),this.blend=Math.min(1,this.blend+e/this.blendDur);let n=mu(this.blend),r=this.out,i=this.from,a=this.cur;for(let e=0;e<45;e++)r[e]=i[e]+(a[e]-i[e])*n;this.apply(r);let o=Pu(this.dead?null:this.status),s=this.flash>.07?o.flashHot:this.flash>0?o.flashWarm:r[Y.glow]>.5?o.charged:o.base;for(let e=0;e<this.meshes.length;e++)this.meshes[e].material=s}apply(e){let t=this.bones,n=this.rest,r=this.scaleVar;t[J.body].position.set(e[Y.bX],e[Y.bY],e[Y.bZ]),t[J.body].rotation.set(e[Y.bRX],e[Y.bRY],e[Y.bRZ]);let i=e[Y.bS];t[J.body].scale.set(r/Math.sqrt(i),r*i,r/Math.sqrt(i)),t[J.hips].position.set(n[J.hips].x+e[Y.hX],n[J.hips].y+e[Y.hY],n[J.hips].z+e[Y.hZ]),t[J.hips].rotation.set(e[Y.hRX],e[Y.hRY],e[Y.hRZ]),t[J.torso].rotation.set(e[Y.tRX],e[Y.tRY],e[Y.tRZ]),t[J.head].rotation.set(e[Y.nRX],e[Y.nRY],e[Y.nRZ]),t[J.armL].rotation.set(e[Y.aLX],e[Y.aLY],e[Y.aLZ]),t[J.foreL].rotation.set(e[Y.fL],0,0),t[J.armR].rotation.set(e[Y.aRX],e[Y.aRY],e[Y.aRZ]),t[J.foreR].rotation.set(e[Y.fR],0,0),t[J.thighL].rotation.set(e[Y.lLX],0,e[Y.lLZ]),t[J.shinL].rotation.set(e[Y.kL],0,0),t[J.thighR].rotation.set(e[Y.lRX],0,e[Y.lRZ]),t[J.shinR].rotation.set(e[Y.kR],0,0),t[J.weapon].position.set(e[Y.wX],e[Y.wY],e[Y.wZ]),t[J.weapon].rotation.set(e[Y.wRX],e[Y.wRY],e[Y.wRZ]),t[J.extra].position.set(n[J.extra].x,n[J.extra].y,n[J.extra].z+e[Y.xZ]),t[J.extra].scale.setScalar(Math.max(1e-4,e[Y.xS])),t[J.cape].rotation.set(e[Y.cape],0,0);let a=this.def.rig.bowString;if(a){let n=e[Y.xS]>.01?e[Y.xZ]:0,r=Math.hypot(a.half,n);t[J.stringT].rotation.x=Math.atan2(-n,a.half),t[J.stringB].rotation.x=Math.atan2(n,a.half),t[J.stringT].scale.y=t[J.stringB].scale.y=r/a.half}let o=this.def;o.gripL&&e[Y.ikL]>.001&&this.ik(1,o.gripL,e[Y.ikL],o.poleL??Ju,!1),o.gripR&&e[Y.ikR]>.001&&this.ik(-1,o.gripR,e[Y.ikR],o.poleR??Yu,o.gripROnExtra===!0)}ik(e,t,n,r,i){let a=this.def,o=this.bones[e>0?J.armL:J.armR],s=this.bones[e>0?J.foreL:J.foreR],c=this.bones[J.weapon];if(Bu.set(t[0],t[1],t[2]),i){let e=this.bones[J.extra];e.updateMatrix(),Bu.applyMatrix4(e.matrix)}c.updateMatrix(),Bu.applyMatrix4(c.matrix);let l=a.rig.upperLen,u=a.rig.handLen;Vu.subVectors(Bu,o.position);let d=Vu.length();if(d<1e-5)return;Vu.divideScalar(d),d=Math.min(Math.max(d,Math.abs(l-u)+.01),(l+u)*.999);let f=Math.min(1,Math.max(-1,(l*l+d*d-u*u)/(2*l*d))),p=Math.sqrt(1-f*f);Hu.set(r[0],r[1],r[2]).addScaledVector(Vu,-Hu.dot(Vu)).normalize(),Uu.copy(o.position).addScaledVector(Vu,l*f).addScaledVector(Hu,l*p),Wu.subVectors(Uu,o.position).divideScalar(l),Gu.setFromUnitVectors(zu,Wu),Wu.copy(o.position).addScaledVector(Vu,d).sub(Uu).normalize(),qu.copy(Gu).invert(),Wu.applyQuaternion(qu),Ku.setFromUnitVectors(zu,Wu),n>=.999?(o.quaternion.copy(Gu),s.quaternion.copy(Ku)):(o.quaternion.slerp(Gu,n),s.quaternion.slerp(Ku,n))}getMuzzleWorldPosition(e){return this.muzzleBone.updateWorldMatrix(!0,!1),e.copy(this.muzzleLocal).applyMatrix4(this.muzzleBone.matrixWorld)}dispose(){this.root.removeFromParent(),this.skeleton.dispose()}};function Qu(e,t={}){return new Zu(e,t)}function $u(e){return Ru(e,e.defaultTint).triangles}var $={steel:11845578,steelDark:8358809,steelShadow:6121591,mail:8358810,white:15265007,cloth:4550815,gold:14068028,goldDark:10648100,skin:15253402,beard:10250806,fur:14341318,runeBlue:7329535|eu,runeBlueHot:12120319|eu,timber:8016433,timberDark:5716514,leather:7031343,leatherDark:4862498,sole:3024160,iron:5593439,ironDark:3948357,ironLight:9080726,rust:8210986,bone:14866620,bronze:10250286,bronzeLight:13209930,boneDark:12102538,charcoal:2762276,hideGrunt:7115584,hideBrute:4481082,hideArcher:8033352,hideShaman:8227932,hideChief:5929536,corrupt:4925014,corruptDeep:3414590,acid:9240378|eu,eyeRed:16726818|eu,clothRed:8006693,clothBrown:7166530,robe:6957614,fletch:10695723},ed={hips:[0,.96,0],torso:[0,.1,0],head:[0,.46,.01],shoulder:[.215,.37,0],upperLen:.28,handLen:.28,hip:[.1,-.03,0],thighLen:.44,cape:[0,.4,-.13]},td=4937059,nd=(e,t,n)=>Math.floor(n/Zl)&1?e:t;function rd(e){let t=X(e,.72),n=[],r=new Z;r.rbox(0,-.02,0,.165,.11,.12,3,$.cloth),r.tubeY(0,0,-.16,.02,.18,.135,1.1,(e,t)=>nd($.mail,X($.mail,.82),t)),r.tubeY(0,0,0,.08,.185,.14,1,$.leather),r.box(-.04,0,.12,.04,.08,.16,$.gold),r.box(-.1,-.34,.12,.1,0,.17,(t,n)=>n<-.3||Math.abs(t)>.075?$.gold:Math.abs(t)<.03?e:$.white),r.box(-.1,-.3,-.17,.1,0,-.12,(e,t)=>t<-.26||Math.abs(e)>.075?$.gold:$.white),n.push({bone:`hips`,part:r});let i=new Z;i.rbox(0,.1,0,.16,.12,.115,2.4,$.cloth),i.rbox(0,.25,.005,.2,.165,.14,2.6,$.steel),i.fill(-.3,.02,-.3,.3,.3,.3,()=>!0,(t,n,r)=>{if(n>.27)return $.gold;if(r>.08){let r=Math.hypot(t,n-.17);if(r<.045)return e;if(r<.075)return $.gold}return $.white},`paint`),i.box(-.02,.15,.13,.02,.19,.18,$.runeBlue,`paint`),i.fill(-.3,.02,-.3,.3,.44,.3,e=>Math.abs(e)>.17,$.steelDark,`paint`),i.tubeY(0,0,.36,.45,.095,.085,.95,$.steelDark),i.tubeY(0,0,.4,.44,.1,.09,1,$.gold),i.ell(0,.4,-.08,.17,.055,.075,(e,t,n)=>X($.fur,.9+.2*ou(e*50|0,t*50|0,n*50|0)));for(let e of[1,-1]){let t=.235*e;i.fill(t-.12,.28,-.13,t+.12,.45,.13,(e,n,r)=>{let i=(e-t)/.1,a=(n-.35)/.08,o=r/.11;return i*i+a*a+o*o<=1},(e,t)=>t<.31?$.gold:$.steel),i.fill(t-.12,.25,-.12,t+.12,.3,.12,(e,n,r)=>{let i=(e-t*1.06)/.1,a=r/.11;return i*i+a*a<=1&&n>.25},$.steelDark,`under`),i.box(.2*e-.02,.4,.09,.2*e+.02,.44,.13,$.gold,`paint`)}n.push({bone:`torso`,part:i});let a=new Z;a.ell(0,.13,.01,.11,.13,.115,$.skin),a.ell(0,.045,.06,.085,.075,.072,$.beard),a.seg(0,.01,.1,0,-.08,.11,.03,.02,(e,t)=>Math.abs(t+.05)<.015?$.gold:$.beard),a.box(-.055,.075,.1,.055,.1,.155,X($.beard,1.1)),a.fill(-.2,0,-.2,.2,.32,.2,(e,t,n)=>{let r=e/.134,i=(t-.15)/.155,a=(n-.005)/.134;return r*r+i*i+a*a>1?!1:t<.1?n<0:!0},(e,t,n)=>{if(t<.1)return Math.floor(t/Zl)&1?$.mail:X($.mail,.85);if(t<.2&&n>.06){let n=Math.abs(Math.abs(e)-.048),r=t-.15;return n<.022&&Math.abs(r)<.018?Math.abs(n)<.012?$.runeBlue:1844275:$.steelDark}return t<.23?$.gold:$.steel}),a.box(-.015,.08,.12,.015,.2,.155,$.steelDark),a.ell(0,.3,-.01,.03,.06,.13,(n,r,i)=>r>.33||i<-.1?e:t),n.push({bone:`head`,part:a});for(let e of[`L`,`R`]){let t=new Z;t.tubeY(0,0,-.28,.02,.058,.06,1,(e,t)=>nd($.mail,X($.mail,.85),t)),n.push({bone:e===`L`?`armL`:`armR`,part:t});let r=new Z;r.ell(0,-.01,0,.055,.05,.055,$.mail),r.tubeY(0,0,-.2,0,.058,.062,1.2,(e,t)=>t>-.05?$.gold:$.steel),r.rbox(0,-.26,.01,.048,.065,.052,2.5,$.leather),n.push({bone:e===`L`?`foreL`:`foreR`,part:r})}for(let e of[`L`,`R`]){let t=new Z;t.tubeY(0,0,-.44,.04,.082,.088,1.2,$.cloth),t.ell(0,-.43,.035,.06,.065,.05,$.steel),n.push({bone:e===`L`?`thighL`:`thighR`,part:t});let r=new Z;r.tubeY(0,0,-.36,0,.066,.07,1.1,$.steel),r.box(-.02,-.34,.05,.02,-.02,.09,$.gold,`paint`),r.rbox(0,-.425,.03,.068,.075,.115,3,$.leatherDark),r.box(-.08,-.5,-.1,.08,-.46,.15,$.sole,`paint`),r.tubeY(0,0,-.37,-.32,.078,.082,1,$.fur),n.push({bone:e===`L`?`shinL`:`shinR`,part:r})}let o=new Z;o.fill(-.3,-.98,-.12,.3,0,.02,(e,t,n)=>{let r=.15+.11*Math.min(1,-t/.9);if(Math.abs(e)>r)return!1;let i=e/r*-.1*(e/r)-.02*-t;return n>i-.045&&n<=i+.001},(n,r)=>r<-.92?$.gold:Math.abs(n)%.08<.04?e:t),n.push({bone:`cape`,part:o});let s=new Z;return s.jitter=.05,s.rbox(0,-.035,-.22,.028,.06,.15,3,(e,t,n)=>n<-.34||Math.abs(n+.2)<.02?$.gold:$.timberDark),s.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),s.rbox(0,.015,.09,.038,.045,.14,3,(e,t,n)=>t>.045||Math.abs(n-.09)>.12?$.gold:td),s.tubeZ(0,.03,.2,.64,.026,.026,1,(e,t,n)=>Math.abs((n-.3)%.15)<.03?$.gold:X(td,.85)),s.box(-.012,.06,-.02,.012,.085,.2,(e,t,n)=>Math.floor(n/Zl)&1?$.runeBlue:$.gold),s.box(-.018,-.06,.2,.018,0,.34,$.timber),s.rbox(0,.03,.66,.042,.042,.03,3,$.gold),s.ell(0,.03,.715,.028,.028,.035,$.runeBlueHot),n.push({bone:`weapon`,part:s}),n}var id=[-.13,.31,.12,0,.05,0];function ad(e,t){let n=hu(Q(t,0,.06));_u(e,id,n),e[Y.nRX]+=.08*n,e[Y.tRY]+=.1*n;let r=gu(t,.02,.05,.26);e[Y.wZ]-=.075*r,e[Y.wRX]-=.32*fu(r),e[Y.tRX]-=.07*r,e[Y.tRY]+=.05*r,e[Y.nRX]-=.05*r,e[Y.hZ]-=.015*r,e[Y.cape]+=.08*r}function od(e,t){let n=hu(Q(t,0,.18))*(1-hu(Q(t,.82,1)));e[Y.wRZ]+=.75*n,e[Y.wRX]+=.35*n,e[Y.wY]-=.05*n,e[Y.wZ]-=.04*n,e[Y.nRX]+=.28*n,e[Y.tRX]+=.06*n;let r=gu(t,.2,.42,.72);e[Y.ikL]*=1-r,e[Y.aLX]+=.5*r,e[Y.fL]-=.6*r;let i=gu(t,.7,.74,.86);e[Y.wY]+=.03*i,e[Y.wRX]-=.12*i}var sd={kind:`warden`,defaultTint:4165600,height:1.8,rig:ed,parts:rd,hunch:.04,stance:.06,loco:{walkHz:.95,runHz:1.4,stride:.45,runStride:.8,knee:.75,runKnee:1.35,bob:.03,armSwing:.35,lean:.2},carry:[-.14,.12,.2,-.8,.58,0],drop:[-.36,.12,0,-1.57,0,0],carryRun:[-.12,.16,.17,-.95,.68,0],gripR:[0,-.05,0],gripL:[0,-.03,.27],poleL:[.4,-1,-.2],poleR:[-.9,-.6,-.4],muzzle:{bone:`weapon`,p:[0,.03,.76]},attackDur:.34,attack:ad,reload:od,deathDepth:.14},cd=16752714|eu,ld=.58;function ud(e){let t=rd(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.05,n.rbox(0,-.04,-.2,.032,.066,.13,3,(e,t,n)=>n<-.3?$.gold:$.timberDark);for(let e=0;e<3;e++)n.box(.03,-.06+e*.035,-.26,.045,-.035+e*.035,-.14,(e,t,n)=>n<-.235?$.gold:cd);n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.rbox(0,.02,.08,.045,.055,.12,3,(e,t,n)=>t>.06||Math.abs(n-.08)>.1?$.gold:td),n.box(-.012,.07,0,.012,.09,.16,(e,t,n)=>Math.floor(n/Zl)&1?cd:$.gold),n.tubeZ(0,.045,.18,.5299999999999999,.036,.036,1,(e,t,n)=>Math.abs((n-.24)%.12)<.025?$.gold:X(td,.9)),n.tubeZ(0,-.012,.18,.46,.022,.022,1,$.ironDark),n.rbox(0,0,.29,.046,.034,.075,3,(e,t,n)=>Math.abs(n-.29)>.06?$.gold:$.timber),n.tubeZ(0,.045,.52,ld,.05,.05,1.25,$.gold),n.ell(0,.045,.585,.03,.03,.02,cd),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.04;let i=-.29;return r.seg(.2,-.12,i,-.22,.56,i,.034,.03,(e,t)=>t<.1?$.timberDark:X(td,.85)),r.rbox(.06,.1,i,.045,.06,.05,3,(e,t)=>Math.abs(t-.1)<.03?$.runeBlue:$.gold),r.ell(-.22,.58,i,.026,.026,.026,$.runeBlueHot),r.seg(-.2,.36,-.2,.22,.02,-.2,.014,.014,$.leather),t.push({bone:`torso`,part:r}),t}function dd(e,t){let n=hu(Q(t,0,.05));_u(e,id,n),e[Y.nRX]+=.08*n,e[Y.tRY]+=.1*n;let r=gu(t,0,.04,.3);e[Y.wZ]-=.12*r,e[Y.wRX]-=.42*fu(r),e[Y.tRX]-=.12*r,e[Y.tRY]+=.08*r,e[Y.nRX]-=.08*r,e[Y.hZ]-=.03*r,e[Y.cape]+=.12*r;let i=gu(t,.3,.4,.55);e[Y.wZ]-=.05*i,e[Y.wRZ]+=.18*i;let a=gu(t,.45,.52,.62);e[Y.wZ]+=.03*a}function fd(e,t){let n=hu(Q(t,0,.25))*(1-hu(Q(t,.85,1))*.6);e[Y.wRZ]-=.55*n,e[Y.wRX]+=.2*n,e[Y.wY]-=.03*n,e[Y.nRX]+=.22*n;let r=gu(t,.3,.55,.8);e[Y.ikL]*=1-.8*r,e[Y.aLX]-=.35*r,e[Y.fL]-=.5*r,e[Y.wZ]+=.015*r}var pd={...sd,kind:`warden_shotgun`,parts:ud,gripL:[0,-.03,.29],muzzle:{bone:`weapon`,p:[0,.045,.61]},attackDur:.62,attack:dd,reload:fd},md=.86;function hd(e){let t=sd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.03,n.ell(0,-.15,0,.03,.03,.03,$.gold),n.tubeY(0,0,-.13,.05,.022,.022,1,(e,t)=>Math.floor(t/.03)&1?$.leatherDark:$.leather),n.box(-.02,.05,-.12,.02,.09,.12,(e,t,n)=>Math.abs(n)>.09?$.goldDark:$.gold),n.fill(-.02,.09,-.06,.02,md,.06,(e,t,n)=>{let r=(t-.09)/.77,i=r<.82?.045-.012*r:.035*(1-(r-.82)/.18);return Math.abs(n)<=i},(e,t,n)=>Math.abs(n)<.012&&t>.14&&t<.72?Math.floor(t/.06)&1?$.runeBlue:X($.steelDark,.9):Math.abs(n)>.03?X($.steel,1.12):$.steel),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.02;let i=(e,t)=>{let n=(.06-e)/.5,r=n<.35?.19:.19*(1-(n-.35)/.65);return n>=0&&n<=1&&Math.abs(t)<=r};return r.fill(.06,-.46,-.21,.1,.07,.21,(e,t,n)=>i(t,n),(t,n,r)=>{if(!i(n+.035,r)||!i(n-.035,r)||!i(n,r+.035)||!i(n,r-.035))return $.gold;if(t<.075)return $.steelDark;let a=Math.hypot(n+.1,r);return a<.035?$.runeBlueHot:a<.06?$.gold:Math.abs(r)<.015||Math.abs(n+.1)<.015?X($.gold,.85):X(e,.9)}),t.push({bone:`foreL`,part:r}),t}var gd=[-.22,.6,-.02,-.85,.25,.4],_d=[.08,.22,.46,1.65,-.3,-.55];function vd(e,t){let n=fu(Q(t,0,.09)),r=pu(Q(t,.08,.17)),i=mu(Q(t,.24,.42));_u(e,gd,n*(1-r)),_u(e,_d,r*(1-i)),e[Y.tRY]+=-.35*n*(1-r)+.3*r*(1-i),e[Y.tRX]+=-.08*n*(1-r)+.18*r*(1-i),e[Y.nRY]-=.2*r*(1-i),e[Y.hZ]+=.05*r*(1-i),e[Y.kL]+=.25*r*(1-i),e[Y.lLX]-=.2*r*(1-i),e[Y.aLX]+=-.7*(n+r)*.5*(1-i),e[Y.aLZ]+=.15*n,e[Y.fL]+=-.7*(1-i)*Math.min(1,n+r),e[Y.cape]+=.15*gu(t,.1,.16,.4)}var yd={...sd,kind:`warden_knight`,parts:hd,carry:[-.27,-.02,.16,.6,0,.1],carryRun:[-.25,.02,.2,.9,0,.1],drop:[-.36,.1,0,-1.57,0,0],gripR:[0,0,0],gripL:null,muzzle:{bone:`weapon`,p:[0,md,0]},attackDur:.42,attack:vd},bd=1.3;function xd(e){let t=sd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.03,n.ell(0,-.3,0,.04,.04,.04,$.gold),n.tubeY(0,0,-.28,.05,.024,.024,1,(e,t)=>Math.floor(t/.035)&1?$.leatherDark:$.leather),n.box(-.025,.05,-.19,.025,.1,.19,(e,t,n)=>Math.abs(n)>.15?$.goldDark:$.gold),n.ell(0,.075,0,.035,.035,.035,$.runeBlueHot),n.fill(-.024,.1,-.09,.024,bd,.09,(e,t,n)=>{let r=(t-.1)/1.2,i=r<.86?.078-.018*r:.064*(1-(r-.86)/.14);return Math.abs(n)<=i},(e,t,n)=>Math.abs(n)<.016&&t>.16&&t<1.1?Math.floor(t/.07)&1?$.runeBlueHot:$.runeBlue:Math.abs(n)>.05?X($.steel,1.15):$.steel),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.02;let i=(e,t)=>{let n=(.3-t)/.5,r=n<.35?.19:.19*(1-(n-.35)/.65);return n>=0&&n<=1&&Math.abs(e)<=r};return r.fill(-.2,-.21,-.27,.2,.31,-.23,(e,t)=>i(e,t),(t,n)=>{if(!i(t,n+.035)||!i(t,n-.035)||!i(t+.035,n)||!i(t-.035,n))return $.gold;let r=Math.hypot(t,n-.14);return r<.035?$.runeBlueHot:r<.06?$.gold:X(e,.9)}),t.push({bone:`torso`,part:r}),t}var Sd=[-.06,-.02,.3,.55,0,.3],Cd=[-.3,.42,-.08,-.5,.5,1.1],wd=[.26,.1,.42,1.35,-.5,-1.2];function Td(e,t){let n=fu(Q(t,0,.3)),r=pu(Q(t,.3,.44)),i=mu(Q(t,.55,.9));_u(e,Cd,n*(1-r)),_u(e,wd,r*(1-i)),e[Y.tRY]+=-.55*n*(1-r)+.55*r*(1-i),e[Y.tRX]+=-.06*n*(1-r)+.22*r*(1-i),e[Y.nRY]-=.25*r*(1-i),e[Y.hZ]+=.08*r*(1-i),e[Y.hY]-=.05*r*(1-i),e[Y.kL]+=.35*r*(1-i),e[Y.kR]+=.2*r*(1-i),e[Y.lLX]-=.25*r*(1-i),e[Y.cape]+=.25*gu(t,.3,.42,.75)}var Ed={...yd,kind:`warden_knight_great`,parts:xd,carry:Sd,carryRun:[-.08,.02,.26,.8,0,.35],gripR:[0,0,0],gripL:[0,-.17,0],muzzle:{bone:`weapon`,p:[0,bd,0]},attackDur:.8,attack:Td},Dd=4937059,Od=1;function kd(e){let t=sd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;return n.jitter=.05,n.rbox(0,-.035,-.24,.028,.065,.16,3,(e,t,n)=>n<-.37||Math.abs(n+.22)<.02?$.gold:$.timberDark),n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.rbox(0,.015,.1,.036,.045,.16,3,(e,t,n)=>t>.045||Math.abs(n-.1)>.14?$.gold:Dd),n.box(-.018,-.06,.24,.018,0,.5,$.timber),n.tubeZ(0,.03,.24,.94,.022,.022,1,(e,t,n)=>Math.abs((n-.3)%.18)<.03?$.gold:X(Dd,.85)),n.tubeZ(0,.1,-.06,.24,.028,.028,1,(e,t,n)=>n<-.03||n>.21?$.gold:$.steelDark),n.box(-.012,.055,.02,.012,.08,.12,$.steelDark),n.ell(0,.1,.25,.02,.02,.012,$.runeBlueHot),n.box(-.012,.06,.26,.012,.085,.5,(e,t,n)=>Math.floor(n/Zl)&1?$.runeBlue:$.gold),n.rbox(0,.03,.95,.04,.04,.03,3,$.gold),n.ell(0,.03,Od,.026,.026,.04,$.runeBlueHot),t.push({bone:`weapon`,part:n}),t}var Ad={...sd,kind:`warden_sniper`,parts:kd,gripL:[0,-.03,.36],muzzle:{bone:`weapon`,p:[0,.03,1.04]}},jd=.44;function Md(e){let t=sd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.05,n.rbox(0,-.035,-.13,.026,.055,.09,3,(e,t,n)=>n<-.19?$.gold:$.timberDark),n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.rbox(0,.01,.15,.03,.038,.22,3,(e,t,n)=>t>.035||Math.abs(n-.15)>.19?$.gold:$.timber),n.box(-.008,.045,-.02,.008,.058,.4,(e,t,n)=>Math.floor(n/Zl)&1?$.runeBlue:$.gold),n.rbox(0,.105,.05,.034,.034,.075,3,(e,t)=>t>.125?$.gold:Dd);for(let e of[-.018,0,.018])n.box(e-.006,.09,.125,e+.006,.105,.145,$.runeBlueHot);n.fill(-.23,0,.22,.23,.05,.4,(e,t,n)=>Math.abs(n-(.37-.16*e*e/.0529))<.026,e=>Math.abs(e)>.18?$.runeBlueHot:Math.abs(e)<.045?$.gold:$.steel);for(let e of[1,-1])n.seg(.22*e,.028,.215,.012*e,.05,.05,.008,.008,$.runeBlueHot);n.tubeZ(0,.068,.05,jd,.011,.011,1,$.runeBlue),n.ell(0,.068,.46,.018,.018,.03,$.runeBlueHot),n.rbox(0,.02,.41000000000000003,.032,.03,.02,3,$.gold),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.04;let i=-.29;return r.seg(.22,-.2,i,-.25,.72,i,.028,.022,(e,t)=>t<.02?$.timberDark:X(Dd,.85)),r.rbox(.1,.05,i,.04,.055,.045,3,(e,t)=>Math.abs(t-.05)<.025?$.runeBlue:$.gold),r.seg(.04,.28,-.33999999999999997,-.05,.46,-.33999999999999997,.022,.022,$.steelDark),r.ell(-.25,.74,i,.024,.024,.024,$.runeBlueHot),r.seg(-.2,.36,-.2,.22,.02,-.2,.014,.014,$.leather),t.push({bone:`torso`,part:r}),t}var Nd={...Ad,kind:`warden_sniper_xbow`,parts:Md,gripL:[0,-.03,.17],muzzle:{bone:`weapon`,p:[0,.068,.49]}};function Pd(e){let t=sd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.05,n.rbox(0,-.035,-.2,.03,.06,.13,3,(e,t,n)=>n<-.3?$.bronze:$.timberDark),n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.rbox(0,.02,.1,.05,.055,.12,3,(e,t,n)=>t>.055||Math.abs(n-.1)>.1?$.bronzeLight:$.bronze),n.ell(0,.03,.12,.034,.034,.05,$.runeBlueHot),n.box(-.012,.08,.03,.012,.1,.2,(e,t,n)=>Math.floor(n/Zl)&1?$.runeBlue:$.gold),n.tubeZ(0,.03,.2,.52,.026,.026,.9,(e,t,n)=>Math.abs((n-.26)%.1)<.025?$.gold:X($.iron,1.1)),n.fill(-.24,0,.3,.24,.06,.4,(e,t,n)=>Math.abs(n-(.36-e*e*.18/.0576))<.028,e=>Math.abs(e)>.19?$.runeBlueHot:Math.abs(e)<.05?$.gold:$.runeBlue),n.rbox(0,.03,.54,.038,.038,.025,3,$.gold),n.ell(0,.03,.5800000000000001,.022,.022,.03,$.runeBlueHot),t.push({bone:`weapon`,part:n}),t.push({bone:`head`,part:Fd()});let r=new Z;return r.jitter=.04,r.seg(-.2,-.05,-.19,.2,.38,-.19,.018,.018,$.timber),r.rbox(.2,.4,-.19,.06,.045,.05,3,e=>e>.25?$.ironLight:$.iron),r.box(.17,.39,-.245,.23,.41,-.235,$.runeBlue,`paint`),r.box(-.22,.2,-.16,.22,.23,-.13,$.leather),t.push({bone:`torso`,part:r}),t}function Fd(){let e=new Z;e.jitter=.02,e.tubeY(0,.005,.22,.26,.142,.142,1,$.leatherDark,`under`);for(let t of[1,-1])e.tubeZ(.05*t,.24,.12,.16,.034,.03,1,$.bronzeLight),e.tubeZ(.05*t,.24,.15,.165,.022,.02,1,$.runeBlueHot);return e}var Id={...sd,kind:`warden_engineer`,parts:Pd,gripL:[0,-.03,.24],muzzle:{bone:`weapon`,p:[0,.03,.6100000000000001]}},Ld=.62;function Rd(e){let t=sd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.03,n.tubeY(0,0,-.2,.57,.024,.024,1,(e,t)=>t<.02?Math.floor(t/.035)&1?$.leatherDark:$.leather:$.timber),n.ell(0,-.22,0,.032,.03,.032,$.bronze),n.tubeY(0,0,.52,.57,.034,.034,1,$.gold),n.rbox(0,Ld,.03,.085,.095,.125,3,(e,t,n)=>Math.abs(t-Ld)>.07?$.ironLight:n>.13?$.bronzeLight:$.iron),n.box(-.065,.5549999999999999,.155,.065,.685,.17,(e,t)=>Math.abs(e)<.018||Math.abs(t-Ld)<.018?$.runeBlueHot:$.runeBlue),n.seg(0,.64,-.08,0,.7,-.24,.035,.012,$.ironDark),t.push({bone:`weapon`,part:n}),t.push({bone:`head`,part:Fd()});let r=new Z;r.jitter=.04;let i=-.28;return r.seg(.2,-.12,i,-.16,.44,i,.03,.026,(e,t)=>t<.05?$.timberDark:$.bronze),r.ell(.02,.17,-.30000000000000004,.034,.034,.034,$.runeBlueHot),r.seg(-.32,.34,-.31000000000000005,0,.54,-.31000000000000005,.02,.02,e=>Math.abs(e+.16)>.12?$.runeBlueHot:$.runeBlue),r.seg(-.2,.36,-.2,.22,.02,-.2,.014,.014,$.leather),t.push({bone:`torso`,part:r}),t}var zd=[-.18,.62,-.05,-1.25,.15,.25],Bd=[-.02,.05,.5,1.45,0,-.1];function Vd(e,t){let n=fu(Q(t,0,.16)),r=pu(Q(t,.16,.26)),i=mu(Q(t,.32,.55));_u(e,zd,n*(1-r)),_u(e,Bd,r*(1-i)),e[Y.tRX]+=-.12*n*(1-r)+.3*r*(1-i),e[Y.nRX]+=.12*r*(1-i),e[Y.hY]-=.04*r*(1-i),e[Y.kL]+=.25*r*(1-i),e[Y.kR]+=.25*r*(1-i);let a=gu(t,.26,.29,.36);e[Y.wY]+=.05*a,e[Y.cape]+=.15*gu(t,.18,.26,.5)}var Hd={...yd,kind:`warden_engineer_hammer`,parts:Rd,carry:[-.25,-.04,.14,.45,0,.1],carryRun:[-.24,0,.18,.8,0,.1],gripR:[0,0,0],gripL:null,muzzle:{bone:`weapon`,p:[0,Ld,.17]},attackDur:.58,attack:Vd},Ud=.8;function Wd(e,t=0,n=0){let r=new Z;r.jitter=.04;let i=n=>t+n*e,a=(e,t)=>[Math.min(i(e),i(t)),Math.max(i(e),i(t))],o=n=>(n-t)*e,[s,c]=a(-.14,-.1);r.box(-.02,s,n-.05,.02,c,n+.05,$.timberDark);let[l,u]=a(-.12,.5);r.tubeY(0,n,l,u,.025,.025,1,(e,t)=>Math.abs(o(t))%.16<.03?$.leatherDark:$.timber);let[d,f]=a(.48,.54);r.tubeY(0,n,d,f,.034,.034,1,$.gold);let[p,m]=a(.52,Ud),h=e=>(o(e)-.52)/.28;return r.fill(-.016,p,n-.1,.016,m,n+.1,(e,t,r)=>{let i=h(t),a=i<.2?.05+.2*i:i<.75?.09:.09*(1-(i-.75)/.25)+.015;return Math.abs(r-n)<=a},(e,t,r)=>{let i=h(t);return i>.86?$.runeBlueHot:Math.abs(r-n)<.012&&i>.2?$.runeBlue:Math.abs(r-n)>.065?X($.steel,1.1):$.steelDark}),r}function Gd(e){let t=sd.parts(e).filter(e=>e.bone!==`weapon`);t.push({bone:`weapon`,part:Wd(1)}),t.push({bone:`foreL`,part:Wd(-1,-.28,.03)});let n=new Z;n.jitter=.02,n.rbox(0,.25,.13,.035,.03,.025,3,$.bronze),n.ell(0,.25,.155,.022,.02,.012,$.runeBlueHot),t.push({bone:`head`,part:n});let r=new Z;return r.jitter=.05,r.rbox(.19,-.1,.02,.05,.08,.09,3,(e,t)=>t>-.04?$.leatherDark:$.leather),r.box(.2,-.06,.1,.23,-.02,.115,$.gold),t.push({bone:`hips`,part:r}),t}var Kd={...yd,kind:`warden_digger`,parts:Gd,muzzle:{bone:`weapon`,p:[0,Ud,0]}},qd=.52;function Jd(e){let t=sd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.05,n.rbox(0,-.03,-.14,.028,.05,.09,3,(e,t,n)=>n<-.2?$.gold:$.timberDark),n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.tubeZ(0,-.06,0,.32,.088,.088,1,(e,t,n)=>Math.abs(n-.16)<.05&&t<-.02?$.runeBlueHot:Math.abs(n-.03)<.02||Math.abs(n-.29)<.02?$.gold:$.bronze),n.rbox(0,.05,.14,.032,.03,.16,3,$.bronzeLight),n.seg(.06,-.02,.3,.05,.04,.4,.016,.016,$.leatherDark),n.seg(.05,.04,.4,0,.05,.36,.016,.016,$.leatherDark),n.tubeZ(0,.05,.28,.46,.022,.022,1,(e,t,n)=>Math.abs((n-.3)%.08)<.02?$.gold:$.iron),n.tubeZ(0,.05,.43000000000000005,qd,.045,.045,1.8,(e,t,n)=>n>.5?$.runeBlueHot:$.gold),n.box(-.01,.08,.06,.01,.095,.24,(e,t,n)=>Math.floor(n/.04)&1?$.runeBlue:$.gold),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.04;let i=-.27;for(let e of[1,-1])r.seg(.22*e,-.18,i,-.16*e,.42,i,.02,.02,$.timber),r.fill(-.22*e-.07,.4,-.29000000000000004,-.22*e+.07,.62,-.25,()=>!0,(e,t)=>t>.58?$.runeBlueHot:$.steelDark);return r.seg(-.2,.36,-.2,.22,.02,-.2,.014,.014,$.leather),t.push({bone:`torso`,part:r}),t.push(...Gd(e).slice(-2)),t}var Yd={...sd,kind:`warden_digger_spray`,parts:Jd,gripL:[0,-.03,.2],muzzle:{bone:`weapon`,p:[0,.05,.55]}};function Xd(e,t,n,r,i=0){let a=e/r,o=t/r,s=n/r,c=Math.floor(a),l=Math.floor(o),u=Math.floor(s),d=a-c,f=o-l,p=s-u,m=d*d*(3-2*d),h=f*f*(3-2*f),g=p*p*(3-2*p),_=(e,t,n)=>ou(c+e+i*131,l+t,u+n),v=(e,t,n)=>e+(t-e)*n;return v(v(v(_(0,0,0),_(1,0,0),m),v(_(0,1,0),_(1,1,0),m),h),v(v(_(0,0,1),_(1,0,1),m),v(_(0,1,1),_(1,1,1),m),h),g)}function Zd(e,t,n=0,r=0){let i=X(e,.8);return(a,o,s)=>{let c=Xd(a,o,s,.11,r),l=su(e,i,Math.max(0,c-.5)*2);if(t>0){let e=Xd(a,o,s,.16,r+7);e>1-t*.55&&(l=su(l,$.corrupt,Math.min(1,(e-(1-t*.55))*9)))}if(n>0){let e=Xd(a,o,s,.09,r+13);if(Math.abs(e-.5)<.022*n&&Xd(a,o,s,.25,r+3)>.45)return $.acid}return l}}function Qd(e,t=0){return(n,r,i)=>t>0&&Math.abs((r+10)%t-t/2)<Zl*.5&&(Math.floor(n/Zl)+Math.floor(i/Zl))%3==0?$.ironLight:Xd(n,r,i,.08,5)>1-e?$.rust:$.iron}function $d(e,t,n){return(r,i)=>(i%n+n)%n<n/2?e:t}function ef(e,t,n,r,i,a,o){e.seg(t*n,r,i,t*(n+a),r+a*.35,i-a*.5,.035,.012,o)}function tf(e,t,n,r,i,a,o){e.seg(t*n,r,i,t*(n+.01),r+a,i+a*.25,o,o*.45,(e,t)=>t>r+a*.7?$.bone:$.boneDark)}function nf(e,t,n,r){e.rbox(0,-t,.005,n,n*1.05,n*1.05,2.6,r)}function rf(e,t,n,r,i){e.rbox(0,-t+n*.55,r*.35,n,n*.6,r,3,i),e.box(-n,-t,r*1.2,n,-t+n*.35,r*1.35+Zl,e=>Math.floor(e/Zl)&1?$.boneDark:-1,`add`)}var af={hips:[0,.9,0],torso:[0,.1,0],head:[0,.49,.08],shoulder:[.29,.42,0],upperLen:.33,handLen:.33,hip:[.12,-.03,0],thighLen:.42};function of(e){let t=[],n=Zd($.hideGrunt,.25,0,1),r=Zd(X($.hideGrunt,.85),.2,0,2),i=5981746,a=new Z;a.rbox(0,-.03,0,.19,.12,.15,2.8,i),a.tubeY(0,0,-.01,.07,.2,.16,1,$.leatherDark),a.rbox(0,.03,.16,.05,.05,.03,3,$.bone),a.box(-.03,.02,.18,-.01,.04,.2,$.charcoal,`paint`),a.box(.01,.02,.18,.03,.04,.2,$.charcoal,`paint`),a.box(-.1,-.34,.12,.1,0,.17,(t,n,r)=>n<-.26&&ou(t*40|0,0,r*40|0)>.55?-1:e),a.box(-.12,-.3,-.17,.12,0,-.12,(t,n)=>n<-.24&&ou(t*40|0,1,0)>.5?-1:X(e,.85)),t.push({bone:`hips`,part:a});let o=new Z;o.rbox(0,.17,.03,.24,.22,.19,2.2,n),o.ell(0,.34,0,.3,.15,.185,n),o.ell(0,.44,-.04,.2,.1,.14,r),o.fill(-.3,0,.1,.3,.45,.3,(e,t)=>Math.abs(e)<.015||Math.abs(t-.27)<.012,X($.hideGrunt,.78),`paint`),o.fill(-.4,-.05,-.3,.4,.55,.3,(e,t)=>Math.abs(e*.95-(t-.22))<.035,(e,t)=>Math.abs(e*.95-(t-.22))<.012&&(t*100|0)%9<2?$.ironLight:$.leatherDark,`paint`),o.fill(.14,.38,-.16,.46,.6,.16,(e,t,n)=>{let r=(e-.3)/.14,i=(t-.43)/.1,a=n/.14;return r*r+i*i+a*a<=1&&t>.4},Qd(.35,.06)),o.seg(.3,.5,0,.34,.62,-.02,.03,.008,$.boneDark),o.seg(.38,.47,.06,.45,.56,.08,.025,.008,$.boneDark),o.fill(-.3,0,.1,.3,.4,.3,(e,t)=>Math.abs(t-(.12+e*.6))<.012&&e>-.12&&e<.08,$.acid,`paint`),t.push({bone:`torso`,part:o});let s=new Z;s.rbox(0,.14,.02,.135,.135,.135,2.5,n),s.rbox(0,.035,.07,.14,.07,.115,3,r),s.box(-.13,.155,.1,.13,.2,.17,X($.hideGrunt,.68)),s.box(-.03,.08,.13,.03,.15,.19,X($.hideGrunt,.9)),s.box(-.09,.12,.11,-.05,.14,.17,$.eyeRed,`paint`),s.box(.05,.12,.11,.09,.14,.17,$.eyeRed,`paint`),s.box(-.08,.045,.16,.08,.065,.2,$.charcoal,`paint`);for(let e of[1,-1])tf(s,e,.075,.03,.16,.12,.024),ef(s,e,.125,.15,.02,.14,n);s.ell(0,.29,-.05,.05,.05,.05,$.charcoal),s.seg(0,.29,-.09,0,.13,-.22,.034,.022,$d($.charcoal,X($.charcoal,1.35),.06)),t.push({bone:`head`,part:s});for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.33,.03,.08,.085,1.15,n),i.ell(0,-.14,.03,.085,.1,.08,n),t.push({bone:e===`L`?`armL`:`armR`,part:i});let a=new Z;a.ell(0,-.01,0,.075,.06,.075,n),a.tubeY(0,0,-.29,0,.066,.068,1.15,n),a.tubeY(0,0,-.26,-.1,.074,.075,1.12,$d($.leather,$.leatherDark,.06)),nf(a,.33,.068,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:a})}for(let e of[`L`,`R`]){let a=new Z;a.tubeY(0,0,-.42,.05,.1,.105,1.2,i),a.box(-.06,-.3,.06,.03,-.18,.13,X($.clothBrown,1.1),`paint`),t.push({bone:e===`L`?`thighL`:`thighR`,part:a});let o=new Z;o.ell(0,-.01,.01,.08,.07,.08,n),o.tubeY(0,0,-.38,0,.07,.075,1.1,n),o.tubeY(0,0,-.34,-.12,.078,.082,1.08,$d($.clothBrown,X($.clothBrown,.8),.05)),rf(o,.45,.075,.1,r),t.push({bone:e===`L`?`shinL`:`shinR`,part:o})}let c=new Z;return c.jitter=.06,c.seg(0,-.16,0,0,.66,0,.024,.022,(e,t)=>Math.abs(t)<.07?$.leatherDark:Math.abs(t-.3)<.02?$.iron:$.timber),c.ell(0,-.17,0,.032,.03,.032,$.iron),c.fill(-.02,.3,-.02,.02,.84,.36,(e,t,n)=>{if(n<.01)return!1;let r=.06+.6*Math.max(0,n-.02),i=.57+.1*n;return Math.abs(t-i)<Math.min(r,.22)&&n<.3+.06*(1-Math.abs(t-i)/.22)},(e,t,n)=>n>.27?ou(0,t*60|0,3)>.85?-1:$.ironLight:sf(e,t,n)>.62?$.rust:$.iron),c.seg(0,.58,0,0,.6,-.13,.028,.008,$.ironDark),c.tubeY(0,0,.48,.66,.03,.03,1,$d($.leatherDark,$.leather,.05)),t.push({bone:`weapon`,part:c}),t}function sf(e,t,n){return ou(e*25|0,t*25|0,n*25|0)}var cf=[-.2,.72,-.05,-.75,.1,.25],lf=[-.12,.2,.5,1.9,.05,.1];function uf(e,t){let n=fu(Q(t,0,.32)),r=pu(Q(t,.3,.44)),i=mu(Q(t,.52,.85));_u(e,cf,n*(1-r)),_u(e,lf,r*(1-i));let a=-.28*n*(1-r)+.42*r*(1-i);e[Y.tRX]+=a,e[Y.tRY]+=-.3*n*(1-r)+.2*r*(1-i),e[Y.nRX]-=a*.6,e[Y.hY]-=.08*r*(1-i),e[Y.hZ]+=.05*r*(1-i),e[Y.kL]+=.4*r*(1-i),e[Y.kR]+=.3*r*(1-i),e[Y.lLX]-=.3*r*(1-i),e[Y.lRX]+=.2*r*(1-i),e[Y.aLX]+=-.9*n*(1-r)+.7*r*(1-i),e[Y.aLZ]+=.3*n,e[Y.fL]+=-.6*n*(1-r),e[Y.bS]+=.04*gu(t,.42,.45,.6)}var df={kind:`orc_grunt`,defaultTint:$.clothRed,height:2,rig:af,parts:of,hunch:.32,stance:.1,loco:{walkHz:.85,runHz:1.3,stride:.42,runStride:.75,knee:.7,runKnee:1.3,bob:.04,armSwing:.45,lean:.25},carry:[-.36,0,.12,.55,0,.12],drop:[-.46,0,0,0,0,0],gripL:null,gripR:[0,0,0],muzzle:{bone:`weapon`,p:[0,.56,.25]},attackDur:.85,attack:uf,deathDepth:.2},ff={hips:[0,1.18,0],torso:[0,.14,0],head:[0,.64,.16],shoulder:[.45,.55,0],upperLen:.44,handLen:.44,hip:[.19,-.04,0],thighLen:.55};function pf(e){let t=[],n=Zd($.hideBrute,.55,.8,11),r=Zd(X($.hideBrute,.85),.5,.5,12),i=4863270,a=new Z;a.rbox(0,-.03,0,.3,.16,.22,2.8,i),a.tubeY(0,0,-.38,0,.32,.25,1.12,(e,t,n)=>Math.abs(e)<.02||Math.abs(n)<.02&&t<-.1?-1:Qd(.3,.09)(e,t,n)),a.tubeY(0,0,-.01,.1,.33,.25,1,$d($.leatherDark,i,.06)),a.box(-.13,-.5,.25,.13,.02,.3,(t,n,r)=>n<-.42&&ou(t*40|0,2,r*40|0)>.5?-1:e),a.box(-.15,-.46,-.3,.15,.02,-.25,(t,n)=>n<-.38&&ou(t*40|0,3,0)>.5?-1:X(e,.85)),a.rbox(0,.05,.27,.08,.075,.045,3,$.bone),a.box(-.05,.05,.29,-.015,.08,.33,$.charcoal,`paint`),a.box(.015,.05,.29,.05,.08,.33,$.charcoal,`paint`),t.push({bone:`hips`,part:a});let o=new Z;o.rbox(0,.14,.06,.33,.22,.27,2.3,n),o.ell(0,.38,.03,.44,.26,.3,n),o.ell(0,.52,-.1,.34,.17,.24,r),o.fill(-.3,.26,.12,.3,.56,.5,(e,t)=>Math.abs(e)<.26-(t-.26)*.25,Qd(.25,.1),`paint`),o.fill(-.5,0,-.5,.5,.7,.5,(e,t)=>Math.abs(Math.abs(e)-(.2+(t-.3)*.2))<.03&&t>.1,$.leatherDark,`paint`);for(let e of[1,-1]){let t=.46*e;o.fill(t-.24,.5,-.24,t+.24,.8,.24,(e,n,r)=>{let i=(e-t)/.22,a=(n-.56)/.16,o=r/.22;return i*i+a*a+o*o<=1&&n>.52},(e,t,n)=>t<.56?$.ironDark:Qd(.4,.07)(e,t,n)),o.seg(t,.68,0,t+.03*e,.86,-.02,.045,.01,$.boneDark),o.seg(t+.1*e,.64,.08,t+.2*e,.78,.1,.035,.008,$.boneDark),o.seg(t+.1*e,.64,-.08,t+.2*e,.78,-.12,.035,.008,$.boneDark)}t.push({bone:`torso`,part:o});let s=new Z;s.rbox(0,.12,.02,.14,.13,.13,2.5,n),s.rbox(0,.02,.07,.16,.08,.13,3,r),s.fill(-.2,.15,-.2,.2,.32,.2,(e,t,n)=>{let r=e/.155,i=(t-.14)/.15,a=(n-.01)/.15;return r*r+i*i+a*a<=1},(e,t,n)=>t<.18?$.ironLight:Qd(.3)(e,t,n));for(let e of[1,-1])s.seg(.13*e,.22,.02,.24*e,.3,.04,.04,.03,$.boneDark),s.seg(.24*e,.3,.04,.28*e,.42,.12,.03,.01,$.bone),tf(s,e,.09,.02,.17,.15,.03);s.box(-.09,.1,.12,-.04,.12,.17,$.eyeRed,`paint`),s.box(.04,.1,.12,.09,.12,.17,$.eyeRed,`paint`),s.box(-.1,.03,.18,.1,.05,.22,$.charcoal,`paint`),t.push({bone:`head`,part:s});for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.44,.04,.12,.13,1.15,n),i.ell(0,-.2,.05,.14,.15,.12,n),t.push({bone:e===`L`?`armL`:`armR`,part:i});let a=new Z;a.ell(0,-.01,0,.12,.09,.12,n),a.tubeY(0,0,-.38,0,.1,.1,1.25,n),a.tubeY(0,0,-.34,-.1,.12,.12,1.12,Qd(.3,.08)),a.seg(0,-.22,-.1,0,-.2,-.22,.03,.008,$.boneDark),nf(a,.44,.1,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:a})}for(let a of[`L`,`R`]){let o=new Z;o.tubeY(0,0,-.55,.06,.15,.16,1.2,i),o.box(-.12,-.44,.08,.1,-.3,.2,X(e,.9),`paint`),t.push({bone:a===`L`?`thighL`:`thighR`,part:o});let s=new Z;s.ell(0,-.01,.02,.12,.1,.12,Qd(.3)),s.tubeY(0,0,-.5,0,.11,.115,1.1,n),s.tubeY(0,0,-.42,-.1,.12,.12,1.1,Qd(.35,.1)),rf(s,.59,.11,.14,r),t.push({bone:a===`L`?`shinL`:`shinR`,part:s})}let c=new Z;c.jitter=.05,c.seg(0,-.36,0,0,1,0,.042,.042,(e,t)=>Math.abs(t-.16)<.24?$d($.leatherDark,$.leather,.06)(0,t,0):Math.abs(t-.6)<.03?$.iron:$.timberDark),c.ell(0,-.38,0,.06,.05,.06,$.iron),c.rbox(0,1.08,0,.15,.14,.27,4,(e,t,n)=>Math.abs(n)>.22?$.ironDark:Math.abs(e)>.12&&Math.abs(n)<.06&&Math.abs(t-1.08)<.06?$.acid:Xd(e,t,n,.07,9)>.62?$.rust:$.iron);for(let e of[1,-1])c.box(-.08,1,.27*e-.02,.08,1.16,.27*e+.02,$.ironLight,`paint`);return c.seg(0,1.2,0,0,1.36,0,.04,.01,$.ironDark),t.push({bone:`weapon`,part:c}),t}var mf=[-.05,.95,.05,-.8,0,0],hf=[-.05,0,.58,1.45,0,0];function gf(e,t){let n=fu(Q(t,0,.5)),r=pu(Q(t,.48,.62)),i=mu(Q(t,.85,1.25));_u(e,mf,n*(1-r)),_u(e,hf,r*(1-i));let a=-.3*n*(1-r)+.5*r*(1-i);e[Y.tRX]+=a,e[Y.nRX]-=a*.5,e[Y.hY]+=.04*n*(1-r)-.16*r*(1-i),e[Y.kL]+=.6*r*(1-i),e[Y.kR]+=.6*r*(1-i),e[Y.lLX]-=.45*r*(1-i),e[Y.lRX]-=.3*r*(1-i),e[Y.lLZ]+=.1*r,e[Y.lRZ]-=.1*r;let o=gu(t,.6,.63,.85);e[Y.bS]-=.05*o,e[Y.tRZ]+=.03*Math.sin(t*90)*o}var _f={kind:`orc_brute`,defaultTint:$.clothBrown,height:2.8,rig:ff,parts:pf,hunch:.26,stance:.14,loco:{walkHz:.62,runHz:.95,stride:.38,runStride:.62,knee:.65,runKnee:1.15,bob:.07,armSwing:.3,lean:.22},carry:[-.28,.02,.42,.35,0,-1],drop:[-.62,-.1,0,0,0,0],gripR:[0,0,0],gripL:[0,.34,0],poleL:[.9,-.5,-.3],poleR:[-.9,-.5,-.3],muzzle:{bone:`weapon`,p:[0,1.08,0]},attackDur:1.25,attack:gf,deathDepth:.32},vf=.56,yf=-.12,bf=14274740,xf={hips:[0,.93,0],torso:[0,.1,0],head:[0,.47,.05],shoulder:[.22,.39,0],upperLen:.3,handLen:.31,hip:[.1,-.03,0],thighLen:.43,extra:[0,0,0],bowString:{half:.53,z:yf}};function Sf(e){let t=[],n=Zd($.hideArcher,.2,0,21),r=Zd(X($.hideArcher,.85),.2,0,22),i=6178352,a=7296056,o=new Z;o.rbox(0,-.03,0,.16,.11,.12,2.8,5061418),o.tubeY(0,0,-.01,.06,.17,.13,1,$.leatherDark),o.box(-.08,-.3,.1,.08,0,.14,(e,t)=>t<-.25&&ou(e*40|0,5,0)>.5?-1:X($.clothBrown,.9)),o.rbox(.15,-.06,.02,.04,.06,.06,3,$.leather),t.push({bone:`hips`,part:o});let s=new Z;s.rbox(0,.16,.02,.18,.19,.13,2.3,a),s.ell(0,.32,0,.22,.11,.14,a),s.fill(-.3,0,.08,.3,.45,.3,e=>Math.abs(e)<.02,$.leatherDark,`paint`),s.fill(-.3,0,.08,.3,.45,.3,(e,t)=>Math.abs(e)<.02&&(t/Zl|0)%3==0,$.bone,`paint`),s.ell(0,.4,0,.2,.06,.14,n),s.ell(0,.41,-.02,.19,.07,.15,i),s.seg(-.1,.02,-.19,.1,.52,-.2,.06,.06,$d($.leather,$.leatherDark,.12)),s.seg(-.1,.02,-.19,.1,.52,-.2,.065,.065,$.leatherDark,`under`);for(let t=0;t<6;t++){let n=.07+t%3*.03,r=-.23+(t>>1)*.02+t%2*.01;s.seg(n,.48,r,n+.02,.58,r,.01,.01,13351316),s.seg(n+.015,.55,r,n+.025,.61,r,.016,.006,t%3==1?$.bone:e)}s.fill(-.3,-.05,-.3,.3,.6,.3,(e,t)=>Math.abs(-e*1.1-(t-.22))<.025,$.leatherDark,`paint`),t.push({bone:`torso`,part:s});let c=new Z;c.rbox(0,.12,.02,.11,.12,.11,2.5,n),c.rbox(0,.04,.06,.1,.055,.09,3,r),c.box(-.025,.08,.1,.025,.13,.15,X($.hideArcher,.9)),c.box(-.075,.12,.09,-.04,.145,.14,$.eyeRed,`paint`),c.box(.04,.12,.09,.075,.145,.14,$.eyeRed,`paint`);for(let e of[1,-1])tf(c,e,.05,.03,.12,.06,.016);c.fill(-.2,0,-.25,.2,.34,.2,(e,t,n)=>{let r=e/.145,i=(t-.15)/.16,a=(n+.01)/.145;return r*r+i*i+a*a<=1&&!(n>.02&&t<.2&&Math.abs(e)<.09)},(e,t)=>t<.04?X(i,.85):i),c.seg(0,.22,-.1,0,.3,-.2,.05,.015,i);for(let e of[1,-1])ef(c,e,.13,.15,0,.12,n);t.push({bone:`head`,part:c});for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.3,.02,.058,.062,1.1,n),i.tubeY(0,0,-.08,.03,.07,.072,1,a),t.push({bone:e===`L`?`armL`:`armR`,part:i});let o=new Z;o.tubeY(0,0,-.27,.01,.05,.052,1.15,n),e===`L`&&o.tubeY(0,0,-.25,-.07,.062,.064,1.1,$d($.leather,$.leatherDark,.06)),nf(o,.31,.052,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:o})}for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.43,.04,.075,.08,1.2,5061418),t.push({bone:e===`L`?`thighL`:`thighR`,part:i});let a=new Z;a.tubeY(0,0,-.42,0,.058,.062,1.15,n),a.tubeY(0,0,-.4,-.08,.065,.068,1.1,$d($.clothBrown,X($.clothBrown,.8),.045)),rf(a,.47,.062,.085,r),t.push({bone:e===`L`?`shinL`:`shinR`,part:a})}let l=new Z;l.jitter=.04,l.fill(-.02,-.56-.05,-.2,.02,.6100000000000001,.1,(e,t,n)=>{let r=Math.abs(t)/vf;if(r>1)return!1;let i=-.13*r*r+.035*Math.max(0,r-.8)/.2,a=.032-.016*r;return Math.abs(n-i)<a},(e,t)=>{let n=Math.abs(t)/vf;return n<.12?$.leatherDark:n>.88?$.bone:Math.abs(n-.5)<.03?$.boneDark:$.timber}),t.push({bone:`weapon`,part:l});let u=new Z,d=new Z;u.jitter=d.jitter=0,u.box(0,-.53,0,.01,0,.01,bf),d.box(0,0,0,.01,.53,.01,bf),t.push({bone:`stringT`,part:u},{bone:`stringB`,part:d});let f=new Z;return f.jitter=.03,f.box(0,0,yf,.01,.01,.5,13351316),f.seg(0,0,.48,0,0,.6,.026,.005,$.ironLight),f.box(-.03,-.01,-.11,.03,.01,-.01999999999999999,e),f.box(-.01,-.03,-.11,.01,.03,-.01999999999999999,e),t.push({bone:`extra`,part:f}),t}var Cf=[.1,.38,.5,0,.08,-.18];function wf(e,t){let n=fu(Q(t,0,.26)),r=t>=.74,i=mu(Q(t,.84,1.1));_u(e,Cf,n*(1-i)),e[Y.xS]=Q(t,.12,.18)*+!r,e[Y.ikR]=hu(Q(t,.1,.28))*(1-hu(Q(t,.84,1)));let a=fu(Q(t,.3,.62)),o=fu(Q(t,.74,.8));e[Y.xZ]=-.4*a-.1*o,e[Y.tRY]+=-.22*n*(1-i),e[Y.tRX]-=.06*n,e[Y.nRY]+=.22*n*(1-i),e[Y.nRX]+=.05*n;let s=gu(t,.74,.76,.9);e[Y.wRX]-=.12*s,e[Y.wZ]+=.03*s,e[Y.tRY]+=.06*s}var Tf={kind:`orc_archer`,defaultTint:$.fletch,height:1.9,rig:xf,parts:Sf,hunch:.2,stance:.07,loco:{walkHz:.95,runHz:1.45,stride:.45,runStride:.8,knee:.75,runKnee:1.4,bob:.03,armSwing:.4,lean:.25},carry:[.3,-.02,.14,.5,0,-.1],drop:[.38,.1,0,0,0,0],gripL:[0,0,0],gripR:[0,0,yf],gripROnExtra:!0,ikIdle:[1,0],poleL:[.9,-.6,-.1],poleR:[-.9,-.3,-.4],muzzle:{bone:`extra`,p:[0,0,.6]},attackDur:1.1,attack:wf,deathDepth:.14,extraScale:0},Ef={hips:[0,.9,0],torso:[0,.1,0],head:[0,.45,.06],shoulder:[.21,.37,0],upperLen:.29,handLen:.3,hip:[.09,-.03,0],thighLen:.42,extra:[0,.86,0]},Df=10354522|eu;function Of(e){let t=[],n=Zd($.hideShaman,.3,0,31),r=Zd(X($.hideShaman,.85),.3,0,32),i=(t,n,r)=>Xd(t,n,r,.12,33)>.7?X(e,.8):e,a=(e,t,n)=>X(7035464,.85+.3*ou(e/Zl|0,t/Zl|0,n/Zl|0)),o=new Z;o.fill(-.4,-.86,-.4,.4,.08,.4,(e,t,n)=>{let r=Math.min(1,-t/.86),i=.19+.13*r,a=.15+.12*r;return(e/i)**2+(n/a)**2<=1&&t>-.86+.03*Math.abs(Math.sin(e*30+n*20))},(e,t,n)=>t<-.72?t>-.78&&(Math.atan2(n,e)*8|0)%3==0&&ou(e/Zl|0,7,n/Zl|0)>.4?$.acid:t<-.8?$.corruptDeep:$.corrupt:i(e,t,n)),o.tubeY(0,0,0,.06,.2,.16,1,10521180),o.seg(.08,.02,.15,.1,-.2,.17,.02,.018,10521180),o.rbox(.1,-.24,.17,.035,.04,.03,3,$.bone),t.push({bone:`hips`,part:o});let s=new Z;s.rbox(0,.17,0,.18,.2,.13,2.3,i),s.ell(0,.34,-.03,.2,.1,.15,i),s.ell(0,.4,-.05,.25,.08,.19,a),s.ell(0,.36,-.08,.22,.12,.16,a,`under`),s.fill(-.3,.3,0,.3,.46,.35,(e,t,n)=>{let r=Math.hypot(e/1.1,n-.02);return Math.abs(r-.15)<.018&&t>.36&&t<.42&&n>.02},e=>Math.floor(e/Zl)&1?$.bone:$.boneDark),s.rbox(0,.3,.16,.04,.04,.03,3,$.bone),s.box(-.03,.3,.18,-.01,.32,.2,Df,`paint`),s.box(.01,.3,.18,.03,.32,.2,Df,`paint`),s.fill(-.3,0,.05,.3,.3,.3,(e,t,n)=>Xd(e,t,n,.1,34)>.68,$.corrupt,`paint`),t.push({bone:`torso`,part:s});let c=new Z;c.rbox(0,.11,.03,.105,.12,.11,2.4,n),c.rbox(0,.03,.07,.095,.06,.09,3,r),c.seg(0,.14,.12,0,.07,.19,.03,.022,X($.hideShaman,.9)),c.box(-.075,.12,.1,-.04,.15,.15,Df,`paint`),c.box(.04,.12,.1,.075,.15,.15,Df,`paint`);for(let e of[1,-1])tf(c,e,.05,.03,.13,.06,.016),ef(c,e,.1,.1,0,.15,n);c.seg(0,0,.1,0,-.1,.12,.035,.012,12105384),c.fill(-.2,.15,-.2,.2,.34,.26,(e,t,n)=>{let r=e/.13,i=(t-.2)/.1,a=(n-.02)/.14;return r*r+i*i+a*a<=1&&t>.17},(e,t,n)=>n>.08&&Math.abs(Math.abs(e)-.05)<.02?$.charcoal:$.bone),c.rbox(0,.22,.17,.06,.04,.07,2.5,$.boneDark);for(let e of[1,-1])c.seg(.1*e,.26,.02,.2*e,.36,-.06,.035,.028,$.boneDark),c.seg(.2*e,.36,-.06,.22*e,.46,.04,.028,.01,$.bone);t.push({bone:`head`,part:c});for(let e of[`L`,`R`]){let a=new Z;a.tubeY(0,0,-.3,.03,.065,.068,1.25,i),t.push({bone:e===`L`?`armL`:`armR`,part:a});let o=new Z;o.tubeY(0,0,-.12,.01,.085,.088,1.1,(e,t,n)=>t<-.1?$.corrupt:i(e,t,n)),o.tubeY(0,0,-.27,-.1,.045,.047,1,n),o.tubeY(0,0,-.23,-.2,.055,.057,1,$.bone),nf(o,.3,.05,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:o})}for(let r of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.42,.03,.07,.075,1.1,X(e,.7)),t.push({bone:r===`L`?`thighL`:`thighR`,part:i});let a=new Z;a.tubeY(0,0,-.4,0,.052,.055,1.1,n),rf(a,.45,.06,.085,7166530),t.push({bone:r===`L`?`shinL`:`shinR`,part:a})}let l=new Z;l.jitter=.06;let u=[[0,-.92,0],[.02,-.5,-.01],[-.015,-.1,.01],[.01,.3,0],[-.01,.7,.015]];for(let e=0;e+1<u.length;e++){let[t,n]=[u[e],u[e+1]];l.seg(t[0],t[1],t[2],n[0],n[1],n[2],.03,.03,(e,t,n)=>Math.abs(t)<.06?$.leatherDark:Xd(e,t,n,.05,35)>.6?$.timber:$.timberDark)}l.ell(0,.4,0,.045,.03,.045,$.bone),l.ell(0,.46,0,.04,.02,.04,$.fletch);for(let[e,t]of[[.07,0],[-.05,.05],[-.03,-.07]])l.seg(0,.7,0,e,.84,t,.022,.018,$.timberDark),l.seg(e,.84,t,e*.5,.97,t*.5,.018,.008,$.boneDark);t.push({bone:`weapon`,part:l});let d=new Z;return d.fill(-.06,-.1,-.06,.06,.12,.06,(e,t,n)=>Math.abs(e)+Math.abs(n)+Math.abs(t)*.55<.065,(e,t)=>t>.02?5111590|eu|tu:2277392|eu|tu),t.push({bone:`extra`,part:d}),t}var kf=[-.2,.66,.2,-.4,0,.1],Af=[-.16,.36,.44,.55,0,0];function jf(e,t){let n=fu(Q(t,0,.4)),r=fu(Q(t,.44,.58)),i=mu(Q(t,.7,1.15));_u(e,kf,n*(1-r)),_u(e,Af,r*(1-i));let a=n*(1-r),o=r*(1-i);e[Y.tRX]+=-.25*a+.25*o,e[Y.nRX]+=-.35*a+.1*o,e[Y.hY]+=.02*a-.05*o,e[Y.aLX]+=-2*a-1.5*o,e[Y.aLZ]+=.5*a+.1*o,e[Y.fL]+=-.5*a+.2*o,e[Y.glow]=hu(Q(t,.15,.4))*(1-hu(Q(t,.7,.9))),e[Y.xS]=1+.6*hu(Q(t,.1,.44))*(1-i)+.5*gu(t,.44,.5,.7),e[Y.bS]+=.03*gu(t,.44,.48,.65)}function Mf(e,t){e[Y.xS]*=1+.08*Math.sin(t*3.1)}var Nf={kind:`orc_shaman`,defaultTint:$.robe,height:1.9,rig:Ef,parts:Of,hunch:.28,stance:.06,loco:{walkHz:.8,runHz:1.2,stride:.34,runStride:.6,knee:.6,runKnee:1.1,bob:.03,armSwing:.3,lean:.2},carry:[-.28,.06,.2,-.26,0,.05],drop:[-.34,.2,0,0,0,0],gripL:null,gripR:[0,0,0],muzzle:{bone:`extra`,p:[0,0,0]},attackDur:1.15,attack:jf,deathDepth:.16,idleExtra:Mf},Pf={hips:[0,1.24,0],torso:[0,.14,0],head:[0,.63,.08],shoulder:[.42,.53,0],upperLen:.42,handLen:.42,hip:[.18,-.04,0],thighLen:.58,cape:[0,.6,-.22]},Ff=3817028;function If(e,t,n){let r=Xd(e,t,n,.08,41);return r>.7?$.rust:r<.25?X(Ff,1.25):Ff}function Lf(e){let t=[],n=Zd($.hideChief,.6,1,41),r=Zd(X($.hideChief,.85),.55,.6,42),i=4140578,a=t=>(n,r,i)=>Math.abs((r*100|0)%9)<2?e:t(n,r,i),o=new Z;o.rbox(0,-.03,0,.29,.16,.22,2.8,i),o.tubeY(0,0,-.4,0,.31,.25,1.12,(e,t,n)=>Math.abs(e)<.02||Math.abs(n)<.02&&t<-.1?-1:t<-.36?$.bronze:If(e,t,n)),o.tubeY(0,0,-.01,.1,.32,.25,1,$d($.leatherDark,$.bronze,.05)),o.box(-.13,-.56,.25,.13,.02,.3,(t,n,r)=>n<-.48&&ou(t*40|0,2,r*40|0)>.5?-1:e),o.box(-.15,-.5,-.3,.15,.02,-.25,(t,n)=>n<-.42&&ou(t*40|0,3,0)>.5?-1:X(e,.8));for(let e of[1,-1])o.rbox(.24*e,-.02,.2,.05,.055,.045,3,$.bone),o.box(.24*e-.035,-.01,.23,.24*e-.01,.015,.26,$.charcoal,`paint`),o.box(.24*e+.01,-.01,.23,.24*e+.035,.015,.26,$.charcoal,`paint`);t.push({bone:`hips`,part:o});let s=new Z;s.rbox(0,.15,.05,.3,.22,.25,2.3,n),s.ell(0,.38,.02,.4,.25,.28,n),s.ell(0,.5,-.08,.3,.15,.22,r),s.fill(-.4,.05,.08,.4,.58,.5,(e,t)=>Math.abs(e)<.3-(t-.05)*.12,(e,t,n)=>Math.abs(Math.abs(e)-(.29-(t-.05)*.12))<.035||Math.abs(t-.07)<.03?$.bronze:If(e,t,n),`paint`),s.rbox(0,.36,.3,.07,.07,.04,3,$.bone),s.box(-.045,.37,.33,-.01,.4,.36,$.eyeRed,`paint`),s.box(.01,.37,.33,.045,.4,.36,$.eyeRed,`paint`),s.ell(0,.58,-.04,.3,.08,.24,(e,t,n)=>X(3878953,.85+.35*ou(e*40|0,t*40|0,n*40|0)));for(let e of[1,-1]){let t=.43*e;s.fill(t-.22,.52,-.22,t+.22,.8,.22,(e,n,r)=>{let i=(e-t)/.2,a=(n-.57)/.14,o=r/.2;return i*i+a*a+o*o<=1&&n>.53},(e,t,n)=>t<.58?$.bronzeLight:If(e,t,n)),s.seg(t+.04*e,.66,0,t+.2*e,.9,-.02,.05,.012,$.bone),s.seg(t+.12*e,.63,.1,t+.26*e,.78,.14,.035,.008,$.boneDark),s.seg(t+.12*e,.63,-.1,t+.26*e,.78,-.14,.035,.008,$.boneDark)}s.seg(.16,.1,-.3,.18,1.35,-.32,.03,.028,(e,t)=>Math.abs(t-.7)<.03?$.bronze:$.timberDark),s.rbox(.18,1.4,-.32,.055,.06,.055,3,$.bone),s.box(.15,1.39,-.28,.17,1.41,-.26,$.eyeRed,`paint`),s.box(.19,1.39,-.28,.21,1.41,-.26,$.eyeRed,`paint`),s.fill(.19,.8,-.34,.6,1.3,-.3,(e,t)=>t<1.28-(e-.19)*.25&&t>.82+(e-.19)*.35*(.5+.5*Math.sin(e*40)),(t,n)=>Math.abs(n-1.05+(t-.19)*.05)<.07&&t>.28&&t<.44?$.bone:t<.22||n>1.23?$.bronze:e),t.push({bone:`torso`,part:s});let c=new Z;c.fill(-.4,-1.05,-.16,.4,0,.02,(e,t,n)=>{let r=.28+.1*Math.min(1,-t);if(Math.abs(e)>r||t<-.95&&ou(e*40|0,9,0)>.5)return!1;let i=e/r*-.1*(e/r)-.03*-t;return n>i-.05&&n<=i+.001},(t,n,r)=>Xd(t,n,r,.1,43)>.7?X(e,.75):n<-.85?X(e,.85):e),t.push({bone:`cape`,part:c});let l=new Z;l.rbox(0,.13,.03,.15,.15,.14,2.5,n),l.rbox(0,.03,.08,.165,.08,.13,3,r),l.fill(-.22,.14,-.22,.22,.36,.22,(e,t,n)=>{let r=e/.17,i=(t-.15)/.17,a=(n-.02)/.165;return r*r+i*i+a*a>1?!1:!(n>.08&&t<.2&&Math.abs(e)<.11)},(e,t,n)=>t<.2?$.bronze:If(e,t,n)),l.box(-.02,.1,.15,.02,.22,.2,$.bronze);for(let e=0;e<5;e++){let t=.1-e*.07;l.seg(0,.3,t,0,.42-e*.015,t-.03,.028,.008,e%2?$.boneDark:$.bone)}for(let e of[1,-1])l.seg(.15*e,.24,.02,.28*e,.3,0,.05,.035,$.boneDark),l.seg(.28*e,.3,0,.33*e,.46,.08,.035,.01,$.bone),tf(l,e,.1,.02,.18,.17,.032);l.box(-.095,.13,.13,-.045,.15,.19,$.eyeRed,`paint`),l.box(.045,.13,.13,.095,.15,.19,$.eyeRed,`paint`),l.box(-.1,.04,.19,.1,.06,.23,$.charcoal,`paint`),t.push({bone:`head`,part:l});for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.42,.04,.12,.125,1.15,a(n)),i.ell(0,-.2,.04,.13,.14,.11,a(n)),t.push({bone:e===`L`?`armL`:`armR`,part:i});let o=new Z;o.ell(0,-.01,0,.11,.08,.11,n),o.tubeY(0,0,-.36,0,.095,.095,1.25,n),o.tubeY(0,0,-.33,-.1,.115,.115,1.12,(e,t,n)=>Math.abs(t+.12)<.02||Math.abs(t+.31)<.02?$.bronzeLight:If(e,t,n)),o.seg(0,-.2,-.1,0,-.18,-.24,.03,.008,$.bone),o.seg(.1,-.2,0,.2,-.18,0,.025,.008,$.bone),o.seg(-.1,-.2,0,-.2,-.18,0,.025,.008,$.bone),nf(o,.42,.095,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:o})}for(let e of[`L`,`R`]){let r=new Z;r.tubeY(0,0,-.58,.06,.145,.155,1.2,i),r.fill(-.2,-.5,0,.2,-.1,.25,(e,t,n)=>n>.05,If,`paint`),t.push({bone:e===`L`?`thighL`:`thighR`,part:r});let a=new Z;a.ell(0,-.01,.03,.12,.1,.12,$.bronze),a.tubeY(0,0,-.52,0,.11,.115,1.1,n),a.tubeY(0,0,-.46,-.08,.125,.125,1.08,(e,t,n)=>Math.abs(t+.1)<.02?$.bronze:If(e,t,n)),rf(a,.62,.11,.14,If),t.push({bone:e===`L`?`shinL`:`shinR`,part:a})}let u=new Z;return u.jitter=.05,u.seg(0,-.42,0,0,1.3,0,.04,.04,(e,t)=>Math.abs(t-.15)<.25?$d($.leatherDark,$.leather,.06)(0,t,0):Math.abs(t-.6)<.03||Math.abs(t-.85)<.03?$.bronze:$.timberDark),u.ell(0,-.44,0,.06,.05,.06,$.bronze),u.fill(-.025,.85,-.45,.025,1.45,.45,(e,t,n)=>{let r=Math.abs(n);if(r<.03)return!1;let i=.07+.55*Math.max(0,r-.04);return Math.abs(t-1.15)<Math.min(i,.26)&&r<.36+.06*(1-Math.abs(t-1.15)/.26)},(e,t,n)=>{let r=Math.abs(n);return r>.33?$.ironLight:r>.3?$.acid:Xd(e,t,n,.07,44)>.66?$.rust:Ff}),u.rbox(0,1.15,0,.055,.12,.055,3,$.bronze),u.seg(0,1.26,0,0,1.46,0,.04,.01,$.ironLight),t.push({bone:`weapon`,part:u}),t}var Rf=[-.28,.85,-.05,-.9,.3,.6],zf=[.08,.05,.58,1.45,-.2,-.45];function Bf(e,t){let n=fu(Q(t,0,.45)),r=pu(Q(t,.42,.58)),i=mu(Q(t,.78,1.2));_u(e,Rf,n*(1-r)),_u(e,zf,r*(1-i));let a=n*(1-r),o=r*(1-i);e[Y.tRX]+=-.2*a+.4*o,e[Y.tRY]+=-.45*a+.35*o,e[Y.nRX]+=.2*a-.25*o,e[Y.nRY]+=.3*a-.2*o,e[Y.hY]+=.03*a-.14*o,e[Y.hRY]+=-.15*a+.15*o,e[Y.kL]+=.55*o,e[Y.kR]+=.45*o,e[Y.lLX]-=.4*o,e[Y.lRX]+=.2*o,e[Y.cape]+=.4*o-.1*a,e[Y.bS]-=.04*gu(t,.56,.59,.8)}var Vf={kind:`orc_warchief`,defaultTint:9051930,height:2.9,rig:Pf,parts:Lf,hunch:.14,stance:.13,loco:{walkHz:.65,runHz:1,stride:.4,runStride:.65,knee:.65,runKnee:1.15,bob:.06,armSwing:.3,lean:.18},carry:[-.26,.05,.38,.25,0,-.75],drop:[-.62,-.1,0,0,0,0],gripR:[0,0,0],gripL:[0,.32,0],poleL:[.9,-.5,-.3],poleR:[-.9,-.5,-.3],muzzle:{bone:`weapon`,p:[0,1.15,.3]},attackDur:1.2,attack:Bf,deathDepth:.3},Hf=12088356,Uf=3090982,Wf=13221016,Gf=.25,Kf=.2,qf=[.13,.36,.07],Jf={hips:[0,.86,0],torso:[0,.1,0],head:[0,.43,.08],shoulder:[.23,.37,0],upperLen:.3,handLen:.3,hip:[.1,-.03,0],thighLen:.4,extra:[0,0,0]},Yf=e=>Kf-.04*(e/Gf)**2;function Xf(e){let t=[],n=Zd($.hideGrunt,.15,0,41),r=Zd(X($.hideGrunt,.84),.15,0,42),i=(e,t,n)=>Xd(e,t,n,.07,43)>.73?X(Uf,1+.3*ou(e/Zl|0,t/Zl|0,n/Zl|0)):-1,a=5193518,o=new Z;o.rbox(0,-.03,0,.17,.11,.13,2.8,a),o.tubeY(0,0,-.01,.07,.18,.14,1,$d(e,X(e,.8),.05)),o.seg(-.12,.02,.12,-.16,-.22,.14,.03,.022,X(e,.85)),o.box(-.09,-.28,.11,.09,0,.15,(t,n)=>n<-.21&&ou(t*40|0,3,0)>.5?-1:X(e,.75)),o.rbox(.15,-.07,.03,.04,.055,.055,3,$.leather),o.rbox(-.1,-.08,-.12,.05,.05,.04,3,$.leatherDark),t.push({bone:`hips`,part:o});let s=new Z;s.rbox(0,.15,.02,.19,.19,.14,2.3,n),s.ell(0,.3,0,.24,.12,.155,n),s.ell(0,.38,-.05,.17,.08,.12,r),s.fill(-.3,-.05,-.25,.3,.5,.25,()=>!0,i,`paint`),s.fill(-.3,0,.05,.3,.4,.3,(e,t)=>Math.abs(e)<.013&&t>.12,X($.hideGrunt,.75),`paint`),s.fill(-.3,.1,.05,0,.4,.3,(e,t,n)=>Xd(e,t,n,.05,44)>.62&&Math.hypot(e+.1,t-.28)<.08,9059628,`paint`);let c=(e,t)=>Math.abs(e*1-(t-.2));s.fill(-.4,-.05,-.3,.4,.55,.3,(e,t)=>c(e,t)<.03,$.leatherDark,`paint`);for(let e=0;e<4;e++){let t=.08+e*.1,n=t-.2,r=Math.sqrt(Math.max(0,1-(n/.24)**2))*.15+.035;s.ell(n,t,r,.035,.035,.03,Uf),s.seg(n,t+.03,r,n+.01,t+.06,r,.008,.006,9075290)}s.fill(-.3,.33,-.25,.3,.5,.3,(e,t,n)=>{let r=Math.hypot(e/1.05,n+.01);return r>.1&&r<.165&&Math.abs(t-(.43-.12*Math.max(0,n)))<.035},$d(e,X(e,.82),.03)),s.seg(0,.4,.16,.03,.3,.2,.035,.02,X(e,.9)),t.push({bone:`torso`,part:s});let l=new Z;l.rbox(0,.12,.02,.12,.125,.12,2.5,n),l.rbox(0,.035,.07,.12,.06,.1,3,r),l.box(-.12,.14,.09,.12,.18,.16,X($.hideGrunt,.66)),l.box(-.025,.07,.12,.025,.14,.17,X($.hideGrunt,.88)),l.fill(-.2,.09,.05,.2,.16,.2,(e,t,n)=>n>.08&&t<.155,Uf,`paint`),l.box(-.085,.11,.1,-.045,.135,.16,$.eyeRed,`paint`),l.box(.045,.11,.1,.085,.135,.16,$.eyeRed,`paint`),l.fill(-.2,.02,.1,.2,.07,.2,(e,t)=>Math.abs(e)<.08&&Math.abs(t-(.045+.4*e*e))<.014,$.charcoal,`paint`),l.fill(-.2,.02,.1,.2,.07,.2,(e,t)=>Math.abs(e)<.07&&Math.abs(t-(.058+.4*e*e))<.006&&(e/Zl|0)%2==0,$.bone,`paint`);for(let e of[1,-1])tf(l,e,.07,.03,.14,.07,.018);ef(l,1,.115,.14,.02,.15,n),ef(l,-1,.115,.14,.02,.15,n),l.fill(-.35,.1,-.2,-.2,.3,.1,(e,t)=>e<-.2&&t>.17&&t<.2,0,`carve`),l.fill(-.2,.18,-.2,.2,.24,.2,(e,t,n)=>Math.abs(t-(.205-.08*n))<.018&&Math.hypot(e/1.02,n-.02)>.1,$.leatherDark,`paint`);for(let e of[1,-1])l.tubeZ(e*.052,.225,.1,.16,.042,.042,1,$.bronzeLight),l.tubeZ(e*.052,.225,.12,.165,.028,.028,1,2898494),l.box(e*.052-.02,.235,.15,e*.052-.005,.25,.168,12574952);l.box(-.012,.215,.13,.012,.235,.16,$.bronze),l.ell(0,.27,-.04,.05,.035,.05,Uf),l.seg(0,.28,-.05,.02,.36,-.09,.025,.01,X(Uf,1.25)),t.push({bone:`head`,part:l});for(let e of[`L`,`R`]){let a=new Z;a.tubeY(0,0,-.3,.03,.068,.07,1.15,n),a.ell(0,-.12,.02,.07,.085,.07,n),a.fill(-.1,-.3,-.1,.1,.05,.1,()=>!0,i,`paint`),t.push({bone:e===`L`?`armL`:`armR`,part:a});let o=new Z;o.ell(0,-.01,0,.065,.055,.065,n),o.tubeY(0,0,-.27,0,.056,.058,1.12,n),o.tubeY(0,0,-.24,-.06,.064,.066,1.08,$d(Wf,X(Wf,.82),.04)),nf(o,.3,.06,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:o})}for(let i of[`L`,`R`]){let o=new Z;o.tubeY(0,0,-.4,.04,.085,.09,1.15,a),o.box(-.05,-.28,.05,.03,-.16,.11,X(e,.8),`paint`),t.push({bone:i===`L`?`thighL`:`thighR`,part:o});let s=new Z;s.ell(0,-.01,.01,.07,.06,.07,n),s.tubeY(0,0,-.36,0,.06,.064,1.1,n),s.tubeY(0,0,-.32,-.1,.068,.07,1.06,$d(Wf,X(Wf,.8),.05)),rf(s,.43,.068,.09,r),t.push({bone:i===`L`?`shinL`:`shinR`,part:s})}let u=new Z;u.jitter=.04,u.fill(-.2,-.25,-.2,Kf,Gf,Kf,(e,t,n)=>Math.hypot(e,n)<=Yf(t),(e,t,n)=>{let r=Math.hypot(e,n),i=Math.atan2(n,e);if((t>Gf-Zl*1.2||t<-.25+Zl*1.2)&&r<Yf(t)-.03)return X($.timberDark,.85+.1*Math.cos(e*60));if(Math.abs(Math.abs(t)-.2)<.02||Math.abs(Math.abs(t)-.12)<.015)return Xd(e,t,n,.05,45)>.7?$.rust:$.ironDark;let a=Math.floor((i+Math.PI)/(2*Math.PI)*14),o=Math.abs((i+Math.PI)/(2*Math.PI)*14%1-.5)>.44,s=a%2==0?$.timber:X($.timber,.86);return o?X($.timberDark,.9):Xd(e,t,n,.06,46)>.72?X(s,.8):s});let d=(e,t,n)=>Math.hypot(e,n)>Yf(t)-Zl*1.2;u.fill(-.2,-.1,-.2,Kf,.1,Kf,(e,t,n)=>d(e,t,n)&&Math.abs(t)<.095,(e,t,n)=>Xd(e,t,n,.05,47)>.72?9053718:11743774,`paint`),u.fill(-.12,-.12,.08,.12,.12,.25,(e,t,n)=>d(e,t,n)&&(Math.hypot(e,(t-.025)*1.1)<.085||Math.abs(e)<.05&&t<-.02&&t>-.085),$.bone,`paint`),u.fill(-.12,-.12,.08,.12,.12,.25,(e,t,n)=>d(e,t,n)&&(Math.hypot(Math.abs(e)-.036,t-.03)<.019||t<-.045&&t>-.075&&(e/Zl|0)%2==0&&Math.abs(e)<.045),$.charcoal,`paint`),u.tubeY(.09,.05,.24,.28,.03,.03,1,$.ironDark);let f=[[.09,.27,.05],[.12,.3,.04],[.14,.33,.06],qf];for(let e=0;e+1<f.length;e++){let[t,n]=[f[e],f[e+1]];u.seg(t[0],t[1],t[2],n[0],n[1],n[2],.014,.014,e===f.length-2?Uf:10127970)}u.ell(qf[0],qf[1]+.008,qf[2],.02,.02,.02,16751136|eu|tu),u.ell(qf[0],qf[1]+.01,qf[2],.01,.01,.01,16769152|eu|tu);for(let[e,t,n]of[[.035,.025,0],[-.025,.04,.02],[.01,.05,-.025]])u.box(qf[0]+e-.012,qf[1]+t-.012,qf[2]+n-.012,qf[0]+e+.012,qf[1]+t+.012,qf[2]+n+.012,16742938|eu|tu);return t.push({bone:`extra`,part:u}),t}var Zf=[0,.98,-.03,-.12,0,0];function Qf(e,t){let n=fu(Q(t,0,.26));_u(e,Zf,n);let r=n*Q(t,.2,.3);e[Y.wRZ]+=.09*r*Math.sin(t*43),e[Y.wX]+=.02*r*Math.sin(t*37+1),e[Y.tRX]+=-.42*n,e[Y.nRX]+=-.2*n-.12*r*(.5+.5*Math.sin(t*22)),e[Y.hY]+=-.05*gu(t,0,.1,.3)+.02*r*Math.sin(t*30),e[Y.kL]+=.25*n,e[Y.kR]+=.25*n,e[Y.lLX]-=.12*n,e[Y.lRX]-=.12*n,e[Y.bS]+=.03*r*Math.sin(t*30),e[Y.glow]=hu(Q(t,.05,.2))}function $f(e,t){e[Y.wRZ]+=.03*Math.sin(t*5.3)}var ep={warden:sd,warden_shotgun:pd,warden_sniper:Ad,warden_knight:yd,warden_engineer:Id,warden_digger:Kd,warden_sniper_xbow:Nd,warden_knight_great:Ed,warden_engineer_hammer:Hd,warden_digger_spray:Yd,orc_grunt:df,orc_brute:_f,orc_archer:Tf,orc_shaman:Nf,orc_warchief:Vf,orc_bomber:{kind:`orc_bomber`,defaultTint:Hf,height:1.8,rig:Jf,parts:Xf,hunch:.36,stance:.1,loco:{walkHz:1,runHz:1.55,stride:.42,runStride:.78,knee:.75,runKnee:1.4,bob:.045,armSwing:.2,lean:.3},carry:[0,-.04,.3,-.22,0,0],carryRun:[0,0,.29,-.36,0,0],drop:[0,0,.3,0,0,0],gripL:[.20500000000000002,-.01,.03],gripR:[-.2-.005,-.01,.03],poleL:[.9,-.5,-.4],poleR:[-.9,-.5,-.4],muzzle:{bone:`extra`,p:[qf[0],qf[1]+.008,qf[2]]},attackDur:.8,attack:Qf,deathDepth:.17,deathExtraScale:0,idleExtra:$f}},tp=(e,t)=>{let n=ep[e];if(!n)throw Error(`createCharacter: unknown kind ${e}`);return Qu(n,t)};export{Be as $,_n as A,W as B,yi as C,Wt as D,sa as E,ji as F,i as G,qr as H,Vr as I,la as J,so as K,Ga as L,_ as M,Ka as N,tr as O,ca as P,ua as Q,Ii as R,U as S,Ke as T,Ca as U,ai as V,Sa as W,pt as X,oo as Y,xa as Z,pr as _,yu as a,Cr as at,ko as b,lu as c,B as ct,ou as d,Ue as et,Ql as f,Qn as g,ea as h,$u as i,Lr as it,ln as j,vn as k,Zl as l,V as lt,Pn as m,ep as n,ba as nt,eu as o,ho as ot,Jl as p,io as q,$ as r,da as rt,$l as s,_a as st,tp as t,yn as tt,Z as u,Mt as ut,Xi as v,lo as w,G as x,ta as y,Ji as z};