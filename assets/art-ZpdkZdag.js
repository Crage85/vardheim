...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ss(e,t,n){return new xa({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ko,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cs(){return new xa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ls(){return new xa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:us(),fragmentShader:`
	...
	`}var ds=class extends Nt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Xi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
#endif`)}var Gu=null;function Ku(){return Gu||(Gu=new Ta,Gu.onBeforeCompile=Wu,Gu.customProgramCacheKey=()=>`voxel-character-depth`),Gu}var qu=.32,Ju=.12;function Yu(e,t,n=null){let r=new Ca({vertexColors:!0,roughness:.8,metalness:.05});r.emissive.setRGB(t,t,t);let i=new W(n??0);return r.onBeforeCompile=t=>{Wu(t),t.uniforms.uGlow={value:e},t.uniforms.uStatus={value:i},t.uniforms.uStatusMix={value:n===null?0:qu},t.uniforms.uStatusGlow={value:n===null?0:Ju},t.vertexShader=`attribute float glow;
varying float vGlow;
varying vec3 vGrain;
`+t.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>\n\tvGlow = glow;\n\tvGrain = position / ${$l.toFixed(4)} - normal * 0.25;`),t.fragmentShader=`uniform float uGlow;
...
`+t.fragmentShader.replace(`#include <color_fragment>`,`#include <color_fragment>
	...
	totalEmissiveRadiance += glowColor * vGlow * uGlow + uStatus * uStatusGlow;`)},r.customProgramCacheKey=()=>`voxel-character-glow`,r}var Xu=new Map;function Zu(e=null){let t=e??-1,n=Xu.get(t);return n||(n={base:Yu(1,0,e),charged:Yu(2.2,0,e),flashHot:Yu(2,.55,e),flashWarm:Yu(1.5,.25,e)},Xu.set(t,n)),n}var Qu=[0,16,28];function $u(e){let t=e.rig,n=(e,t=1)=>new V(e[0]*t,e[1],e[2]),r=Array(17),i=Array(17),a=(e,t,n)=>{r[e]=n,i[e]=t};a(q.body,-1,new V),a(q.hips,q.body,n(t.hips)),a(q.torso,q.hips,n(t.torso)),a(q.head,q.torso,n(t.head)),a(q.armL,q.torso,n(t.shoulder)),a(q.armR,q.torso,n(t.shoulder,-1)),a(q.foreL,q.armL,new V(0,-t.upperLen,0)),a(q.foreR,q.armR,new V(0,-t.upperLen,0)),a(q.thighL,q.hips,n(t.hip)),a(q.thighR,q.hips,n(t.hip,-1)),a(q.shinL,q.thighL,new V(0,-t.thighLen,0)),a(q.shinR,q.thighR,new V(0,-t.thighLen,0));let o=e.carry;a(q.weapon,q.torso,new V(o[0],o[1],o[2])),a(q.extra,q.weapon,t.extra?n(t.extra):new V),a(q.cape,q.torso,t.cape?n(t.cape):new V);let s=t.bowString;return a(q.stringT,q.weapon,s?new V(0,s.half,s.z):new V),a(q.stringB,q.weapon,s?new V(0,-s.half,s.z):new V),{rest:r,parent:i}}var ed=new Map;function td(e,t,n=`none`){let r=Pu[n];if(!r)throw Error(`createCharacter: unknown warband ${n}`);let i=Object.keys(r).length?n:`none`,a=`${e.kind}:${t}:${i}`,o=ed.get(a);if(o)return o;let{rest:s,parent:c}=$u(e),l=[];for(let e=0;e<17;e++)l[e]=s[e].clone(),c[e]>=0&&l[e].add(l[c[e]]);let u=[],d=[];for(let n of Zl){Ql(n);let r=new lu;for(let{bone:n,part:a}of Fu(i,()=>e.parts(t))){let e=l[q[n]];r.add(a,q[n],e.x,e.y,e.z)}u.push(r.build()),d.push(r.idx.length/3)}return Ql(Xl),o={def:e,geometries:u,rest:s,parent:c,inverses:l.map(e=>new U().makeTranslation(-e.x,-e.y,-e.z)),triangles:d},ed.set(a,o),o}var nd=new V(0,-1,0),rd=new V,id=new V,ad=new V,od=new V,sd=new V,cd=new pt,ld=new pt,ud=new pt,dd=[.75,-.6,-.45],fd=[-.75,-.6,-.45],pd=0,md=class{root=new un;kind;height;def;bones=[];meshes=[];skeleton;rest;scaleVar;ctx;state=`idle`;loop=`idle`;speed=1;rate=1;t=0;clock=0;phase=0;flash=0;status=null;groundSpeed=null;dead=!1;blend=1;blendDur=.2;from=new Float32Array(45);cur=new Float32Array(45);out=new Float32Array(45);muzzleBone;muzzleLocal;constructor(e,t){this.def=e,this.kind=e.kind;let n=td(e,t.tint??e.defaultTint,t.warband);this.rest=n.rest;let r=pd++,i=(r*.6180339887%1+1)%1;this.ctx={seed:i,flip:1},this.scaleVar=e.kind.startsWith(`warden`)?1:.95+.1*((r*.7548776662%1+1)%1),this.height=e.height*this.scaleVar;for(let e=0;e<17;e++){let t=new yi;t.position.copy(n.rest[e]),this.bones.push(t)}for(let e=0;e<17;e++){let t=n.parent[e];t>=0&&this.bones[t].add(this.bones[e])}let a=Zu();this.skeleton=new Ci(this.bones,n.inverses),this.root.add(this.bones[q.body]);let o=new Hr;n.geometries.forEach((e,t)=>{let n=new vi(e,a.base);n.castShadow=!0,n.receiveShadow=!0,n.customDepthMaterial=Ku(),n.boundingSphere=new or(new V(0,this.height*.5,0),this.height*1.15),n.bind(this.skeleton,new U),o.addLevel(n,Qu[t],.1),this.meshes.push(n)}),this.root.add(o),this.muzzleBone=this.bones[e.muzzle.bone===`extra`?q.extra:q.weapon],this.muzzleLocal=new V(...e.muzzle.p),Eu(e,`idle`,`idle`,0,0,0,this.ctx,this.out),this.from.set(this.out),this.apply(this.out)}play(e,t=1){if(!this.dead){if(e===`idle`||e===`walk`||e===`run`){if(this.speed=t,e===this.loop)return;this.loop=e,(this.state===`idle`||this.state===`walk`||this.state===`run`)&&this.startBlend(e,.22);return}this.rate=e===`attack`||e===`reload`?t:1,e===`hit`&&(this.flash=.14,this.ctx.flip=-this.ctx.flip),e===`death`&&(this.dead=!0,this.ctx.flip=this.ctx.seed<.6?1:-1),this.startBlend(e,e===`hit`?.04:e===`death`?.1:.07),this.t=0}}setStatusTint(e){this.status=e}setGroundSpeed(e){this.groundSpeed=e}cycleLength(){let e=this.def.rig,t=this.def.loco,n=(e.hips[1]+e.hip[1])*this.scaleVar*this.root.scale.y;return Math.max(.1,4*n*Math.sin(this.loop===`run`?t.runStride:t.stride))}reset(){this.dead=!1,this.loop=`idle`,this.state=`idle`,this.t=0,this.flash=0,Eu(this.def,`idle`,`idle`,0,this.clock,0,this.ctx,this.out),this.blend=1,this.apply(this.out)}startBlend(e,t){this.from.set(this.out),this.state=e,this.blend=0,this.blendDur=t}update(e){let t=this.def;if(this.clock+=e,this.loop!==`idle`&&!this.dead){let n=this.loop===`run`?t.loco.runHz:t.loco.walkHz,r=this.groundSpeed===null?n*this.speed:this.groundSpeed/this.cycleLength();this.phase=((this.phase+e*r)%1+1)%1}if(this.state!==`idle`&&this.state!==`walk`&&this.state!==`run`){this.t+=e*this.rate;let n=yu(t,this.state);this.t>=n&&(this.state===`death`?this.t=n:this.startBlend(this.loop,.22))}this.flash>0&&(this.flash-=e),Eu(t,this.state,this.loop,this.t,this.clock,this.phase,this.ctx,this.cur),this.blend=Math.min(1,this.blend+e/this.blendDur);let n=mu(this.blend),r=this.out,i=this.from,a=this.cur;for(let e=0;e<45;e++)r[e]=i[e]+(a[e]-i[e])*n;this.apply(r);let o=Zu(this.dead?null:this.status),s=this.flash>.07?o.flashHot:this.flash>0?o.flashWarm:r[J.glow]>.5?o.charged:o.base;for(let e=0;e<this.meshes.length;e++)this.meshes[e].material=s}apply(e){let t=this.bones,n=this.rest,r=this.scaleVar;t[q.body].position.set(e[J.bX],e[J.bY],e[J.bZ]),t[q.body].rotation.set(e[J.bRX],e[J.bRY],e[J.bRZ]);let i=e[J.bS];t[q.body].scale.set(r/Math.sqrt(i),r*i,r/Math.sqrt(i)),t[q.hips].position.set(n[q.hips].x+e[J.hX],n[q.hips].y+e[J.hY],n[q.hips].z+e[J.hZ]),t[q.hips].rotation.set(e[J.hRX],e[J.hRY],e[J.hRZ]),t[q.torso].rotation.set(e[J.tRX],e[J.tRY],e[J.tRZ]),t[q.head].rotation.set(e[J.nRX],e[J.nRY],e[J.nRZ]),t[q.armL].rotation.set(e[J.aLX],e[J.aLY],e[J.aLZ]),t[q.foreL].rotation.set(e[J.fL],0,0),t[q.armR].rotation.set(e[J.aRX],e[J.aRY],e[J.aRZ]),t[q.foreR].rotation.set(e[J.fR],0,0),t[q.thighL].rotation.set(e[J.lLX],0,e[J.lLZ]),t[q.shinL].rotation.set(e[J.kL],0,0),t[q.thighR].rotation.set(e[J.lRX],0,e[J.lRZ]),t[q.shinR].rotation.set(e[J.kR],0,0),t[q.weapon].position.set(e[J.wX],e[J.wY],e[J.wZ]),t[q.weapon].rotation.set(e[J.wRX],e[J.wRY],e[J.wRZ]),t[q.extra].position.set(n[q.extra].x,n[q.extra].y,n[q.extra].z+e[J.xZ]),t[q.extra].scale.setScalar(Math.max(1e-4,e[J.xS])),t[q.cape].rotation.set(e[J.cape],0,0);let a=this.def.rig.bowString;if(a){let n=e[J.xS]>.01?e[J.xZ]:0,r=Math.hypot(a.half,n);t[q.stringT].rotation.x=Math.atan2(-n,a.half),t[q.stringB].rotation.x=Math.atan2(n,a.half),t[q.stringT].scale.y=t[q.stringB].scale.y=r/a.half}let o=this.def;o.gripL&&e[J.ikL]>.001&&this.ik(1,o.gripL,e[J.ikL],o.poleL??dd,!1),o.gripR&&e[J.ikR]>.001&&this.ik(-1,o.gripR,e[J.ikR],o.poleR??fd,o.gripROnExtra===!0)}ik(e,t,n,r,i){let a=this.def,o=this.bones[e>0?q.armL:q.armR],s=this.bones[e>0?q.foreL:q.foreR],c=this.bones[q.weapon];if(rd.set(t[0],t[1],t[2]),i){let e=this.bones[q.extra];e.updateMatrix(),rd.applyMatrix4(e.matrix)}c.updateMatrix(),rd.applyMatrix4(c.matrix);let l=a.rig.upperLen,u=a.rig.handLen;id.subVectors(rd,o.position);let d=id.length();if(d<1e-5)return;id.divideScalar(d),d=Math.min(Math.max(d,Math.abs(l-u)+.01),(l+u)*.999);let f=Math.min(1,Math.max(-1,(l*l+d*d-u*u)/(2*l*d))),p=Math.sqrt(1-f*f);ad.set(r[0],r[1],r[2]).addScaledVector(id,-ad.dot(id)).normalize(),od.copy(o.position).addScaledVector(id,l*f).addScaledVector(ad,l*p),sd.subVectors(od,o.position).divideScalar(l),cd.setFromUnitVectors(nd,sd),sd.copy(o.position).addScaledVector(id,d).sub(od).normalize(),ud.copy(cd).invert(),sd.applyQuaternion(ud),ld.setFromUnitVectors(nd,sd),n>=.999?(o.quaternion.copy(cd),s.quaternion.copy(ld)):(o.quaternion.slerp(cd,n),s.quaternion.slerp(ld,n))}getMuzzleWorldPosition(e){return this.muzzleBone.updateWorldMatrix(!0,!1),e.copy(this.muzzleLocal).applyMatrix4(this.muzzleBone.matrixWorld)}dispose(){this.root.removeFromParent(),this.skeleton.dispose()}};function hd(e,t={}){return new md(e,t)}function gd(e){return td(e,e.defaultTint).triangles}var _d={hips:[0,.96,0],torso:[0,.1,0],head:[0,.46,.01],shoulder:[.215,.37,0],upperLen:.28,handLen:.28,hip:[.1,-.03,0],thighLen:.44,cape:[0,.4,-.13]},vd=4937059,yd=(e,t,n)=>Math.floor(n/Y)&1?e:t;function bd(e){let t=X(e,.72),n=[],r=new Z;r.rbox(0,-.02,0,.165,.11,.12,3,$.cloth),r.tubeY(0,0,-.16,.02,.18,.135,1.1,(e,t)=>yd($.mail,X($.mail,.82),t)),r.tubeY(0,0,0,.08,.185,.14,1,$.leather),r.box(-.04,0,.12,.04,.08,.16,$.gold),r.box(-.1,-.34,.12,.1,0,.17,(t,n)=>n<-.3||Math.abs(t)>.075?$.gold:Math.abs(t)<.03?e:$.white),r.box(-.1,-.3,-.17,.1,0,-.12,(e,t)=>t<-.26||Math.abs(e)>.075?$.gold:$.white),n.push({bone:`hips`,part:r});let i=new Z;i.rbox(0,.1,0,.16,.12,.115,2.4,$.cloth),i.rbox(0,.25,.005,.2,.165,.14,2.6,$.steel),i.fill(-.3,.02,-.3,.3,.3,.3,()=>!0,(t,n,r)=>{if(n>.27)return $.gold;if(r>.08){let r=Math.hypot(t,n-.17);if(r<.045)return e;if(r<.075)return $.gold}return $.white},`paint`),i.box(-.02,.15,.13,.02,.19,.18,$.runeBlue,`paint`),i.fill(-.3,.02,-.3,.3,.44,.3,e=>Math.abs(e)>.17,$.steelDark,`paint`),i.tubeY(0,0,.36,.45,.095,.085,.95,$.steelDark),i.tubeY(0,0,.4,.44,.1,.09,1,$.gold),i.ell(0,.4,-.08,.17,.055,.075,(e,t,n)=>X($.fur,.9+.2*ou(e*50|0,t*50|0,n*50|0)));for(let e of[1,-1]){let t=.235*e;i.fill(t-.12,.28,-.13,t+.12,.45,.13,(e,n,r)=>{let i=(e-t)/.1,a=(n-.35)/.08,o=r/.11;return i*i+a*a+o*o<=1},(e,t)=>t<.31?$.gold:$.steel),i.fill(t-.12,.25,-.12,t+.12,.3,.12,(e,n,r)=>{let i=(e-t*1.06)/.1,a=r/.11;return i*i+a*a<=1&&n>.25},$.steelDark,`under`),i.box(.2*e-.02,.4,.09,.2*e+.02,.44,.13,$.gold,`paint`)}n.push({bone:`torso`,part:i});let a=new Z;a.ell(0,.13,.01,.11,.13,.115,$.skin),a.ell(0,.045,.06,.085,.075,.072,$.beard),a.seg(0,.01,.1,0,-.08,.11,.03,.02,(e,t)=>Math.abs(t+.05)<.015?$.gold:$.beard),a.box(-.055,.075,.1,.055,.1,.155,X($.beard,1.1)),a.fill(-.2,0,-.2,.2,.32,.2,(e,t,n)=>{let r=e/.134,i=(t-.15)/.155,a=(n-.005)/.134;return r*r+i*i+a*a>1?!1:t<.1?n<0:!0},(e,t,n)=>{if(t<.1)return Math.floor(t/Y)&1?$.mail:X($.mail,.85);if(t<.2&&n>.06){let n=Math.abs(Math.abs(e)-.048),r=t-.15;return n<.022&&Math.abs(r)<.018?Math.abs(n)<.012?$.runeBlue:1844275:$.steelDark}return t<.23?$.gold:$.steel}),a.box(-.015,.08,.12,.015,.2,.155,$.steelDark),a.ell(0,.3,-.01,.03,.06,.13,(n,r,i)=>r>.33||i<-.1?e:t),n.push({bone:`head`,part:a});for(let e of[`L`,`R`]){let t=new Z;t.tubeY(0,0,-.28,.02,.058,.06,1,(e,t)=>yd($.mail,X($.mail,.85),t)),n.push({bone:e===`L`?`armL`:`armR`,part:t});let r=new Z;r.ell(0,-.01,0,.055,.05,.055,$.mail),r.tubeY(0,0,-.2,0,.058,.062,1.2,(e,t)=>t>-.05?$.gold:$.steel),r.rbox(0,-.26,.01,.048,.065,.052,2.5,$.leather),n.push({bone:e===`L`?`foreL`:`foreR`,part:r})}for(let e of[`L`,`R`]){let t=new Z;t.tubeY(0,0,-.44,.04,.082,.088,1.2,$.cloth),t.ell(0,-.43,.035,.06,.065,.05,$.steel),n.push({bone:e===`L`?`thighL`:`thighR`,part:t});let r=new Z;r.tubeY(0,0,-.36,0,.066,.07,1.1,$.steel),r.box(-.02,-.34,.05,.02,-.02,.09,$.gold,`paint`),r.rbox(0,-.425,.03,.068,.075,.115,3,$.leatherDark),r.box(-.08,-.5,-.1,.08,-.46,.15,$.sole,`paint`),r.tubeY(0,0,-.37,-.32,.078,.082,1,$.fur),n.push({bone:e===`L`?`shinL`:`shinR`,part:r})}let o=new Z;o.fill(-.3,-.98,-.12,.3,0,.02,(e,t,n)=>{let r=.15+.11*Math.min(1,-t/.9);if(Math.abs(e)>r)return!1;let i=e/r*-.1*(e/r)-.02*-t;return n>i-.045&&n<=i+.001},(n,r)=>r<-.92?$.gold:Math.abs(n)%.08<.04?e:t),n.push({bone:`cape`,part:o});let s=new Z;return s.jitter=.05,s.rbox(0,-.035,-.22,.028,.06,.15,3,(e,t,n)=>n<-.34||Math.abs(n+.2)<.02?$.gold:$.timberDark),s.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),s.rbox(0,.015,.09,.038,.045,.14,3,(e,t,n)=>t>.045||Math.abs(n-.09)>.12?$.gold:vd),s.tubeZ(0,.03,.2,.64,.026,.026,1,(e,t,n)=>Math.abs((n-.3)%.15)<.03?$.gold:X(vd,.85)),s.box(-.012,.06,-.02,.012,.085,.2,(e,t,n)=>Math.floor(n/Y)&1?$.runeBlue:$.gold),s.box(-.018,-.06,.2,.018,0,.34,$.timber),s.rbox(0,.03,.66,.042,.042,.03,3,$.gold),s.ell(0,.03,.715,.028,.028,.035,$.runeBlueHot),n.push({bone:`weapon`,part:s}),n}var xd=[-.13,.31,.12,0,.05,0];function Sd(e,t){let n=hu(Q(t,0,.06));_u(e,xd,n),e[J.nRX]+=.08*n,e[J.tRY]+=.1*n;let r=gu(t,.02,.05,.26);e[J.wZ]-=.075*r,e[J.wRX]-=.32*fu(r),e[J.tRX]-=.07*r,e[J.tRY]+=.05*r,e[J.nRX]-=.05*r,e[J.hZ]-=.015*r,e[J.cape]+=.08*r}function Cd(e,t){let n=hu(Q(t,0,.18))*(1-hu(Q(t,.82,1)));e[J.wRZ]+=.75*n,e[J.wRX]+=.35*n,e[J.wY]-=.05*n,e[J.wZ]-=.04*n,e[J.nRX]+=.28*n,e[J.tRX]+=.06*n;let r=gu(t,.2,.42,.72);e[J.ikL]*=1-r,e[J.aLX]+=.5*r,e[J.fL]-=.6*r;let i=gu(t,.7,.74,.86);e[J.wY]+=.03*i,e[J.wRX]-=.12*i}var wd={kind:`warden`,defaultTint:4165600,height:1.8,rig:_d,parts:bd,hunch:.04,stance:.06,loco:{walkHz:.95,runHz:1.4,stride:.45,runStride:.8,knee:.75,runKnee:1.35,bob:.03,armSwing:.35,lean:.2},carry:[-.14,.12,.2,-.8,.58,0],drop:[-.36,.12,0,-1.57,0,0],carryRun:[-.12,.16,.17,-.95,.68,0],gripR:[0,-.05,0],gripL:[0,-.03,.27],poleL:[.4,-1,-.2],poleR:[-.9,-.6,-.4],muzzle:{bone:`weapon`,p:[0,.03,.76]},attackDur:.34,attack:Sd,reload:Cd,deathDepth:.14},Td=16752714|eu,Ed=.58;function Dd(e){let t=bd(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.05,n.rbox(0,-.04,-.2,.032,.066,.13,3,(e,t,n)=>n<-.3?$.gold:$.timberDark);for(let e=0;e<3;e++)n.box(.03,-.06+e*.035,-.26,.045,-.035+e*.035,-.14,(e,t,n)=>n<-.235?$.gold:Td);n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.rbox(0,.02,.08,.045,.055,.12,3,(e,t,n)=>t>.06||Math.abs(n-.08)>.1?$.gold:vd),n.box(-.012,.07,0,.012,.09,.16,(e,t,n)=>Math.floor(n/Y)&1?Td:$.gold),n.tubeZ(0,.045,.18,.5299999999999999,.036,.036,1,(e,t,n)=>Math.abs((n-.24)%.12)<.025?$.gold:X(vd,.9)),n.tubeZ(0,-.012,.18,.46,.022,.022,1,$.ironDark),n.rbox(0,0,.29,.046,.034,.075,3,(e,t,n)=>Math.abs(n-.29)>.06?$.gold:$.timber),n.tubeZ(0,.045,.52,Ed,.05,.05,1.25,$.gold),n.ell(0,.045,.585,.03,.03,.02,Td),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.04;let i=-.29;return r.seg(.2,-.12,i,-.22,.56,i,.034,.03,(e,t)=>t<.1?$.timberDark:X(vd,.85)),r.rbox(.06,.1,i,.045,.06,.05,3,(e,t)=>Math.abs(t-.1)<.03?$.runeBlue:$.gold),r.ell(-.22,.58,i,.026,.026,.026,$.runeBlueHot),r.seg(-.2,.36,-.2,.22,.02,-.2,.014,.014,$.leather),t.push({bone:`torso`,part:r}),t}function Od(e,t){let n=hu(Q(t,0,.05));_u(e,xd,n),e[J.nRX]+=.08*n,e[J.tRY]+=.1*n;let r=gu(t,0,.04,.3);e[J.wZ]-=.12*r,e[J.wRX]-=.42*fu(r),e[J.tRX]-=.12*r,e[J.tRY]+=.08*r,e[J.nRX]-=.08*r,e[J.hZ]-=.03*r,e[J.cape]+=.12*r;let i=gu(t,.3,.4,.55);e[J.wZ]-=.05*i,e[J.wRZ]+=.18*i;let a=gu(t,.45,.52,.62);e[J.wZ]+=.03*a}function kd(e,t){let n=hu(Q(t,0,.25))*(1-hu(Q(t,.85,1))*.6);e[J.wRZ]-=.55*n,e[J.wRX]+=.2*n,e[J.wY]-=.03*n,e[J.nRX]+=.22*n;let r=gu(t,.3,.55,.8);e[J.ikL]*=1-.8*r,e[J.aLX]-=.35*r,e[J.fL]-=.5*r,e[J.wZ]+=.015*r}var Ad={...wd,kind:`warden_shotgun`,parts:Dd,gripL:[0,-.03,.29],muzzle:{bone:`weapon`,p:[0,.045,.61]},attackDur:.62,attack:Od,reload:kd},jd=.86;function Md(e){let t=wd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.03,n.ell(0,-.15,0,.03,.03,.03,$.gold),n.tubeY(0,0,-.13,.05,.022,.022,1,(e,t)=>Math.floor(t/.03)&1?$.leatherDark:$.leather),n.box(-.02,.05,-.12,.02,.09,.12,(e,t,n)=>Math.abs(n)>.09?$.goldDark:$.gold),n.fill(-.02,.09,-.06,.02,jd,.06,(e,t,n)=>{let r=(t-.09)/.77,i=r<.82?.045-.012*r:.035*(1-(r-.82)/.18);return Math.abs(n)<=i},(e,t,n)=>Math.abs(n)<.012&&t>.14&&t<.72?Math.floor(t/.06)&1?$.runeBlue:X($.steelDark,.9):Math.abs(n)>.03?X($.steel,1.12):$.steel),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.02;let i=(e,t)=>{let n=(.06-e)/.5,r=n<.35?.19:.19*(1-(n-.35)/.65);return n>=0&&n<=1&&Math.abs(t)<=r};return r.fill(.06,-.46,-.21,.1,.07,.21,(e,t,n)=>i(t,n),(t,n,r)=>{if(!i(n+.035,r)||!i(n-.035,r)||!i(n,r+.035)||!i(n,r-.035))return $.gold;if(t<.075)return $.steelDark;let a=Math.hypot(n+.1,r);return a<.035?$.runeBlueHot:a<.06?$.gold:Math.abs(r)<.015||Math.abs(n+.1)<.015?X($.gold,.85):X(e,.9)}),t.push({bone:`foreL`,part:r}),t}var Nd=[-.22,.6,-.02,-.85,.25,.4],Pd=[.08,.22,.46,1.65,-.3,-.55];function Fd(e,t){let n=fu(Q(t,0,.09)),r=pu(Q(t,.08,.17)),i=mu(Q(t,.24,.42));_u(e,Nd,n*(1-r)),_u(e,Pd,r*(1-i)),e[J.tRY]+=-.35*n*(1-r)+.3*r*(1-i),e[J.tRX]+=-.08*n*(1-r)+.18*r*(1-i),e[J.nRY]-=.2*r*(1-i),e[J.hZ]+=.05*r*(1-i),e[J.kL]+=.25*r*(1-i),e[J.lLX]-=.2*r*(1-i),e[J.aLX]+=-.7*(n+r)*.5*(1-i),e[J.aLZ]+=.15*n,e[J.fL]+=-.7*(1-i)*Math.min(1,n+r),e[J.cape]+=.15*gu(t,.1,.16,.4)}var Id={...wd,kind:`warden_knight`,parts:Md,carry:[-.27,-.02,.16,.6,0,.1],carryRun:[-.25,.02,.2,.9,0,.1],drop:[-.36,.1,0,-1.57,0,0],gripR:[0,0,0],gripL:null,muzzle:{bone:`weapon`,p:[0,jd,0]},attackDur:.42,attack:Fd},Ld=1.3;function Rd(e){let t=wd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.03,n.ell(0,-.3,0,.04,.04,.04,$.gold),n.tubeY(0,0,-.28,.05,.024,.024,1,(e,t)=>Math.floor(t/.035)&1?$.leatherDark:$.leather),n.box(-.025,.05,-.19,.025,.1,.19,(e,t,n)=>Math.abs(n)>.15?$.goldDark:$.gold),n.ell(0,.075,0,.035,.035,.035,$.runeBlueHot),n.fill(-.024,.1,-.09,.024,Ld,.09,(e,t,n)=>{let r=(t-.1)/1.2,i=r<.86?.078-.018*r:.064*(1-(r-.86)/.14);return Math.abs(n)<=i},(e,t,n)=>Math.abs(n)<.016&&t>.16&&t<1.1?Math.floor(t/.07)&1?$.runeBlueHot:$.runeBlue:Math.abs(n)>.05?X($.steel,1.15):$.steel),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.02;let i=(e,t)=>{let n=(.3-t)/.5,r=n<.35?.19:.19*(1-(n-.35)/.65);return n>=0&&n<=1&&Math.abs(e)<=r};return r.fill(-.2,-.21,-.27,.2,.31,-.23,(e,t)=>i(e,t),(t,n)=>{if(!i(t,n+.035)||!i(t,n-.035)||!i(t+.035,n)||!i(t-.035,n))return $.gold;let r=Math.hypot(t,n-.14);return r<.035?$.runeBlueHot:r<.06?$.gold:X(e,.9)}),t.push({bone:`torso`,part:r}),t}var zd=[-.06,-.02,.3,.55,0,.3],Bd=[-.3,.42,-.08,-.5,.5,1.1],Vd=[.26,.1,.42,1.35,-.5,-1.2];function Hd(e,t){let n=fu(Q(t,0,.3)),r=pu(Q(t,.3,.44)),i=mu(Q(t,.55,.9));_u(e,Bd,n*(1-r)),_u(e,Vd,r*(1-i)),e[J.tRY]+=-.55*n*(1-r)+.55*r*(1-i),e[J.tRX]+=-.06*n*(1-r)+.22*r*(1-i),e[J.nRY]-=.25*r*(1-i),e[J.hZ]+=.08*r*(1-i),e[J.hY]-=.05*r*(1-i),e[J.kL]+=.35*r*(1-i),e[J.kR]+=.2*r*(1-i),e[J.lLX]-=.25*r*(1-i),e[J.cape]+=.25*gu(t,.3,.42,.75)}var Ud={...Id,kind:`warden_knight_great`,parts:Rd,carry:zd,carryRun:[-.08,.02,.26,.8,0,.35],gripR:[0,0,0],gripL:[0,-.17,0],muzzle:{bone:`weapon`,p:[0,Ld,0]},attackDur:.8,attack:Hd},Wd=4937059,Gd=1;function Kd(e){let t=wd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;return n.jitter=.05,n.rbox(0,-.035,-.24,.028,.065,.16,3,(e,t,n)=>n<-.37||Math.abs(n+.22)<.02?$.gold:$.timberDark),n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.rbox(0,.015,.1,.036,.045,.16,3,(e,t,n)=>t>.045||Math.abs(n-.1)>.14?$.gold:Wd),n.box(-.018,-.06,.24,.018,0,.5,$.timber),n.tubeZ(0,.03,.24,.94,.022,.022,1,(e,t,n)=>Math.abs((n-.3)%.18)<.03?$.gold:X(Wd,.85)),n.tubeZ(0,.1,-.06,.24,.028,.028,1,(e,t,n)=>n<-.03||n>.21?$.gold:$.steelDark),n.box(-.012,.055,.02,.012,.08,.12,$.steelDark),n.ell(0,.1,.25,.02,.02,.012,$.runeBlueHot),n.box(-.012,.06,.26,.012,.085,.5,(e,t,n)=>Math.floor(n/Y)&1?$.runeBlue:$.gold),n.rbox(0,.03,.95,.04,.04,.03,3,$.gold),n.ell(0,.03,Gd,.026,.026,.04,$.runeBlueHot),t.push({bone:`weapon`,part:n}),t}var qd={...wd,kind:`warden_sniper`,parts:Kd,gripL:[0,-.03,.36],muzzle:{bone:`weapon`,p:[0,.03,1.04]}},Jd=.44;function Yd(e){let t=wd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.05,n.rbox(0,-.035,-.13,.026,.055,.09,3,(e,t,n)=>n<-.19?$.gold:$.timberDark),n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.rbox(0,.01,.15,.03,.038,.22,3,(e,t,n)=>t>.035||Math.abs(n-.15)>.19?$.gold:$.timber),n.box(-.008,.045,-.02,.008,.058,.4,(e,t,n)=>Math.floor(n/Y)&1?$.runeBlue:$.gold),n.rbox(0,.105,.05,.034,.034,.075,3,(e,t)=>t>.125?$.gold:Wd);for(let e of[-.018,0,.018])n.box(e-.006,.09,.125,e+.006,.105,.145,$.runeBlueHot);n.fill(-.23,0,.22,.23,.05,.4,(e,t,n)=>Math.abs(n-(.37-.16*e*e/.0529))<.026,e=>Math.abs(e)>.18?$.runeBlueHot:Math.abs(e)<.045?$.gold:$.steel);for(let e of[1,-1])n.seg(.22*e,.028,.215,.012*e,.05,.05,.008,.008,$.runeBlueHot);n.tubeZ(0,.068,.05,Jd,.011,.011,1,$.runeBlue),n.ell(0,.068,.46,.018,.018,.03,$.runeBlueHot),n.rbox(0,.02,.41000000000000003,.032,.03,.02,3,$.gold),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.04;let i=-.29;return r.seg(.22,-.2,i,-.25,.72,i,.028,.022,(e,t)=>t<.02?$.timberDark:X(Wd,.85)),r.rbox(.1,.05,i,.04,.055,.045,3,(e,t)=>Math.abs(t-.05)<.025?$.runeBlue:$.gold),r.seg(.04,.28,-.33999999999999997,-.05,.46,-.33999999999999997,.022,.022,$.steelDark),r.ell(-.25,.74,i,.024,.024,.024,$.runeBlueHot),r.seg(-.2,.36,-.2,.22,.02,-.2,.014,.014,$.leather),t.push({bone:`torso`,part:r}),t}var Xd={...qd,kind:`warden_sniper_xbow`,parts:Yd,gripL:[0,-.03,.17],muzzle:{bone:`weapon`,p:[0,.068,.49]}};function Zd(e){let t=wd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.05,n.rbox(0,-.035,-.2,.03,.06,.13,3,(e,t,n)=>n<-.3?$.bronze:$.timberDark),n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.rbox(0,.02,.1,.05,.055,.12,3,(e,t,n)=>t>.055||Math.abs(n-.1)>.1?$.bronzeLight:$.bronze),n.ell(0,.03,.12,.034,.034,.05,$.runeBlueHot),n.box(-.012,.08,.03,.012,.1,.2,(e,t,n)=>Math.floor(n/Y)&1?$.runeBlue:$.gold),n.tubeZ(0,.03,.2,.52,.026,.026,.9,(e,t,n)=>Math.abs((n-.26)%.1)<.025?$.gold:X($.iron,1.1)),n.fill(-.24,0,.3,.24,.06,.4,(e,t,n)=>Math.abs(n-(.36-e*e*.18/.0576))<.028,e=>Math.abs(e)>.19?$.runeBlueHot:Math.abs(e)<.05?$.gold:$.runeBlue),n.rbox(0,.03,.54,.038,.038,.025,3,$.gold),n.ell(0,.03,.5800000000000001,.022,.022,.03,$.runeBlueHot),t.push({bone:`weapon`,part:n}),t.push({bone:`head`,part:Qd()});let r=new Z;return r.jitter=.04,r.seg(-.2,-.05,-.19,.2,.38,-.19,.018,.018,$.timber),r.rbox(.2,.4,-.19,.06,.045,.05,3,e=>e>.25?$.ironLight:$.iron),r.box(.17,.39,-.245,.23,.41,-.235,$.runeBlue,`paint`),r.box(-.22,.2,-.16,.22,.23,-.13,$.leather),t.push({bone:`torso`,part:r}),t}function Qd(){let e=new Z;e.jitter=.02,e.tubeY(0,.005,.22,.26,.142,.142,1,$.leatherDark,`under`);for(let t of[1,-1])e.tubeZ(.05*t,.24,.12,.16,.034,.03,1,$.bronzeLight),e.tubeZ(.05*t,.24,.15,.165,.022,.02,1,$.runeBlueHot);return e}var $d={...wd,kind:`warden_engineer`,parts:Zd,gripL:[0,-.03,.24],muzzle:{bone:`weapon`,p:[0,.03,.6100000000000001]}},ef=.62;function tf(e){let t=wd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.03,n.tubeY(0,0,-.2,.57,.024,.024,1,(e,t)=>t<.02?Math.floor(t/.035)&1?$.leatherDark:$.leather:$.timber),n.ell(0,-.22,0,.032,.03,.032,$.bronze),n.tubeY(0,0,.52,.57,.034,.034,1,$.gold),n.rbox(0,ef,.03,.085,.095,.125,3,(e,t,n)=>Math.abs(t-ef)>.07?$.ironLight:n>.13?$.bronzeLight:$.iron),n.box(-.065,.5549999999999999,.155,.065,.685,.17,(e,t)=>Math.abs(e)<.018||Math.abs(t-ef)<.018?$.runeBlueHot:$.runeBlue),n.seg(0,.64,-.08,0,.7,-.24,.035,.012,$.ironDark),t.push({bone:`weapon`,part:n}),t.push({bone:`head`,part:Qd()});let r=new Z;r.jitter=.04;let i=-.28;return r.seg(.2,-.12,i,-.16,.44,i,.03,.026,(e,t)=>t<.05?$.timberDark:$.bronze),r.ell(.02,.17,-.30000000000000004,.034,.034,.034,$.runeBlueHot),r.seg(-.32,.34,-.31000000000000005,0,.54,-.31000000000000005,.02,.02,e=>Math.abs(e+.16)>.12?$.runeBlueHot:$.runeBlue),r.seg(-.2,.36,-.2,.22,.02,-.2,.014,.014,$.leather),t.push({bone:`torso`,part:r}),t}var nf=[-.18,.62,-.05,-1.25,.15,.25],rf=[-.02,.05,.5,1.45,0,-.1];function af(e,t){let n=fu(Q(t,0,.16)),r=pu(Q(t,.16,.26)),i=mu(Q(t,.32,.55));_u(e,nf,n*(1-r)),_u(e,rf,r*(1-i)),e[J.tRX]+=-.12*n*(1-r)+.3*r*(1-i),e[J.nRX]+=.12*r*(1-i),e[J.hY]-=.04*r*(1-i),e[J.kL]+=.25*r*(1-i),e[J.kR]+=.25*r*(1-i);let a=gu(t,.26,.29,.36);e[J.wY]+=.05*a,e[J.cape]+=.15*gu(t,.18,.26,.5)}var of={...Id,kind:`warden_engineer_hammer`,parts:tf,carry:[-.25,-.04,.14,.45,0,.1],carryRun:[-.24,0,.18,.8,0,.1],gripR:[0,0,0],gripL:null,muzzle:{bone:`weapon`,p:[0,ef,.17]},attackDur:.58,attack:af},sf=.8;function cf(e,t=0,n=0){let r=new Z;r.jitter=.04;let i=n=>t+n*e,a=(e,t)=>[Math.min(i(e),i(t)),Math.max(i(e),i(t))],o=n=>(n-t)*e,[s,c]=a(-.14,-.1);r.box(-.02,s,n-.05,.02,c,n+.05,$.timberDark);let[l,u]=a(-.12,.5);r.tubeY(0,n,l,u,.025,.025,1,(e,t)=>Math.abs(o(t))%.16<.03?$.leatherDark:$.timber);let[d,f]=a(.48,.54);r.tubeY(0,n,d,f,.034,.034,1,$.gold);let[p,m]=a(.52,sf),h=e=>(o(e)-.52)/.28;return r.fill(-.016,p,n-.1,.016,m,n+.1,(e,t,r)=>{let i=h(t),a=i<.2?.05+.2*i:i<.75?.09:.09*(1-(i-.75)/.25)+.015;return Math.abs(r-n)<=a},(e,t,r)=>{let i=h(t);return i>.86?$.runeBlueHot:Math.abs(r-n)<.012&&i>.2?$.runeBlue:Math.abs(r-n)>.065?X($.steel,1.1):$.steelDark}),r}function lf(e){let t=wd.parts(e).filter(e=>e.bone!==`weapon`);t.push({bone:`weapon`,part:cf(1)}),t.push({bone:`foreL`,part:cf(-1,-.28,.03)});let n=new Z;n.jitter=.02,n.rbox(0,.25,.13,.035,.03,.025,3,$.bronze),n.ell(0,.25,.155,.022,.02,.012,$.runeBlueHot),t.push({bone:`head`,part:n});let r=new Z;return r.jitter=.05,r.rbox(.19,-.1,.02,.05,.08,.09,3,(e,t)=>t>-.04?$.leatherDark:$.leather),r.box(.2,-.06,.1,.23,-.02,.115,$.gold),t.push({bone:`hips`,part:r}),t}var uf={...Id,kind:`warden_digger`,parts:lf,muzzle:{bone:`weapon`,p:[0,sf,0]}},df=.52;function ff(e){let t=wd.parts(e).filter(e=>e.bone!==`weapon`),n=new Z;n.jitter=.05,n.rbox(0,-.03,-.14,.028,.05,.09,3,(e,t,n)=>n<-.2?$.gold:$.timberDark),n.box(-.02,-.11,-.05,.02,0,.03,$.timberDark),n.tubeZ(0,-.06,0,.32,.088,.088,1,(e,t,n)=>Math.abs(n-.16)<.05&&t<-.02?$.runeBlueHot:Math.abs(n-.03)<.02||Math.abs(n-.29)<.02?$.gold:$.bronze),n.rbox(0,.05,.14,.032,.03,.16,3,$.bronzeLight),n.seg(.06,-.02,.3,.05,.04,.4,.016,.016,$.leatherDark),n.seg(.05,.04,.4,0,.05,.36,.016,.016,$.leatherDark),n.tubeZ(0,.05,.28,.46,.022,.022,1,(e,t,n)=>Math.abs((n-.3)%.08)<.02?$.gold:$.iron),n.tubeZ(0,.05,.43000000000000005,df,.045,.045,1.8,(e,t,n)=>n>.5?$.runeBlueHot:$.gold),n.box(-.01,.08,.06,.01,.095,.24,(e,t,n)=>Math.floor(n/.04)&1?$.runeBlue:$.gold),t.push({bone:`weapon`,part:n});let r=new Z;r.jitter=.04;let i=-.27;for(let e of[1,-1])r.seg(.22*e,-.18,i,-.16*e,.42,i,.02,.02,$.timber),r.fill(-.22*e-.07,.4,-.29000000000000004,-.22*e+.07,.62,-.25,()=>!0,(e,t)=>t>.58?$.runeBlueHot:$.steelDark);return r.seg(-.2,.36,-.2,.22,.02,-.2,.014,.014,$.leather),t.push({bone:`torso`,part:r}),t.push(...lf(e).slice(-2)),t}var pf={...wd,kind:`warden_digger_spray`,parts:ff,gripL:[0,-.03,.2],muzzle:{bone:`weapon`,p:[0,.05,.55]}},mf={hips:[0,.9,0],torso:[0,.1,0],head:[0,.49,.08],shoulder:[.29,.42,0],upperLen:.33,handLen:.33,hip:[.12,-.03,0],thighLen:.42};function hf(e){let t=[],n=Lu($.hideGrunt,.25,0,1),r=Lu(X($.hideGrunt,.85),.2,0,2),i=5981746,a=new Z;a.rbox(0,-.03,0,.19,.12,.15,2.8,i),a.tubeY(0,0,-.01,.07,.2,.16,1,$.leatherDark),a.rbox(0,.03,.16,.05,.05,.03,3,$.bone),a.box(-.03,.02,.18,-.01,.04,.2,$.charcoal,`paint`),a.box(.01,.02,.18,.03,.04,.2,$.charcoal,`paint`),a.box(-.1,-.34,.12,.1,0,.17,(t,n,r)=>n<-.26&&ou(t*40|0,0,r*40|0)>.55?-1:e),a.box(-.12,-.3,-.17,.12,0,-.12,(t,n)=>n<-.24&&ou(t*40|0,1,0)>.5?-1:X(e,.85)),t.push({bone:`hips`,part:a});let o=new Z;o.rbox(0,.17,.03,.24,.22,.19,2.2,n),o.ell(0,.34,0,.3,.15,.185,n),o.ell(0,.44,-.04,.2,.1,.14,r),o.fill(-.3,0,.1,.3,.45,.3,(e,t)=>Math.abs(e)<.015||Math.abs(t-.27)<.012,X($.hideGrunt,.78),`paint`),o.fill(-.4,-.05,-.3,.4,.55,.3,(e,t)=>Math.abs(e*.95-(t-.22))<.035,(e,t)=>Math.abs(e*.95-(t-.22))<.012&&(t*100|0)%9<2?$.ironLight:$.leatherDark,`paint`),o.fill(.14,.38,-.16,.46,.6,.16,(e,t,n)=>{let r=(e-.3)/.14,i=(t-.43)/.1,a=n/.14;return r*r+i*i+a*a<=1&&t>.4},Ru(.35,.06)),o.seg(.3,.5,0,.34,.62,-.02,.03,.008,$.boneDark),o.seg(.38,.47,.06,.45,.56,.08,.025,.008,$.boneDark),o.fill(-.3,0,.1,.3,.4,.3,(e,t)=>Math.abs(t-(.12+e*.6))<.012&&e>-.12&&e<.08,$.acid,`paint`),t.push({bone:`torso`,part:o});let s=new Z;s.rbox(0,.14,.02,.135,.135,.135,2.5,n),s.rbox(0,.035,.07,.14,.07,.115,3,r),s.box(-.13,.155,.1,.13,.2,.17,X($.hideGrunt,.68)),s.box(-.03,.08,.13,.03,.15,.19,X($.hideGrunt,.9)),s.box(-.09,.12,.11,-.05,.14,.17,$.eyeRed,`paint`),s.box(.05,.12,.11,.09,.14,.17,$.eyeRed,`paint`),s.box(-.08,.045,.16,.08,.065,.2,$.charcoal,`paint`);for(let e of[1,-1])Vu(s,e,.075,.03,.16,.12,.024),Bu(s,e,.125,.15,.02,.14,n);s.ell(0,.29,-.05,.05,.05,.05,$.charcoal),s.seg(0,.29,-.09,0,.13,-.22,.034,.022,zu($.charcoal,X($.charcoal,1.35),.06)),t.push({bone:`head`,part:s});for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.33,.03,.08,.085,1.15,n),i.ell(0,-.14,.03,.085,.1,.08,n),t.push({bone:e===`L`?`armL`:`armR`,part:i});let a=new Z;a.ell(0,-.01,0,.075,.06,.075,n),a.tubeY(0,0,-.29,0,.066,.068,1.15,n),a.tubeY(0,0,-.26,-.1,.074,.075,1.12,zu($.leather,$.leatherDark,.06)),Hu(a,.33,.068,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:a})}for(let e of[`L`,`R`]){let a=new Z;a.tubeY(0,0,-.42,.05,.1,.105,1.2,i),a.box(-.06,-.3,.06,.03,-.18,.13,X($.clothBrown,1.1),`paint`),t.push({bone:e===`L`?`thighL`:`thighR`,part:a});let o=new Z;o.ell(0,-.01,.01,.08,.07,.08,n),o.tubeY(0,0,-.38,0,.07,.075,1.1,n),o.tubeY(0,0,-.34,-.12,.078,.082,1.08,zu($.clothBrown,X($.clothBrown,.8),.05)),Uu(o,.45,.075,.1,r),t.push({bone:e===`L`?`shinL`:`shinR`,part:o})}let c=new Z;return c.jitter=.06,c.seg(0,-.16,0,0,.66,0,.024,.022,(e,t)=>Math.abs(t)<.07?$.leatherDark:Math.abs(t-.3)<.02?$.iron:$.timber),c.ell(0,-.17,0,.032,.03,.032,$.iron),c.fill(-.02,.3,-.02,.02,.84,.36,(e,t,n)=>{if(n<.01)return!1;let r=.06+.6*Math.max(0,n-.02),i=.57+.1*n;return Math.abs(t-i)<Math.min(r,.22)&&n<.3+.06*(1-Math.abs(t-i)/.22)},(e,t,n)=>n>.27?ou(0,t*60|0,3)>.85?-1:$.ironLight:gf(e,t,n)>.62?$.rust:$.iron),c.seg(0,.58,0,0,.6,-.13,.028,.008,$.ironDark),c.tubeY(0,0,.48,.66,.03,.03,1,zu($.leatherDark,$.leather,.05)),t.push({bone:`weapon`,part:c}),t}function gf(e,t,n){return ou(e*25|0,t*25|0,n*25|0)}var _f=[-.2,.72,-.05,-.75,.1,.25],vf=[-.12,.2,.5,1.9,.05,.1];function yf(e,t){let n=fu(Q(t,0,.32)),r=pu(Q(t,.3,.44)),i=mu(Q(t,.52,.85));_u(e,_f,n*(1-r)),_u(e,vf,r*(1-i));let a=-.28*n*(1-r)+.42*r*(1-i);e[J.tRX]+=a,e[J.tRY]+=-.3*n*(1-r)+.2*r*(1-i),e[J.nRX]-=a*.6,e[J.hY]-=.08*r*(1-i),e[J.hZ]+=.05*r*(1-i),e[J.kL]+=.4*r*(1-i),e[J.kR]+=.3*r*(1-i),e[J.lLX]-=.3*r*(1-i),e[J.lRX]+=.2*r*(1-i),e[J.aLX]+=-.9*n*(1-r)+.7*r*(1-i),e[J.aLZ]+=.3*n,e[J.fL]+=-.6*n*(1-r),e[J.bS]+=.04*gu(t,.42,.45,.6)}var bf={kind:`orc_grunt`,defaultTint:$.clothRed,height:2,rig:mf,parts:hf,hunch:.32,stance:.1,loco:{walkHz:.85,runHz:1.3,stride:.42,runStride:.75,knee:.7,runKnee:1.3,bob:.04,armSwing:.45,lean:.25},carry:[-.36,0,.12,.55,0,.12],drop:[-.46,0,0,0,0,0],gripL:null,gripR:[0,0,0],muzzle:{bone:`weapon`,p:[0,.56,.25]},attackDur:.85,attack:yf,deathDepth:.2},xf={hips:[0,1.18,0],torso:[0,.14,0],head:[0,.64,.16],shoulder:[.45,.55,0],upperLen:.44,handLen:.44,hip:[.19,-.04,0],thighLen:.55};function Sf(e){let t=[],n=Lu($.hideBrute,.55,.8,11),r=Lu(X($.hideBrute,.85),.5,.5,12),i=4863270,a=new Z;a.rbox(0,-.03,0,.3,.16,.22,2.8,i),a.tubeY(0,0,-.38,0,.32,.25,1.12,(e,t,n)=>Math.abs(e)<.02||Math.abs(n)<.02&&t<-.1?-1:Ru(.3,.09)(e,t,n)),a.tubeY(0,0,-.01,.1,.33,.25,1,zu($.leatherDark,i,.06)),a.box(-.13,-.5,.25,.13,.02,.3,(t,n,r)=>n<-.42&&ou(t*40|0,2,r*40|0)>.5?-1:e),a.box(-.15,-.46,-.3,.15,.02,-.25,(t,n)=>n<-.38&&ou(t*40|0,3,0)>.5?-1:X(e,.85)),a.rbox(0,.05,.27,.08,.075,.045,3,$.bone),a.box(-.05,.05,.29,-.015,.08,.33,$.charcoal,`paint`),a.box(.015,.05,.29,.05,.08,.33,$.charcoal,`paint`),t.push({bone:`hips`,part:a});let o=new Z;o.rbox(0,.14,.06,.33,.22,.27,2.3,n),o.ell(0,.38,.03,.44,.26,.3,n),o.ell(0,.52,-.1,.34,.17,.24,r),o.fill(-.3,.26,.12,.3,.56,.5,(e,t)=>Math.abs(e)<.26-(t-.26)*.25,Ru(.25,.1),`paint`),o.fill(-.5,0,-.5,.5,.7,.5,(e,t)=>Math.abs(Math.abs(e)-(.2+(t-.3)*.2))<.03&&t>.1,$.leatherDark,`paint`);for(let e of[1,-1]){let t=.46*e;o.fill(t-.24,.5,-.24,t+.24,.8,.24,(e,n,r)=>{let i=(e-t)/.22,a=(n-.56)/.16,o=r/.22;return i*i+a*a+o*o<=1&&n>.52},(e,t,n)=>t<.56?$.ironDark:Ru(.4,.07)(e,t,n)),o.seg(t,.68,0,t+.03*e,.86,-.02,.045,.01,$.boneDark),o.seg(t+.1*e,.64,.08,t+.2*e,.78,.1,.035,.008,$.boneDark),o.seg(t+.1*e,.64,-.08,t+.2*e,.78,-.12,.035,.008,$.boneDark)}t.push({bone:`torso`,part:o});let s=new Z;s.rbox(0,.12,.02,.14,.13,.13,2.5,n),s.rbox(0,.02,.07,.16,.08,.13,3,r),s.fill(-.2,.15,-.2,.2,.32,.2,(e,t,n)=>{let r=e/.155,i=(t-.14)/.15,a=(n-.01)/.15;return r*r+i*i+a*a<=1},(e,t,n)=>t<.18?$.ironLight:Ru(.3)(e,t,n));for(let e of[1,-1])s.seg(.13*e,.22,.02,.24*e,.3,.04,.04,.03,$.boneDark),s.seg(.24*e,.3,.04,.28*e,.42,.12,.03,.01,$.bone),Vu(s,e,.09,.02,.17,.15,.03);s.box(-.09,.1,.12,-.04,.12,.17,$.eyeRed,`paint`),s.box(.04,.1,.12,.09,.12,.17,$.eyeRed,`paint`),s.box(-.1,.03,.18,.1,.05,.22,$.charcoal,`paint`),t.push({bone:`head`,part:s});for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.44,.04,.12,.13,1.15,n),i.ell(0,-.2,.05,.14,.15,.12,n),t.push({bone:e===`L`?`armL`:`armR`,part:i});let a=new Z;a.ell(0,-.01,0,.12,.09,.12,n),a.tubeY(0,0,-.38,0,.1,.1,1.25,n),a.tubeY(0,0,-.34,-.1,.12,.12,1.12,Ru(.3,.08)),a.seg(0,-.22,-.1,0,-.2,-.22,.03,.008,$.boneDark),Hu(a,.44,.1,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:a})}for(let a of[`L`,`R`]){let o=new Z;o.tubeY(0,0,-.55,.06,.15,.16,1.2,i),o.box(-.12,-.44,.08,.1,-.3,.2,X(e,.9),`paint`),t.push({bone:a===`L`?`thighL`:`thighR`,part:o});let s=new Z;s.ell(0,-.01,.02,.12,.1,.12,Ru(.3)),s.tubeY(0,0,-.5,0,.11,.115,1.1,n),s.tubeY(0,0,-.42,-.1,.12,.12,1.1,Ru(.35,.1)),Uu(s,.59,.11,.14,r),t.push({bone:a===`L`?`shinL`:`shinR`,part:s})}let c=new Z;c.jitter=.05,c.seg(0,-.36,0,0,1,0,.042,.042,(e,t)=>Math.abs(t-.16)<.24?zu($.leatherDark,$.leather,.06)(0,t,0):Math.abs(t-.6)<.03?$.iron:$.timberDark),c.ell(0,-.38,0,.06,.05,.06,$.iron),c.rbox(0,1.08,0,.15,.14,.27,4,(e,t,n)=>Math.abs(n)>.22?$.ironDark:Math.abs(e)>.12&&Math.abs(n)<.06&&Math.abs(t-1.08)<.06?$.acid:Iu(e,t,n,.07,9)>.62?$.rust:$.iron);for(let e of[1,-1])c.box(-.08,1,.27*e-.02,.08,1.16,.27*e+.02,$.ironLight,`paint`);return c.seg(0,1.2,0,0,1.36,0,.04,.01,$.ironDark),t.push({bone:`weapon`,part:c}),t}var Cf=[-.05,.95,.05,-.8,0,0],wf=[-.05,0,.58,1.45,0,0];function Tf(e,t){let n=fu(Q(t,0,.5)),r=pu(Q(t,.48,.62)),i=mu(Q(t,.85,1.25));_u(e,Cf,n*(1-r)),_u(e,wf,r*(1-i));let a=-.3*n*(1-r)+.5*r*(1-i);e[J.tRX]+=a,e[J.nRX]-=a*.5,e[J.hY]+=.04*n*(1-r)-.16*r*(1-i),e[J.kL]+=.6*r*(1-i),e[J.kR]+=.6*r*(1-i),e[J.lLX]-=.45*r*(1-i),e[J.lRX]-=.3*r*(1-i),e[J.lLZ]+=.1*r,e[J.lRZ]-=.1*r;let o=gu(t,.6,.63,.85);e[J.bS]-=.05*o,e[J.tRZ]+=.03*Math.sin(t*90)*o}var Ef={kind:`orc_brute`,defaultTint:$.clothBrown,height:2.8,rig:xf,parts:Sf,hunch:.26,stance:.14,loco:{walkHz:.62,runHz:.95,stride:.38,runStride:.62,knee:.65,runKnee:1.15,bob:.07,armSwing:.3,lean:.22},carry:[-.28,.02,.42,.35,0,-1],drop:[-.62,-.1,0,0,0,0],gripR:[0,0,0],gripL:[0,.34,0],poleL:[.9,-.5,-.3],poleR:[-.9,-.5,-.3],muzzle:{bone:`weapon`,p:[0,1.08,0]},attackDur:1.25,attack:Tf,deathDepth:.32},Df=.56,Of=-.12,kf=14274740,Af={hips:[0,.93,0],torso:[0,.1,0],head:[0,.47,.05],shoulder:[.22,.39,0],upperLen:.3,handLen:.31,hip:[.1,-.03,0],thighLen:.43,extra:[0,0,0],bowString:{half:.53,z:Of}};function jf(e){let t=[],n=Lu($.hideArcher,.2,0,21),r=Lu(X($.hideArcher,.85),.2,0,22),i=6178352,a=7296056,o=new Z;o.rbox(0,-.03,0,.16,.11,.12,2.8,5061418),o.tubeY(0,0,-.01,.06,.17,.13,1,$.leatherDark),o.box(-.08,-.3,.1,.08,0,.14,(e,t)=>t<-.25&&ou(e*40|0,5,0)>.5?-1:X($.clothBrown,.9)),o.rbox(.15,-.06,.02,.04,.06,.06,3,$.leather),t.push({bone:`hips`,part:o});let s=new Z;s.rbox(0,.16,.02,.18,.19,.13,2.3,a),s.ell(0,.32,0,.22,.11,.14,a),s.fill(-.3,0,.08,.3,.45,.3,e=>Math.abs(e)<.02,$.leatherDark,`paint`),s.fill(-.3,0,.08,.3,.45,.3,(e,t)=>Math.abs(e)<.02&&(t/Y|0)%3==0,$.bone,`paint`),s.ell(0,.4,0,.2,.06,.14,n),s.ell(0,.41,-.02,.19,.07,.15,i),s.seg(-.1,.02,-.19,.1,.52,-.2,.06,.06,zu($.leather,$.leatherDark,.12)),s.seg(-.1,.02,-.19,.1,.52,-.2,.065,.065,$.leatherDark,`under`);for(let t=0;t<6;t++){let n=.07+t%3*.03,r=-.23+(t>>1)*.02+t%2*.01;s.seg(n,.48,r,n+.02,.58,r,.01,.01,13351316),s.seg(n+.015,.55,r,n+.025,.61,r,.016,.006,t%3==1?$.bone:e)}s.fill(-.3,-.05,-.3,.3,.6,.3,(e,t)=>Math.abs(-e*1.1-(t-.22))<.025,$.leatherDark,`paint`),t.push({bone:`torso`,part:s});let c=new Z;c.rbox(0,.12,.02,.11,.12,.11,2.5,n),c.rbox(0,.04,.06,.1,.055,.09,3,r),c.box(-.025,.08,.1,.025,.13,.15,X($.hideArcher,.9)),c.box(-.075,.12,.09,-.04,.145,.14,$.eyeRed,`paint`),c.box(.04,.12,.09,.075,.145,.14,$.eyeRed,`paint`);for(let e of[1,-1])Vu(c,e,.05,.03,.12,.06,.016);c.fill(-.2,0,-.25,.2,.34,.2,(e,t,n)=>{let r=e/.145,i=(t-.15)/.16,a=(n+.01)/.145;return r*r+i*i+a*a<=1&&!(n>.02&&t<.2&&Math.abs(e)<.09)},(e,t)=>t<.04?X(i,.85):i),c.seg(0,.22,-.1,0,.3,-.2,.05,.015,i);for(let e of[1,-1])Bu(c,e,.13,.15,0,.12,n);t.push({bone:`head`,part:c});for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.3,.02,.058,.062,1.1,n),i.tubeY(0,0,-.08,.03,.07,.072,1,a),t.push({bone:e===`L`?`armL`:`armR`,part:i});let o=new Z;o.tubeY(0,0,-.27,.01,.05,.052,1.15,n),e===`L`&&o.tubeY(0,0,-.25,-.07,.062,.064,1.1,zu($.leather,$.leatherDark,.06)),Hu(o,.31,.052,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:o})}for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.43,.04,.075,.08,1.2,5061418),t.push({bone:e===`L`?`thighL`:`thighR`,part:i});let a=new Z;a.tubeY(0,0,-.42,0,.058,.062,1.15,n),a.tubeY(0,0,-.4,-.08,.065,.068,1.1,zu($.clothBrown,X($.clothBrown,.8),.045)),Uu(a,.47,.062,.085,r),t.push({bone:e===`L`?`shinL`:`shinR`,part:a})}let l=new Z;l.jitter=.04,l.fill(-.02,-.56-.05,-.2,.02,.6100000000000001,.1,(e,t,n)=>{let r=Math.abs(t)/Df;if(r>1)return!1;let i=-.13*r*r+.035*Math.max(0,r-.8)/.2,a=.032-.016*r;return Math.abs(n-i)<a},(e,t)=>{let n=Math.abs(t)/Df;return n<.12?$.leatherDark:n>.88?$.bone:Math.abs(n-.5)<.03?$.boneDark:$.timber}),t.push({bone:`weapon`,part:l});let u=new Z,d=new Z;u.jitter=d.jitter=0,u.box(0,-.53,0,.01,0,.01,kf),d.box(0,0,0,.01,.53,.01,kf),t.push({bone:`stringT`,part:u},{bone:`stringB`,part:d});let f=new Z;return f.jitter=.03,f.box(0,0,Of,.01,.01,.5,13351316),f.seg(0,0,.48,0,0,.6,.026,.005,$.ironLight),f.box(-.03,-.01,-.11,.03,.01,-.01999999999999999,e),f.box(-.01,-.03,-.11,.01,.03,-.01999999999999999,e),t.push({bone:`extra`,part:f}),t}var Mf=[.1,.38,.5,0,.08,-.18];function Nf(e,t){let n=fu(Q(t,0,.26)),r=t>=.74,i=mu(Q(t,.84,1.1));_u(e,Mf,n*(1-i)),e[J.xS]=Q(t,.12,.18)*+!r,e[J.ikR]=hu(Q(t,.1,.28))*(1-hu(Q(t,.84,1)));let a=fu(Q(t,.3,.62)),o=fu(Q(t,.74,.8));e[J.xZ]=-.4*a-.1*o,e[J.tRY]+=-.22*n*(1-i),e[J.tRX]-=.06*n,e[J.nRY]+=.22*n*(1-i),e[J.nRX]+=.05*n;let s=gu(t,.74,.76,.9);e[J.wRX]-=.12*s,e[J.wZ]+=.03*s,e[J.tRY]+=.06*s}var Pf={kind:`orc_archer`,defaultTint:$.fletch,height:1.9,rig:Af,parts:jf,hunch:.2,stance:.07,loco:{walkHz:.95,runHz:1.45,stride:.45,runStride:.8,knee:.75,runKnee:1.4,bob:.03,armSwing:.4,lean:.25},carry:[.3,-.02,.14,.5,0,-.1],drop:[.38,.1,0,0,0,0],gripL:[0,0,0],gripR:[0,0,Of],gripROnExtra:!0,ikIdle:[1,0],poleL:[.9,-.6,-.1],poleR:[-.9,-.3,-.4],muzzle:{bone:`extra`,p:[0,0,.6]},attackDur:1.1,attack:Nf,deathDepth:.14,extraScale:0},Ff={hips:[0,.9,0],torso:[0,.1,0],head:[0,.45,.06],shoulder:[.21,.37,0],upperLen:.29,handLen:.3,hip:[.09,-.03,0],thighLen:.42,extra:[0,.86,0]},If=10354522|eu;function Lf(e){let t=[],n=Lu($.hideShaman,.3,0,31),r=Lu(X($.hideShaman,.85),.3,0,32),i=(t,n,r)=>Iu(t,n,r,.12,33)>.7?X(e,.8):e,a=(e,t,n)=>X(7035464,.85+.3*ou(e/Y|0,t/Y|0,n/Y|0)),o=new Z;o.fill(-.4,-.86,-.4,.4,.08,.4,(e,t,n)=>{let r=Math.min(1,-t/.86),i=.19+.13*r,a=.15+.12*r;return(e/i)**2+(n/a)**2<=1&&t>-.86+.03*Math.abs(Math.sin(e*30+n*20))},(e,t,n)=>t<-.72?t>-.78&&(Math.atan2(n,e)*8|0)%3==0&&ou(e/Y|0,7,n/Y|0)>.4?$.acid:t<-.8?$.corruptDeep:$.corrupt:i(e,t,n)),o.tubeY(0,0,0,.06,.2,.16,1,10521180),o.seg(.08,.02,.15,.1,-.2,.17,.02,.018,10521180),o.rbox(.1,-.24,.17,.035,.04,.03,3,$.bone),t.push({bone:`hips`,part:o});let s=new Z;s.rbox(0,.17,0,.18,.2,.13,2.3,i),s.ell(0,.34,-.03,.2,.1,.15,i),s.ell(0,.4,-.05,.25,.08,.19,a),s.ell(0,.36,-.08,.22,.12,.16,a,`under`),s.fill(-.3,.3,0,.3,.46,.35,(e,t,n)=>{let r=Math.hypot(e/1.1,n-.02);return Math.abs(r-.15)<.018&&t>.36&&t<.42&&n>.02},e=>Math.floor(e/Y)&1?$.bone:$.boneDark),s.rbox(0,.3,.16,.04,.04,.03,3,$.bone),s.box(-.03,.3,.18,-.01,.32,.2,If,`paint`),s.box(.01,.3,.18,.03,.32,.2,If,`paint`),s.fill(-.3,0,.05,.3,.3,.3,(e,t,n)=>Iu(e,t,n,.1,34)>.68,$.corrupt,`paint`),t.push({bone:`torso`,part:s});let c=new Z;c.rbox(0,.11,.03,.105,.12,.11,2.4,n),c.rbox(0,.03,.07,.095,.06,.09,3,r),c.seg(0,.14,.12,0,.07,.19,.03,.022,X($.hideShaman,.9)),c.box(-.075,.12,.1,-.04,.15,.15,If,`paint`),c.box(.04,.12,.1,.075,.15,.15,If,`paint`);for(let e of[1,-1])Vu(c,e,.05,.03,.13,.06,.016),Bu(c,e,.1,.1,0,.15,n);c.seg(0,0,.1,0,-.1,.12,.035,.012,12105384),c.fill(-.2,.15,-.2,.2,.34,.26,(e,t,n)=>{let r=e/.13,i=(t-.2)/.1,a=(n-.02)/.14;return r*r+i*i+a*a<=1&&t>.17},(e,t,n)=>n>.08&&Math.abs(Math.abs(e)-.05)<.02?$.charcoal:$.bone),c.rbox(0,.22,.17,.06,.04,.07,2.5,$.boneDark);for(let e of[1,-1])c.seg(.1*e,.26,.02,.2*e,.36,-.06,.035,.028,$.boneDark),c.seg(.2*e,.36,-.06,.22*e,.46,.04,.028,.01,$.bone);t.push({bone:`head`,part:c});for(let e of[`L`,`R`]){let a=new Z;a.tubeY(0,0,-.3,.03,.065,.068,1.25,i),t.push({bone:e===`L`?`armL`:`armR`,part:a});let o=new Z;o.tubeY(0,0,-.12,.01,.085,.088,1.1,(e,t,n)=>t<-.1?$.corrupt:i(e,t,n)),o.tubeY(0,0,-.27,-.1,.045,.047,1,n),o.tubeY(0,0,-.23,-.2,.055,.057,1,$.bone),Hu(o,.3,.05,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:o})}for(let r of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.42,.03,.07,.075,1.1,X(e,.7)),t.push({bone:r===`L`?`thighL`:`thighR`,part:i});let a=new Z;a.tubeY(0,0,-.4,0,.052,.055,1.1,n),Uu(a,.45,.06,.085,7166530),t.push({bone:r===`L`?`shinL`:`shinR`,part:a})}let l=new Z;l.jitter=.06;let u=[[0,-.92,0],[.02,-.5,-.01],[-.015,-.1,.01],[.01,.3,0],[-.01,.7,.015]];for(let e=0;e+1<u.length;e++){let[t,n]=[u[e],u[e+1]];l.seg(t[0],t[1],t[2],n[0],n[1],n[2],.03,.03,(e,t,n)=>Math.abs(t)<.06?$.leatherDark:Iu(e,t,n,.05,35)>.6?$.timber:$.timberDark)}l.ell(0,.4,0,.045,.03,.045,$.bone),l.ell(0,.46,0,.04,.02,.04,$.fletch);for(let[e,t]of[[.07,0],[-.05,.05],[-.03,-.07]])l.seg(0,.7,0,e,.84,t,.022,.018,$.timberDark),l.seg(e,.84,t,e*.5,.97,t*.5,.018,.008,$.boneDark);t.push({bone:`weapon`,part:l});let d=new Z;return d.fill(-.06,-.1,-.06,.06,.12,.06,(e,t,n)=>Math.abs(e)+Math.abs(n)+Math.abs(t)*.55<.065,(e,t)=>t>.02?5111590|eu|tu:2277392|eu|tu),t.push({bone:`extra`,part:d}),t}var Rf=[-.2,.66,.2,-.4,0,.1],zf=[-.16,.36,.44,.55,0,0];function Bf(e,t){let n=fu(Q(t,0,.4)),r=fu(Q(t,.44,.58)),i=mu(Q(t,.7,1.15));_u(e,Rf,n*(1-r)),_u(e,zf,r*(1-i));let a=n*(1-r),o=r*(1-i);e[J.tRX]+=-.25*a+.25*o,e[J.nRX]+=-.35*a+.1*o,e[J.hY]+=.02*a-.05*o,e[J.aLX]+=-2*a-1.5*o,e[J.aLZ]+=.5*a+.1*o,e[J.fL]+=-.5*a+.2*o,e[J.glow]=hu(Q(t,.15,.4))*(1-hu(Q(t,.7,.9))),e[J.xS]=1+.6*hu(Q(t,.1,.44))*(1-i)+.5*gu(t,.44,.5,.7),e[J.bS]+=.03*gu(t,.44,.48,.65)}function Vf(e,t){e[J.xS]*=1+.08*Math.sin(t*3.1)}var Hf={kind:`orc_shaman`,defaultTint:$.robe,height:1.9,rig:Ff,parts:Lf,hunch:.28,stance:.06,loco:{walkHz:.8,runHz:1.2,stride:.34,runStride:.6,knee:.6,runKnee:1.1,bob:.03,armSwing:.3,lean:.2},carry:[-.28,.06,.2,-.26,0,.05],drop:[-.34,.2,0,0,0,0],gripL:null,gripR:[0,0,0],muzzle:{bone:`extra`,p:[0,0,0]},attackDur:1.15,attack:Bf,deathDepth:.16,idleExtra:Vf},Uf={hips:[0,1.24,0],torso:[0,.14,0],head:[0,.63,.08],shoulder:[.42,.53,0],upperLen:.42,handLen:.42,hip:[.18,-.04,0],thighLen:.58,cape:[0,.6,-.22]},Wf=3817028;function Gf(e,t,n){let r=Iu(e,t,n,.08,41);return r>.7?$.rust:r<.25?X(Wf,1.25):Wf}function Kf(e){let t=[],n=Lu($.hideChief,.6,1,41),r=Lu(X($.hideChief,.85),.55,.6,42),i=4140578,a=t=>(n,r,i)=>Math.abs((r*100|0)%9)<2?e:t(n,r,i),o=new Z;o.rbox(0,-.03,0,.29,.16,.22,2.8,i),o.tubeY(0,0,-.4,0,.31,.25,1.12,(e,t,n)=>Math.abs(e)<.02||Math.abs(n)<.02&&t<-.1?-1:t<-.36?$.bronze:Gf(e,t,n)),o.tubeY(0,0,-.01,.1,.32,.25,1,zu($.leatherDark,$.bronze,.05)),o.box(-.13,-.56,.25,.13,.02,.3,(t,n,r)=>n<-.48&&ou(t*40|0,2,r*40|0)>.5?-1:e),o.box(-.15,-.5,-.3,.15,.02,-.25,(t,n)=>n<-.42&&ou(t*40|0,3,0)>.5?-1:X(e,.8));for(let e of[1,-1])o.rbox(.24*e,-.02,.2,.05,.055,.045,3,$.bone),o.box(.24*e-.035,-.01,.23,.24*e-.01,.015,.26,$.charcoal,`paint`),o.box(.24*e+.01,-.01,.23,.24*e+.035,.015,.26,$.charcoal,`paint`);t.push({bone:`hips`,part:o});let s=new Z;s.rbox(0,.15,.05,.3,.22,.25,2.3,n),s.ell(0,.38,.02,.4,.25,.28,n),s.ell(0,.5,-.08,.3,.15,.22,r),s.fill(-.4,.05,.08,.4,.58,.5,(e,t)=>Math.abs(e)<.3-(t-.05)*.12,(e,t,n)=>Math.abs(Math.abs(e)-(.29-(t-.05)*.12))<.035||Math.abs(t-.07)<.03?$.bronze:Gf(e,t,n),`paint`),s.rbox(0,.36,.3,.07,.07,.04,3,$.bone),s.box(-.045,.37,.33,-.01,.4,.36,$.eyeRed,`paint`),s.box(.01,.37,.33,.045,.4,.36,$.eyeRed,`paint`),s.ell(0,.58,-.04,.3,.08,.24,(e,t,n)=>X(3878953,.85+.35*ou(e*40|0,t*40|0,n*40|0)));for(let e of[1,-1]){let t=.43*e;s.fill(t-.22,.52,-.22,t+.22,.8,.22,(e,n,r)=>{let i=(e-t)/.2,a=(n-.57)/.14,o=r/.2;return i*i+a*a+o*o<=1&&n>.53},(e,t,n)=>t<.58?$.bronzeLight:Gf(e,t,n)),s.seg(t+.04*e,.66,0,t+.2*e,.9,-.02,.05,.012,$.bone),s.seg(t+.12*e,.63,.1,t+.26*e,.78,.14,.035,.008,$.boneDark),s.seg(t+.12*e,.63,-.1,t+.26*e,.78,-.14,.035,.008,$.boneDark)}s.seg(.16,.1,-.3,.18,1.35,-.32,.03,.028,(e,t)=>Math.abs(t-.7)<.03?$.bronze:$.timberDark),s.rbox(.18,1.4,-.32,.055,.06,.055,3,$.bone),s.box(.15,1.39,-.28,.17,1.41,-.26,$.eyeRed,`paint`),s.box(.19,1.39,-.28,.21,1.41,-.26,$.eyeRed,`paint`),s.fill(.19,.8,-.34,.6,1.3,-.3,(e,t)=>t<1.28-(e-.19)*.25&&t>.82+(e-.19)*.35*(.5+.5*Math.sin(e*40)),(t,n)=>Math.abs(n-1.05+(t-.19)*.05)<.07&&t>.28&&t<.44?$.bone:t<.22||n>1.23?$.bronze:e),t.push({bone:`torso`,part:s});let c=new Z;c.fill(-.4,-1.05,-.16,.4,0,.02,(e,t,n)=>{let r=.28+.1*Math.min(1,-t);if(Math.abs(e)>r||t<-.95&&ou(e*40|0,9,0)>.5)return!1;let i=e/r*-.1*(e/r)-.03*-t;return n>i-.05&&n<=i+.001},(t,n,r)=>Iu(t,n,r,.1,43)>.7?X(e,.75):n<-.85?X(e,.85):e),t.push({bone:`cape`,part:c});let l=new Z;l.rbox(0,.13,.03,.15,.15,.14,2.5,n),l.rbox(0,.03,.08,.165,.08,.13,3,r),l.fill(-.22,.14,-.22,.22,.36,.22,(e,t,n)=>{let r=e/.17,i=(t-.15)/.17,a=(n-.02)/.165;return r*r+i*i+a*a>1?!1:!(n>.08&&t<.2&&Math.abs(e)<.11)},(e,t,n)=>t<.2?$.bronze:Gf(e,t,n)),l.box(-.02,.1,.15,.02,.22,.2,$.bronze);for(let e=0;e<5;e++){let t=.1-e*.07;l.seg(0,.3,t,0,.42-e*.015,t-.03,.028,.008,e%2?$.boneDark:$.bone)}for(let e of[1,-1])l.seg(.15*e,.24,.02,.28*e,.3,0,.05,.035,$.boneDark),l.seg(.28*e,.3,0,.33*e,.46,.08,.035,.01,$.bone),Vu(l,e,.1,.02,.18,.17,.032);l.box(-.095,.13,.13,-.045,.15,.19,$.eyeRed,`paint`),l.box(.045,.13,.13,.095,.15,.19,$.eyeRed,`paint`),l.box(-.1,.04,.19,.1,.06,.23,$.charcoal,`paint`),t.push({bone:`head`,part:l});for(let e of[`L`,`R`]){let i=new Z;i.tubeY(0,0,-.42,.04,.12,.125,1.15,a(n)),i.ell(0,-.2,.04,.13,.14,.11,a(n)),t.push({bone:e===`L`?`armL`:`armR`,part:i});let o=new Z;o.ell(0,-.01,0,.11,.08,.11,n),o.tubeY(0,0,-.36,0,.095,.095,1.25,n),o.tubeY(0,0,-.33,-.1,.115,.115,1.12,(e,t,n)=>Math.abs(t+.12)<.02||Math.abs(t+.31)<.02?$.bronzeLight:Gf(e,t,n)),o.seg(0,-.2,-.1,0,-.18,-.24,.03,.008,$.bone),o.seg(.1,-.2,0,.2,-.18,0,.025,.008,$.bone),o.seg(-.1,-.2,0,-.2,-.18,0,.025,.008,$.bone),Hu(o,.42,.095,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:o})}for(let e of[`L`,`R`]){let r=new Z;r.tubeY(0,0,-.58,.06,.145,.155,1.2,i),r.fill(-.2,-.5,0,.2,-.1,.25,(e,t,n)=>n>.05,Gf,`paint`),t.push({bone:e===`L`?`thighL`:`thighR`,part:r});let a=new Z;a.ell(0,-.01,.03,.12,.1,.12,$.bronze),a.tubeY(0,0,-.52,0,.11,.115,1.1,n),a.tubeY(0,0,-.46,-.08,.125,.125,1.08,(e,t,n)=>Math.abs(t+.1)<.02?$.bronze:Gf(e,t,n)),Uu(a,.62,.11,.14,Gf),t.push({bone:e===`L`?`shinL`:`shinR`,part:a})}let u=new Z;return u.jitter=.05,u.seg(0,-.42,0,0,1.3,0,.04,.04,(e,t)=>Math.abs(t-.15)<.25?zu($.leatherDark,$.leather,.06)(0,t,0):Math.abs(t-.6)<.03||Math.abs(t-.85)<.03?$.bronze:$.timberDark),u.ell(0,-.44,0,.06,.05,.06,$.bronze),u.fill(-.025,.85,-.45,.025,1.45,.45,(e,t,n)=>{let r=Math.abs(n);if(r<.03)return!1;let i=.07+.55*Math.max(0,r-.04);return Math.abs(t-1.15)<Math.min(i,.26)&&r<.36+.06*(1-Math.abs(t-1.15)/.26)},(e,t,n)=>{let r=Math.abs(n);return r>.33?$.ironLight:r>.3?$.acid:Iu(e,t,n,.07,44)>.66?$.rust:Wf}),u.rbox(0,1.15,0,.055,.12,.055,3,$.bronze),u.seg(0,1.26,0,0,1.46,0,.04,.01,$.ironLight),t.push({bone:`weapon`,part:u}),t}var qf=[-.28,.85,-.05,-.9,.3,.6],Jf=[.08,.05,.58,1.45,-.2,-.45];function Yf(e,t){let n=fu(Q(t,0,.45)),r=pu(Q(t,.42,.58)),i=mu(Q(t,.78,1.2));_u(e,qf,n*(1-r)),_u(e,Jf,r*(1-i));let a=n*(1-r),o=r*(1-i);e[J.tRX]+=-.2*a+.4*o,e[J.tRY]+=-.45*a+.35*o,e[J.nRX]+=.2*a-.25*o,e[J.nRY]+=.3*a-.2*o,e[J.hY]+=.03*a-.14*o,e[J.hRY]+=-.15*a+.15*o,e[J.kL]+=.55*o,e[J.kR]+=.45*o,e[J.lLX]-=.4*o,e[J.lRX]+=.2*o,e[J.cape]+=.4*o-.1*a,e[J.bS]-=.04*gu(t,.56,.59,.8)}var Xf={kind:`orc_warchief`,defaultTint:9051930,height:2.9,rig:Uf,parts:Kf,hunch:.14,stance:.13,loco:{walkHz:.65,runHz:1,stride:.4,runStride:.65,knee:.65,runKnee:1.15,bob:.06,armSwing:.3,lean:.18},carry:[-.26,.05,.38,.25,0,-.75],drop:[-.62,-.1,0,0,0,0],gripR:[0,0,0],gripL:[0,.32,0],poleL:[.9,-.5,-.3],poleR:[-.9,-.5,-.3],muzzle:{bone:`weapon`,p:[0,1.15,.3]},attackDur:1.2,attack:Yf,deathDepth:.3},Zf=12088356,Qf=3090982,$f=13221016,ep=.25,tp=.2,np=[.13,.36,.07],rp={hips:[0,.86,0],torso:[0,.1,0],head:[0,.43,.08],shoulder:[.23,.37,0],upperLen:.3,handLen:.3,hip:[.1,-.03,0],thighLen:.4,extra:[0,0,0]},ip=e=>tp-.04*(e/ep)**2;function ap(e){let t=[],n=Lu($.hideGrunt,.15,0,41),r=Lu(X($.hideGrunt,.84),.15,0,42),i=(e,t,n)=>Iu(e,t,n,.07,43)>.73?X(Qf,1+.3*ou(e/Y|0,t/Y|0,n/Y|0)):-1,a=5193518,o=new Z;o.rbox(0,-.03,0,.17,.11,.13,2.8,a),o.tubeY(0,0,-.01,.07,.18,.14,1,zu(e,X(e,.8),.05)),o.seg(-.12,.02,.12,-.16,-.22,.14,.03,.022,X(e,.85)),o.box(-.09,-.28,.11,.09,0,.15,(t,n)=>n<-.21&&ou(t*40|0,3,0)>.5?-1:X(e,.75)),o.rbox(.15,-.07,.03,.04,.055,.055,3,$.leather),o.rbox(-.1,-.08,-.12,.05,.05,.04,3,$.leatherDark),t.push({bone:`hips`,part:o});let s=new Z;s.rbox(0,.15,.02,.19,.19,.14,2.3,n),s.ell(0,.3,0,.24,.12,.155,n),s.ell(0,.38,-.05,.17,.08,.12,r),s.fill(-.3,-.05,-.25,.3,.5,.25,()=>!0,i,`paint`),s.fill(-.3,0,.05,.3,.4,.3,(e,t)=>Math.abs(e)<.013&&t>.12,X($.hideGrunt,.75),`paint`),s.fill(-.3,.1,.05,0,.4,.3,(e,t,n)=>Iu(e,t,n,.05,44)>.62&&Math.hypot(e+.1,t-.28)<.08,9059628,`paint`);let c=(e,t)=>Math.abs(e*1-(t-.2));s.fill(-.4,-.05,-.3,.4,.55,.3,(e,t)=>c(e,t)<.03,$.leatherDark,`paint`);for(let e=0;e<4;e++){let t=.08+e*.1,n=t-.2,r=Math.sqrt(Math.max(0,1-(n/.24)**2))*.15+.035;s.ell(n,t,r,.035,.035,.03,Qf),s.seg(n,t+.03,r,n+.01,t+.06,r,.008,.006,9075290)}s.fill(-.3,.33,-.25,.3,.5,.3,(e,t,n)=>{let r=Math.hypot(e/1.05,n+.01);return r>.1&&r<.165&&Math.abs(t-(.43-.12*Math.max(0,n)))<.035},zu(e,X(e,.82),.03)),s.seg(0,.4,.16,.03,.3,.2,.035,.02,X(e,.9)),t.push({bone:`torso`,part:s});let l=new Z;l.rbox(0,.12,.02,.12,.125,.12,2.5,n),l.rbox(0,.035,.07,.12,.06,.1,3,r),l.box(-.12,.14,.09,.12,.18,.16,X($.hideGrunt,.66)),l.box(-.025,.07,.12,.025,.14,.17,X($.hideGrunt,.88)),l.fill(-.2,.09,.05,.2,.16,.2,(e,t,n)=>n>.08&&t<.155,Qf,`paint`),l.box(-.085,.11,.1,-.045,.135,.16,$.eyeRed,`paint`),l.box(.045,.11,.1,.085,.135,.16,$.eyeRed,`paint`),l.fill(-.2,.02,.1,.2,.07,.2,(e,t)=>Math.abs(e)<.08&&Math.abs(t-(.045+.4*e*e))<.014,$.charcoal,`paint`),l.fill(-.2,.02,.1,.2,.07,.2,(e,t)=>Math.abs(e)<.07&&Math.abs(t-(.058+.4*e*e))<.006&&(e/Y|0)%2==0,$.bone,`paint`);for(let e of[1,-1])Vu(l,e,.07,.03,.14,.07,.018);Bu(l,1,.115,.14,.02,.15,n),Bu(l,-1,.115,.14,.02,.15,n),l.fill(-.35,.1,-.2,-.2,.3,.1,(e,t)=>e<-.2&&t>.17&&t<.2,0,`carve`),l.fill(-.2,.18,-.2,.2,.24,.2,(e,t,n)=>Math.abs(t-(.205-.08*n))<.018&&Math.hypot(e/1.02,n-.02)>.1,$.leatherDark,`paint`);for(let e of[1,-1])l.tubeZ(e*.052,.225,.1,.16,.042,.042,1,$.bronzeLight),l.tubeZ(e*.052,.225,.12,.165,.028,.028,1,2898494),l.box(e*.052-.02,.235,.15,e*.052-.005,.25,.168,12574952);l.box(-.012,.215,.13,.012,.235,.16,$.bronze),l.ell(0,.27,-.04,.05,.035,.05,Qf),l.seg(0,.28,-.05,.02,.36,-.09,.025,.01,X(Qf,1.25)),t.push({bone:`head`,part:l});for(let e of[`L`,`R`]){let a=new Z;a.tubeY(0,0,-.3,.03,.068,.07,1.15,n),a.ell(0,-.12,.02,.07,.085,.07,n),a.fill(-.1,-.3,-.1,.1,.05,.1,()=>!0,i,`paint`),t.push({bone:e===`L`?`armL`:`armR`,part:a});let o=new Z;o.ell(0,-.01,0,.065,.055,.065,n),o.tubeY(0,0,-.27,0,.056,.058,1.12,n),o.tubeY(0,0,-.24,-.06,.064,.066,1.08,zu($f,X($f,.82),.04)),Hu(o,.3,.06,r),t.push({bone:e===`L`?`foreL`:`foreR`,part:o})}for(let i of[`L`,`R`]){let o=new Z;o.tubeY(0,0,-.4,.04,.085,.09,1.15,a),o.box(-.05,-.28,.05,.03,-.16,.11,X(e,.8),`paint`),t.push({bone:i===`L`?`thighL`:`thighR`,part:o});let s=new Z;s.ell(0,-.01,.01,.07,.06,.07,n),s.tubeY(0,0,-.36,0,.06,.064,1.1,n),s.tubeY(0,0,-.32,-.1,.068,.07,1.06,zu($f,X($f,.8),.05)),Uu(s,.43,.068,.09,r),t.push({bone:i===`L`?`shinL`:`shinR`,part:s})}let u=new Z;u.jitter=.04,u.fill(-.2,-.25,-.2,tp,ep,tp,(e,t,n)=>Math.hypot(e,n)<=ip(t),(e,t,n)=>{let r=Math.hypot(e,n),i=Math.atan2(n,e);if((t>ep-Y*1.2||t<-.25+Y*1.2)&&r<ip(t)-.03)return X($.timberDark,.85+.1*Math.cos(e*60));if(Math.abs(Math.abs(t)-.2)<.02||Math.abs(Math.abs(t)-.12)<.015)return Iu(e,t,n,.05,45)>.7?$.rust:$.ironDark;let a=Math.floor((i+Math.PI)/(2*Math.PI)*14),o=Math.abs((i+Math.PI)/(2*Math.PI)*14%1-.5)>.44,s=a%2==0?$.timber:X($.timber,.86);return o?X($.timberDark,.9):Iu(e,t,n,.06,46)>.72?X(s,.8):s});let d=(e,t,n)=>Math.hypot(e,n)>ip(t)-Y*1.2;u.fill(-.2,-.1,-.2,tp,.1,tp,(e,t,n)=>d(e,t,n)&&Math.abs(t)<.095,(e,t,n)=>Iu(e,t,n,.05,47)>.72?9053718:11743774,`paint`),u.fill(-.12,-.12,.08,.12,.12,.25,(e,t,n)=>d(e,t,n)&&(Math.hypot(e,(t-.025)*1.1)<.085||Math.abs(e)<.05&&t<-.02&&t>-.085),$.bone,`paint`),u.fill(-.12,-.12,.08,.12,.12,.25,(e,t,n)=>d(e,t,n)&&(Math.hypot(Math.abs(e)-.036,t-.03)<.019||t<-.045&&t>-.075&&(e/Y|0)%2==0&&Math.abs(e)<.045),$.charcoal,`paint`),u.tubeY(.09,.05,.24,.28,.03,.03,1,$.ironDark);let f=[[.09,.27,.05],[.12,.3,.04],[.14,.33,.06],np];for(let e=0;e+1<f.length;e++){let[t,n]=[f[e],f[e+1]];u.seg(t[0],t[1],t[2],n[0],n[1],n[2],.014,.014,e===f.length-2?Qf:10127970)}u.ell(np[0],np[1]+.008,np[2],.02,.02,.02,16751136|eu|tu),u.ell(np[0],np[1]+.01,np[2],.01,.01,.01,16769152|eu|tu);for(let[e,t,n]of[[.035,.025,0],[-.025,.04,.02],[.01,.05,-.025]])u.box(np[0]+e-.012,np[1]+t-.012,np[2]+n-.012,np[0]+e+.012,np[1]+t+.012,np[2]+n+.012,16742938|eu|tu);return t.push({bone:`extra`,part:u}),t}var op=[0,.98,-.03,-.12,0,0];function sp(e,t){let n=fu(Q(t,0,.26));_u(e,op,n);let r=n*Q(t,.2,.3);e[J.wRZ]+=.09*r*Math.sin(t*43),e[J.wX]+=.02*r*Math.sin(t*37+1),e[J.tRX]+=-.42*n,e[J.nRX]+=-.2*n-.12*r*(.5+.5*Math.sin(t*22)),e[J.hY]+=-.05*gu(t,0,.1,.3)+.02*r*Math.sin(t*30),e[J.kL]+=.25*n,e[J.kR]+=.25*n,e[J.lLX]-=.12*n,e[J.lRX]-=.12*n,e[J.bS]+=.03*r*Math.sin(t*30),e[J.glow]=hu(Q(t,.05,.2))}function cp(e,t){e[J.wRZ]+=.03*Math.sin(t*5.3)}var lp={kind:`orc_bomber`,defaultTint:Zf,height:1.8,rig:rp,parts:ap,hunch:.36,stance:.1,loco:{walkHz:1,runHz:1.55,stride:.42,runStride:.78,knee:.75,runKnee:1.4,bob:.045,armSwing:.2,lean:.3},carry:[0,-.04,.3,-.22,0,0],carryRun:[0,0,.29,-.36,0,0],drop:[0,0,.3,0,0,0],gripL:[.20500000000000002,-.01,.03],gripR:[-.2-.005,-.01,.03],poleL:[.9,-.5,-.4],poleR:[-.9,-.5,-.4],muzzle:{bone:`extra`,p:[np[0],np[1]+.008,np[2]]},attackDur:.8,attack:sp,deathDepth:.17,deathExtraScale:0,idleExtra:cp};function up(e,t=.12,n=0){return(r,i,a)=>{let o=Iu(r,i,a,.07,e),s=su($.skBone,$.skBoneGrime,Math.max(0,o-.5)*1.7);if(t>0){let o=Iu(r,i,a,.13,e+9),c=1-t*.5;if(o>c&&(s=su(s,$.skOoze,Math.min(1,(o-c)*7))),n>0&&o>c+.03&&Math.abs(Iu(r,i,a,.06,e+17)-.5)<.03*n)return $.skTeal}return s}}function dp(e){return(t,n,r)=>Iu(t,n,r,.05,e)>.68?$.skOozeSheen:$.skOoze}function fp(e,t=.55){return(n,r,i)=>{let a=Iu(n,r,i,.06,e);return a>1-t?a>1-t*.35?X($.skRust,.8):$.skRust:a<.2?$.ironLight:$.iron}}function pp(e,t,n){let r=Math.max(.04,Y*1.01);return(i,a,o)=>a<t&&ou(Math.floor(i/r),n,Math.floor(o/r))>.45+(t-a)*3||a<t-.02&&ou(Math.floor(i/r),n+1,Math.floor(o/r))>.55?-1:Iu(i,a,o,.06,n)>.62?X(e,.72):e}function mp(e,t,n){if(Y<=.03)return;let r=e=>(Math.floor(e/Y)+.5)*Y;for(let i of[1,-1])e.ell(r(i*.045*t),r(.105*t),.1*t,Y*.5,Y*.5,Y*1.4,n,`paint`)}function hp(e,t,n,r){let i=e=>e*t;e.ell(0,i(.13),i(-.01),i(.1),i(.105),i(.115),n),e.ell(0,i(.07),i(.045),i(.085),i(.07),i(.075),n),e.box(i(-.058),i(0),i(.02),i(.058),i(.05),i(.1),n);for(let t of[1,-1])e.ell(t*i(.074),i(.075),i(.055),i(.03),i(.025),i(.035),n),e.ell(t*i(.042),i(.11),i(.085),i(.034),i(.03),i(.03),$.charcoal,`paint`),e.ell(t*i(.042),i(.11),i(.125),i(.03),i(.027),i(.03),0,`carve`),e.ell(t*i(.042),i(.108),i(.083),Math.max(i(.016),Y*.5),Math.max(i(.014),Y*.5),Y*.6,r);e.fill(i(-.03),i(.05),i(.08),i(.03),i(.085),i(.13),(e,t)=>Math.abs(e)<(t-i(.045))*.55+Y*.3,$.charcoal,`paint`),e.box(i(-.05),i(0),i(.07),i(.05),i(.03),i(.105),e=>Math.floor(e/Y)&1?$.skBone:$.skBoneDark,`paint`),e.box(i(-.055),i(-.005),i(.02),i(.055),i(.005),i(.11),$.charcoal,`paint`),e.rbox(0,i(-.028),i(.045),i(.058),i(.022),i(.06),2.6,n);for(let t of[1,-1])e.seg(t*i(.055),i(-.03),i(0),t*i(.07),i(.05),i(-.02),i(.016),i(.014),n)}function gp(e,t,n,r,i,a,o){e.fill(-r-a,t-.06,n-i-a,r+a,t+.03,n+i+a,(e,o,s)=>{let c=Math.sqrt((e/r)**2+((s-n)/i)**2);if(Math.abs(c-1)*Math.min(r,i)>a)return!1;let l=t-.035*Math.max(0,(s-n)/i);return Math.abs(o-l)<a},o)}function _p(e){let t=e.rig,n=e.r,r=up(e.seed,e.stain,e.veins??0),i=e.eye??$.skTeal,a=Math.max(n*.55,Y*.55),o=t.shoulder[1],s=t.shoulder[0],c=e.ribW??s*.78,l=new Z;for(let e of[1,-1])l.ell(e*t.hip[0]*.85,.035,-.015,n*2.3,n*2.2,n*1.3,r),l.seg(e*t.hip[0],t.hip[1],0,e*t.hip[0]*.3,-.07,n*1.6,n*.8,n*.8,r);l.ell(0,0,-.045,n*1.5,n*2.2,n*1.2,r),l.seg(0,0,-.05,0,t.torso[1]+.02,-.06,n*.9,n*.9,r);for(let e=.02;e<t.torso[1];e+=.04)l.ell(0,e,-.06,n*1.25,n*.6,n*1.1,r);let u=new Z,d=-.07;u.seg(0,-.02,d,0,o+.04,-.060000000000000005,n*.9,n*.9,r);for(let e=0;e<o;e+=.045)u.ell(0,e,d-n*.4,n*1.3,n*.6,n*1.4,r);let f=o-.06,p=o*.36;for(let e=0;e<5;e++){let t=e/4;gp(u,f-(f-p)*t,-.005,c*(.92+.08*Math.sin(Math.PI*(.35+.65*t))-.12*t*t),c*.72,a,r)}let m=c*.72-.005;u.seg(0,p-.03,m,0,f+.02,m-.01,n*.9,n*.9,r);for(let e of[1,-1])u.seg(e*.02,o+.01,m-.02,e*s*.95,o+.015,0,n*.75,n*.75,r),u.fill(e*s*.25,o-.2,-.14,e*s*.85,o+.01,-.02,(e,t,n)=>{let r=(Math.abs(e)-s*.25)/(s*.6),i=(o+.01-t)/.21;return r>=0&&r<=1-i*.5&&Math.abs(n-(-.09-.02*r))<a},r),u.ell(e*s,o,0,n*1.5,n*1.3,n*1.5,r);e.ooze>0&&(u.ell(0,p+.03,-.01,c*.62*e.ooze,.055*e.ooze,c*.5*e.ooze,dp(e.seed+3)),u.ell(0,p-.03,-.03,c*.3*e.ooze,.05*e.ooze,c*.3*e.ooze,dp(e.seed+4)));let h=t.head;u.seg(0,o+.03,-.060000000000000005,h[0],h[1]+.02,h[2]-.02,n*.85,n*.85,r);for(let e=.15;e<1;e+=.3)u.ell(0,o+.03+(h[1]-o)*e,d+(h[2]-d)*e,n*1.3,n*.55,n*1.3,r);let g=new Z;hp(g,e.skull,r,i);let _={hips:l,torso:u,head:g,finish:()=>mp(g,e.skull,i)},v=Y>.03?Y*.5:0;for(let e of[`L`,`R`]){let i=new Z;i.seg(v,-.01,v,v,-t.upperLen+.02,v,n,n*.9,r),i.ell(0,-.01,0,n*1.5,n*1.5,n*1.5,r),i.ell(0,-t.upperLen+.015,0,n*1.45,n*1.2,n*1.3,r);let a=new Z,o=t.handLen;if(v>0)a.seg(v,-.015,v,v,-o+.05,v,n*.8,n*.7,r);else for(let e of[1,-1])a.seg(e*n*.7,-.015,0,e*n*.45,-o+.05,.005,n*.72,n*.62,r);a.ell(0,-o+.045,.005,n*1.2,n*.8,n*1.1,r),a.rbox(0,-o,.008,n*1.35,n*1.35,n*1.45,2.4,r),a.box(-n*1.3,-o-n*.6,n*1.2,n*1.3,-o+n*.6,n*1.55,e=>Math.floor(e/Y)&1?$.skBone:$.skBoneGrime,`add`),_[e===`L`?`armL`:`armR`]=i,_[e===`L`?`foreL`:`foreR`]=a}let y=t.hips[1]+t.hip[1]-t.thighLen,b=(e,t,n)=>su(r(e,t,n),$.skBoneDark,Math.min(1,Math.max(0,(-t-y*.4)/(y*.6)))*.7);for(let e of[`L`,`R`]){let i=new Z;i.seg(v,-.01,v,v,-t.thighLen+.02,v,n*1.1,n,r),i.ell(0,-.005,0,n*1.6,n*1.6,n*1.6,r),i.ell(0,-t.thighLen+.02,.005,n*1.55,n*1.3,n*1.4,r);let a=new Z;a.ell(0,-.012,n*1.1,n*1.1,n*1.2,n*.8,r),a.seg(v,-.02,v,v,-y+.07,v,n,n*.8,b),v===0&&a.seg(-n*1.1*(e===`L`?1:-1),-.04,-n*.4,-n*.9*(e===`L`?1:-1),-y+.08,-n*.4,n*.55,n*.55,b),a.ell(0,-y+.05,0,n*1.5,n*1.3,n*1.8,b);for(let e=-1;e<=1;e++)a.seg(e*n*.9,-y+.045,.02,e*n*1.3,-y+Y*.5,.11+.01*(1-Math.abs(e)),n*.7,n*.55,b);_[e===`L`?`thighL`:`thighR`]=i,_[e===`L`?`shinL`:`shinR`]=a}return _}function vp(e,t,n,r,i){let a=pp(t,-r+.08,i);e.tubeY(0,0,-.01,.045,n+.02,n*.75,1,X(t,.8)),e.box(-n*.55,-r,n*.6,n*.55,.02,n*.6+Y,a),e.box(-n*.6,-r*.95,-n*.6-Y,n*.6,.02,-n*.6,pp(X(t,.85),-r*.95+.08,i+2))}var yp=[`hips`,`torso`,`head`,`armL`,`foreL`,`armR`,`foreR`,`thighL`,`shinL`,`thighR`,`shinR`];function bp(e,t=[]){return e.finish?.(),[...yp.map(t=>({bone:t,part:e[t]})),...t]}var xp={hips:[0,.95,0],torso:[0,.1,0],head:[0,.47,.04],shoulder:[.19,.39,0],upperLen:.29,handLen:.29,hip:[.085,-.04,0],thighLen:.43};function Sp(e,t,n){let r=fp(n);e.fill(-.2*t,.13*t,-.2*t,.2*t,.3*t,.2*t,(e,n,r)=>{let i=e/(.115*t),a=(n-.13*t)/(.13*t),o=(r+.01*t)/(.125*t);return i*i+a*a+o*o<=1},r),e.tubeY(0,-.01*t,.13*t,.13*t+Math.max(Y,.025*t),.17*t,.17*t,1,(e,t,n)=>ou(Math.floor(e/.05),7,Math.floor(n/.05))>.9?-1:r(e,t,n)),e.seg(0,.14*t,.12*t,0,.29*t,0,.012*t,.012*t,$.ironDark)}function Cp(e){let t=_p({rig:xp,seed:61,r:.03,skull:1,stain:.16,ooze:1});vp(t.hips,e,.13,.3,62),Sp(t.head,1,63);let n=t.foreL,r=[0,-.15,.07],i=.23,a=fp(64,.7);n.fill(r[0]-i,r[1]-i,r[2],r[0]+i,r[1]+i,r[2]+.05,(e,t,n)=>{let a=Math.hypot(e-r[0],t-r[1]);return a<=i&&n<r[2]+.035+.02*(1-a/i)},(e,t,n)=>{let o=Math.hypot(e-r[0],t-r[1]);if(o>.2)return a(e,t,n);if(o<.05)return n>r[2]+.03?$.ironLight:a(e,t,n);let s=(e-r[0])/.14,c=(t-r[1]-.02)/.14;return s*s+c*c<.9&&!(Math.abs(Math.abs(s)-.38)<.2&&Math.abs(c-.05)<.2)&&c>-.7&&n>r[2]+.02?$.skBone:Math.floor((e-r[0]+i)/.07)&1?$.timberDark:X($.timberDark,.82)});let o=new Z;o.jitter=.05,o.seg(0,-.1,0,0,.07,0,.022,.022,(e,t)=>(t/.03|0)&1?$.skBoneGrime:$.leatherDark),o.ell(0,-.12,0,.03,.03,.03,$.skBone),o.box(-.025,.07,-.09,.025,.1,.09,fp(65,.5));let s=fp(66,.4);return o.fill(-.012,.1,-.06,.012,.72,.06,(e,t,n)=>{let r=.045*(1-Math.max(0,t-.6)/.13);return Math.abs(n)<r&&!(n>r-.02&&ou(0,t/.03|0,11)>.8)},(e,t,n)=>Math.abs(n)<.012?X($.iron,.8):s(e,t,n)),bp(t,[{bone:`weapon`,part:o}])}var wp=[-.2,.6,-.05,-.8,.1,.3],Tp=[-.06,.2,.44,1.9,.05,.1];function Ep(e,t){let n=fu(Q(t,0,.3)),r=pu(Q(t,.3,.43)),i=mu(Q(t,.52,.85));_u(e,wp,n*(1-r)),_u(e,Tp,r*(1-i));let a=n*(1-r),o=r*(1-i);e[J.tRX]+=-.2*a+.38*o,e[J.tRY]+=-.3*a+.2*o,e[J.nRX]+=.1*a-.2*o,e[J.hY]-=.06*o,e[J.kL]+=.35*o,e[J.kR]+=.25*o,e[J.lLX]-=.28*o,e[J.lRX]+=.18*o;let s=fu(Q(t,0,.2))*(1-mu(Q(t,.6,.85)));e[J.aLX]+=-.4*s,e[J.aLZ]+=.15*s,e[J.aLY]+=.6*s,e[J.fL]+=-.15*s,e[J.bS]+=.03*gu(t,.41,.44,.6)}var Dp={kind:`skeleton_warrior`,defaultTint:$.skRag,height:1.85,rig:xp,parts:Cp,hunch:.14,stance:.07,loco:{walkHz:.95,runHz:1.45,stride:.44,runStride:.78,knee:.75,runKnee:1.35,bob:.03,armSwing:.4,lean:.22},carry:[-.27,0,.12,.5,0,.1],drop:[-.38,0,0,0,0,0],gripL:null,gripR:[0,0,0],muzzle:{bone:`weapon`,p:[0,.6,0]},attackDur:.85,attack:Ep,deathDepth:.13},Op=.66,kp=-.1,Ap=13616292,jp={hips:[0,.95,0],torso:[0,.1,0],head:[0,.47,.04],shoulder:[.18,.39,0],upperLen:.29,handLen:.29,hip:[.085,-.04,0],thighLen:.43,extra:[0,0,0],bowString:{half:.63,z:kp}};function Mp(e,t,n,r,i){let a=pp(t,-.02*n,i);e.fill(-.2*n,-.06*n,-.22*n,.2*n,.34*n,.2*n,(e,t,r)=>{let i=e/(.135*n),a=(t-.12*n)/(.165*n),o=(r+.005*n)/(.14*n),s=i*i+a*a+o*o<=1,c=r>0&&t<.19*n&&Math.abs(e)<.095*n;return s&&!c},(e,r,i)=>r<.02*n?X(t,.8):a(e,r,i)),e.seg(0,.24*n,-.06*n,0,.24*n+r*.6,-.06*n-r,.06*n,.012*n,t)}function Np(e){let t=_p({rig:jp,seed:71,r:.028,skull:1,stain:.16,ooze:.9});vp(t.hips,e,.12,.26,72),Mp(t.head,e,1,.16,73),t.torso.fill(-.26,.2,-.2,.26,.47,.16,(e,t,n)=>{let r=(e/.24)**2+((n+.02)/.15)**2;return r<=1&&r>=.62&&t>.44-.2*(1-Math.abs(e)/.26)-(n<0?.1:0)},pp(e,.3,74));let n=t.torso;n.seg(-.08,.02,-.17,.1,.5,-.18,.055,.055,(e,t)=>Math.abs((t*100|0)%12)<2?$.skBoneGrime:$.leatherDark);for(let t=0;t<5;t++){let r=.07+t%3*.025,i=-.2+(t>>1)*.02;n.seg(r,.48,i,r+.02,.6,i,.01,.01,$.skBoneGrime),n.seg(r+.015,.56,i,r+.025,.63,i,.016,.006,t%2?e:$.skBone)}let r=new Z;r.jitter=.04,r.fill(-.02,-.66-.05,-.2,.02,.7100000000000001,.1,(e,t,n)=>{let r=Math.abs(t)/Op;if(r>1)return!1;let i=-.09*r*r;return Math.abs(n-i)<.03-.013*r},(e,t)=>{let n=Math.abs(t)/Op;return n<.1?$.leatherDark:n>.86?$.skBone:Math.abs(n-.45)<.03||Math.abs(n-.7)<.02?$.skBoneGrime:$.timberDark}),r.seg(0,.64,-.07,0,.7100000000000001,-.03,.022,.006,$.skBone),r.seg(0,-.64,-.07,0,-.66-.05,-.03,.022,.006,$.skBone);let i=new Z,a=new Z;i.jitter=a.jitter=0,i.box(0,-.63,0,.01,0,.01,Ap),a.box(0,0,0,.01,.63,.01,Ap);let o=new Z;return o.jitter=.03,o.box(0,0,kp,.01,.01,.52,$.skBoneGrime),o.seg(0,0,.5,0,0,.62,.026,.005,$.skRust),o.box(-.03,-.01,-.09000000000000001,.03,.01,0,t=>ou(t*50|0,1,1)>.8?-1:e),o.box(-.01,-.03,-.09000000000000001,.01,.03,0,e),bp(t,[{bone:`weapon`,part:r},{bone:`stringT`,part:i},{bone:`stringB`,part:a},{bone:`extra`,part:o}])}var Pp=[.1,.36,.48,0,.08,-.12];function Fp(e,t){let n=fu(Q(t,0,.26)),r=t>=.8,i=mu(Q(t,.9,1.15));_u(e,Pp,n*(1-i)),e[J.xS]=Q(t,.12,.18)*+!r,e[J.ikR]=hu(Q(t,.1,.28))*(1-hu(Q(t,.88,1.02)));let a=fu(Q(t,.3,.66)),o=fu(Q(t,.8,.86));e[J.xZ]=-.42*a-.1*o,e[J.tRY]+=-.24*n*(1-i),e[J.tRX]-=.08*n,e[J.nRY]+=.24*n*(1-i),e[J.nRX]+=.06*n,e[J.nRZ]+=.12*a*(1-i);let s=gu(t,.8,.82,.96);e[J.wRX]-=.12*s,e[J.wZ]+=.03*s,e[J.tRY]+=.06*s}var Ip={kind:`skeleton_archer`,defaultTint:$.skRag,height:1.9,rig:jp,parts:Np,hunch:.12,stance:.06,loco:{walkHz:.95,runHz:1.45,stride:.44,runStride:.78,knee:.75,runKnee:1.35,bob:.03,armSwing:.35,lean:.22},carry:[.27,-.02,.14,.45,0,-.1],drop:[.34,.1,0,0,0,0],gripL:[0,0,0],gripR:[0,0,kp],gripROnExtra:!0,ikIdle:[1,0],poleL:[.9,-.6,-.1],poleR:[-.9,-.3,-.4],muzzle:{bone:`extra`,p:[0,0,.62]},attackDur:1.2,attack:Fp,deathDepth:.13,extraScale:0},Lp={hips:[0,1.06,0],torso:[0,.12,0],head:[0,.54,.05],shoulder:[.23,.45,0],upperLen:.32,handLen:.32,hip:[.1,-.04,0],thighLen:.48},Rp=9277326,zp=(e,t,n)=>{let r=Iu(e,t,n,.05,91);return r>.72?6189128:r<.28?X(Rp,.82):Rp};function Bp(e){let t=_p({rig:Lp,seed:81,r:.036,skull:1.1,stain:.22,ooze:1.1,ribW:.2});vp(t.hips,e,.15,.36,82);let n=fp(83,.6),r=t.head;r.fill(-.2,.12,-.2,.2,.34,.2,(e,t,n)=>{let r=e/.125,i=(t-.13)/.15,a=(n+.01)/.135;return r*r+i*i+a*a<=1},n),r.tubeY(0,-.01,.13,.13+Math.max(Y,.03),.132,.142,1,$.ironDark),r.box(-.015,.06,.12,.015,.2,.15,$.ironDark);for(let e of[1,-1])r.seg(e*.11,.21,0,e*.25,.26,.04,.04,.03,$.skBoneGrime),r.seg(e*.25,.26,.04,e*.32,.38,.12,.03,.01,$.skBone);let i=t.torso;for(let e of[1,-1]){let t=.23*e;i.fill(t-.15,.4,-.15,t+.15,.6,.15,(e,n,r)=>{let i=(e-t)/.13,a=(n-.45)/.11,o=r/.13;return i*i+a*a+o*o<=1&&n>.44},(e,t,r)=>t<.47?$.ironDark:n(e,t,r)),i.seg(t,.54,0,t+.06*e,.63,-.02,.025,.006,$.ironLight)}i.tubeY(0,-.04,.43,.49,.13,.12,1,(e,t,n)=>Math.abs(e)<.08&&n>0?-1:$.ironDark);let a=new Z;return a.jitter=.05,a.seg(0,-.28,0,0,.88,0,.03,.028,(e,t)=>Math.abs(t)<.08||Math.abs(t-.32)<.07?$.leatherDark:Math.abs(t-.6)<.03?$.skRust:$.timberDark),a.ell(0,-.29,0,.04,.035,.04,$.skBone),a.rbox(0,.97,0,.11,.13,.23,5,zp),a.fill(-.12,.83,-.24,.12,1.11,.24,(e,t,n)=>Math.abs(Math.abs(n)-.12)<.025,n,`paint`),a.fill(-.12,.83,-.24,.12,1.11,.24,(e,t,n)=>Math.abs(n)<.015&&Math.abs(t-.97)<.08||Math.abs(t-1)<.015&&Math.abs(n)<.055,X(Rp,.55),`paint`),a.box(-.04,.84,-.04,.04,.9,.04,$.ironDark),bp(t,[{bone:`weapon`,part:a}])}var Vp=[-.08,.72,-.05,-.55,0,.1],Hp=[-.02,0,.5,2.05,0,0];function Up(e,t){let n=fu(Q(t,0,.42)),r=pu(Q(t,.42,.56)),i=mu(Q(t,.78,1.25));_u(e,Vp,n*(1-r)),_u(e,Hp,r*(1-i));let a=n*(1-r),o=r*(1-i);e[J.tRX]+=-.28*a+.55*o,e[J.nRX]+=.2*a-.35*o,e[J.hY]+=.03*a-.16*o,e[J.hZ]+=.06*o,e[J.kL]+=.2*a+.7*o,e[J.kR]+=.2*a+.6*o,e[J.lLX]-=.1*a+.5*o,e[J.lRX]+=.3*o,e[J.bS]-=.05*gu(t,.55,.58,.82)}var Wp={kind:`skeleton_demolisher`,defaultTint:$.skRag,height:2.1,rig:Lp,parts:Bp,hunch:.16,stance:.1,loco:{walkHz:.8,runHz:1.2,stride:.4,runStride:.7,knee:.7,runKnee:1.25,bob:.04,armSwing:.3,lean:.2},carry:[-.12,.1,.26,-.9,0,.25],drop:[-.5,-.1,0,0,0,0],gripL:[0,.3,0],gripR:[0,0,0],poleL:[.9,-.5,-.3],poleR:[-.9,-.5,-.3],muzzle:{bone:`weapon`,p:[0,.97,0]},attackDur:1.25,attack:Up,deathDepth:.16},Gp={hips:[0,.93,0],torso:[0,.1,0],head:[0,.46,.05],shoulder:[.18,.38,0],upperLen:.28,handLen:.28,hip:[.085,-.04,0],thighLen:.42},Kp=13879206;function qp(e,t,n,r,i,a,o,s){let c=dp(s+1);e.rbox(t,n,r,i,a,o,6,(e,r,o)=>{let l=(e-t)/i,u=(r-n)/a;return Y<=.03&&Math.abs(u)<Y*.6/a||Math.abs(l-.1*Math.sign(u))<Y*.6/i?c(e,r,o):ou(Math.floor(e/.05),Math.floor(r/.05),Math.floor(o/.05)+s)>.8?X(Kp,.85):Kp})}function Jp(e){let t=_p({rig:Gp,seed:101,r:.028,skull:1,stain:.18,ooze:.9});vp(t.hips,e,.12,.24,102);let n=up(103,.1),r=t.torso;for(let e of[1,-1])r.seg(.12*e,-.05,-.16,.08*e,.8,-.2,.022,.018,n),r.seg(.02*e,.37,.07,.11*e,.4,-.17,.014,.014,$.leatherDark);for(let e of[.1,.35])r.seg(-.13,e,-.17,.13,e,-.17,.016,.016,e=>Math.abs(e)<.03?$.leatherDark:$.skBoneGrime);r.box(-.15,.4,-.3,.15,.43,-.12,$.timberDark),qp(r,0,.52,-.22,.14,.085,.1,104),qp(r,.01,.69,-.23,.13,.085,.095,105),qp(r,-.01,.86,-.22,.12,.08,.09,106),r.seg(-.14,.44,-.12,.13,.95,-.12,.012,.012,$.leatherDark,`under`),t.hips.seg(-.15,-.02,.02,-.17,-.32,.06,.016,.016,$.timberDark),t.hips.rbox(-.17,-.34,.06,.05,.045,.08,3,n);let i=new Z;return qp(i,0,0,0,.13,.08,.1,107),bp(t,[{bone:`weapon`,part:i}])}var Yp=[0,.28,.3,-.2,0,0],Xp=[0,-.62,.52,0,0,0];function Zp(e,t){let n=fu(Q(t,0,.3)),r=mu(Q(t,.3,.7)),i=mu(Q(t,1.05,1.4));_u(e,Yp,n*(1-r)),_u(e,Xp,r*(1-i));let a=r*(1-i);e[J.tRX]+=.75*a-.1*n*(1-r),e[J.nRX]-=.45*a,e[J.hY]-=.3*a,e[J.hZ]-=.08*a,e[J.lLX]-=.95*a,e[J.lRX]-=.7*a,e[J.kL]+=1.5*a,e[J.kR]+=1.25*a;let o=gu(t,.74,.78,.86)+gu(t,.88,.92,1);e[J.wY]-=.03*o,e[J.tRX]+=.05*o,e[J.bS]-=.02*o}var Qp={kind:`skeleton_builder`,defaultTint:$.skRag,height:1.8,rig:Gp,parts:Jp,hunch:.3,stance:.08,loco:{walkHz:.95,runHz:1.4,stride:.4,runStride:.7,knee:.75,runKnee:1.3,bob:.035,armSwing:.3,lean:.2},carry:[0,-.06,.3,0,0,0],drop:[0,.1,.25,0,0,0],gripL:[.13,0,0],gripR:[-.13,0,0],poleL:[.9,-.6,-.3],poleR:[-.9,-.6,-.3],muzzle:{bone:`weapon`,p:[0,0,0]},attackDur:1.4,attack:Zp,deathDepth:.18},$p={hips:[0,.94,0],torso:[0,.1,0],head:[0,.47,.05],shoulder:[.19,.39,0],upperLen:.29,handLen:.29,hip:[.085,-.04,0],thighLen:.43};function em(e){let t=_p({rig:$p,seed:111,r:.029,skull:1,stain:.2,ooze:1});vp(t.hips,e,.12,.28,112);let n=fp(113,.5),r=t.head;r.fill(-.2,.14,-.2,.2,.3,.2,(e,t,n)=>{let r=e/.113,i=(t-.14)/.125,a=(n+.01)/.125;return r*r+i*i+a*a<=1},n),r.tubeY(0,0,.14,.14+Math.max(Y,.02),.12,.13,1,$.leatherDark),r.box(-.04,.17,.1,.04,.26,.17,$.ironDark),r.box(-.028,.18,.13,.028,.25,.18,$.skTealHot),r.box(-.045,.255,.1,.045,.275,.18,$.ironDark);let i=t.torso;i.tubeY(0,-.02,.38,.46,.12,.11,.85,pp(e,.3,114)),i.fill(-.3,0,-.2,.3,.5,.2,(e,t,n)=>{let r=Math.hypot(e-.02,t-.2);return Math.abs(r-.24)<.022&&Math.abs(n)>.085&&Math.abs(n)<.125},zu(10259042,8219722,.03));let a=new Z;return a.jitter=.05,a.seg(0,-.18,0,0,.82,0,.024,.022,(e,t)=>Math.abs(t)<.08||Math.abs(t-.3)<.06?$.leatherDark:$.timber),a.fill(-.03,.66,-.34,.03,.9,.4,(e,t,n)=>{let r=Math.abs(n)/(n>0?.38:.3);if(r>1)return!1;let i=.8-.09*r*r;return Math.abs(t-i)<.045*(1-r*.8)+.008},(e,t,r)=>Math.abs(r)>.3?$.ironLight:n(e,t,r)),a.box(-.035,.74,-.04,.035,.86,.04,$.ironDark),bp(t,[{bone:`weapon`,part:a}])}var tm=[-.14,.78,-.12,-.7,0,.15],nm=[-.02,-.12,.48,2.3,0,0],rm=[-.04,0,.42,1.7,0,0];function im(e,t){let n=fu(Q(t,0,.34)),r=pu(Q(t,.34,.47)),i=mu(Q(t,.55,.75)),a=mu(Q(t,.78,1.05));_u(e,tm,n*(1-r)),_u(e,nm,r*(1-i)),_u(e,rm,i*(1-a));let o=n*(1-r),s=r*(1-a);e[J.tRX]+=-.25*o+.6*s-.12*i*(1-a),e[J.nRX]+=.15*o-.3*s,e[J.hY]-=.14*s,e[J.kL]+=.6*s,e[J.kR]+=.45*s,e[J.lLX]-=.45*s,e[J.lRX]+=.25*s,e[J.bS]-=.03*gu(t,.46,.49,.6)}var am={kind:`skeleton_carver`,defaultTint:$.skRag,height:1.85,rig:$p,parts:em,hunch:.24,stance:.08,loco:{walkHz:.92,runHz:1.4,stride:.42,runStride:.74,knee:.75,runKnee:1.3,bob:.035,armSwing:.3,lean:.24},carry:[-.22,.02,.3,.2,0,-.7],drop:[-.4,-.1,0,0,0,0],gripL:[0,.34,0],gripR:[0,0,0],poleL:[.9,-.5,-.3],poleR:[-.9,-.5,-.3],muzzle:{bone:`weapon`,p:[0,.72,.38]},attackDur:1.05,attack:im,deathDepth:.13},om={hips:[0,1.12,0],torso:[0,.12,0],head:[0,.56,.05],shoulder:[.22,.47,0],upperLen:.34,handLen:.34,hip:[.1,-.05,0],thighLen:.5,extra:[0,1.12,0]};function sm(e){let t=_p({rig:om,seed:131,r:.032,skull:1.15,stain:.35,ooze:1.3,ribW:.19}),n=X(e,.7),r=(t,r,i)=>Iu(t,r,i,.07,132)>.64?n:e,i=t.hips;i.fill(-.5,-1.1,-.5,.5,.1,.5,(e,t,n)=>{let r=Math.min(1,-t/1.08),i=.2+.18*r,a=.16+.16*r,o=(e/i)**2+(n/a)**2;return o>1||n>0&&Math.abs(e)<.05+.1*r&&t>-.9?!1:t>-1.08+.05*Math.abs(Math.sin(e*23+n*17))&&(o>.72||t>-.02)},(e,t,n)=>t<-.93?t>-.99&&(Math.atan2(n,e)*9|0)%3==0&&ou(e/Y|0,7,n/Y|0)>.35?$.skTeal:$.skOoze:r(e,t,n)),i.tubeY(0,0,-.01,.06,.21,.17,1,e=>Math.floor(e/.04)&1?$.skBone:$.skBoneGrime);let a=t.torso;a.fill(-.32,-.08,-.3,.32,.58,.3,(e,t,n)=>{let r=(e/(.2+.04*Math.min(1,t/.4)))**2+((n+.02)/.16)**2;return r<=1&&r>.66&&!(n>.02&&Math.abs(e)<.13-.05*Math.max(0,t-.35)/.2)},r),a.ell(0,.5,-.03,.29,.08,.2,r);let o=up(133,.3);for(let e=0;e<9;e++){let t=-1.2+e*.3,n=Math.sin(t)*.27,r=Math.cos(t)*.18-.02;a.seg(n,.55,r,n*1.25,.47,r*1.2+.02,.028,.012,o)}a.fill(-.2,0,-.2,.2,.3,.3,(e,t,n)=>Iu(e,t,n,.04,134)>.7&&n>0,$.skOozeSheen,`paint`);let s=t.head;Mp(s,e,1.15,.05,135);for(let e=0;e<7;e++){let t=-1.5+e*.5,n=Math.sin(t)*.15,r=Math.cos(t)*.15-.02,i=e===3?.26:e%2?.17:.21;s.seg(n,.28,r,n*1.25,.28+i,r*1.1,.03,.008,e===3?$.skBone:o)}s.tubeY(0,-.01,.26,.29,.16,.16,1,$.skRust);for(let n of[`armL`,`armR`])t[n].tubeY(0,0,-.3,.04,.075,.08,1.35,pp(e,-.22,136));let c=new Z,l=[[0,-1.18,0],[.02,-.6,.01],[-.01,0,0],[.02,.55,-.01],[0,.98,0]];for(let e=0;e<l.length-1;e++){let[t,n]=[l[e],l[e+1]];c.seg(t[0],t[1],t[2],n[0],n[1],n[2],.028,.028,(e,t,n)=>Math.abs(t)<.07?$.leatherDark:Iu(e,t,n,.06,137)>.55?$.skBoneGrime:$.timberDark)}for(let e of[-.3,.3,.7])c.tubeY(0,0,e,e+.04,.036,.036,1,$.skBone);let u=new Z;u.jitter=.03;let d=up(138,.2);c.ell(0,1,0,.07,.065,.075,d),c.ell(0,.97,.05,.05,.035,.05,d);for(let e of[1,-1])c.ell(e*.028,1,.06,.016,.014,.016,$.skTeal),c.seg(e*.05,1.03,-.01,e*.13,1.1,0,.022,.014,d),c.seg(e*.13,1.1,0,e*.1,1.22,.02,.014,.005,d);return u.fill(-.08,-.06,-.08,.08,.2,.08,(e,t,n)=>{let r=.065*(1-Math.max(0,t)/.2)+.01;return e*e+n*n<r*r&&(t>-.04||e*e+n*n<.0012)},(e,t,n)=>t<.05&&e*e+n*n<.0016?$.skTealHot:Iu(e,t,n,.03,139)>.5?$.skTeal:4176036|eu),bp(t,[{bone:`weapon`,part:c},{bone:`extra`,part:u}])}var cm=[-.12,.72,.22,-.2,0,.08],lm=[-.2,.28,.36,.1,0,.05];function um(e,t){let n=fu(Q(t,0,.5)),r=pu(Q(t,.55,.68)),i=mu(Q(t,.95,1.4));_u(e,cm,n*(1-r)),_u(e,lm,r*(1-i));let a=n*(1-r),o=r*(1-i);e[J.tRX]+=-.3*a+.22*o,e[J.nRX]+=-.35*a+.15*o,e[J.hY]+=.04*a-.08*o,e[J.kL]+=.3*o,e[J.kR]+=.25*o,e[J.aLX]+=-2.4*a-1.1*o,e[J.aLZ]+=.35*a+.25*o,e[J.fL]+=-.3*a,e[J.glow]=hu(Q(t,.15,.5))*(1-hu(Q(t,.95,1.2))),e[J.xS]=1+.7*hu(Q(t,.1,.55))*(1-i)+.6*gu(t,.66,.72,.95),e[J.bS]+=.03*gu(t,.66,.7,.85)}function dm(e,t){e[J.xS]*=1+.12*Math.sin(t*4.3)+.05*Math.sin(t*11.7)}var fm={kind:`skeleton_necromancer`,defaultTint:2374202,height:2.35,rig:om,parts:sm,hunch:.12,stance:.06,loco:{walkHz:.72,runHz:1.1,stride:.32,runStride:.56,knee:.55,runKnee:1,bob:.03,armSwing:.25,lean:.16},carry:[-.3,.06,.18,-.2,0,.05],drop:[-.4,.2,0,0,0,0],gripL:null,gripR:[0,0,0],muzzle:{bone:`extra`,p:[0,.05,0]},attackDur:1.4,attack:um,deathDepth:.2,idleExtra:dm},pm={hips:[0,.56,-.28],torso:[0,.03,.5],head:[0,.14,.2],shoulder:[.085,-.04,.03],upperLen:.26,handLen:.24,hip:[.08,-.02,-.02],thighLen:.25,cape:[0,.03,-.54]};function mm(e){let t=.03,n=up(121,.2),r=up(122,.06),i=Y>.03?Y*.5:0,a=new Z;for(let e of[1,-1])a.ell(e*.055,0,-.02,t*1.4,t*2.4,t*2.8,n);a.seg(0,.04,-.08,0,.06,.28,t*.9,t*.9,n);for(let e=-.06;e<.28;e+=.045)a.ell(0,.075,e,t*.6,t*1.4,t*.7,n);let o=new Z;o.seg(0,.03,-.24,0,.05,.08,t*.9,t*.9,n);for(let e=-.22;e<.08;e+=.045)o.ell(0,.075,e,t*.6,t*1.5,t*.7,n);let s=Math.max(t*.4,Y*.5);for(let e=0;e<5;e++){let t=-.21+e*.066,r=.1+.035*Math.sin(e/4*Math.PI),i=.075;o.fill(-.075-s,.05-2*r-s,t-s,i+s,.06,t+s,(e,t)=>{let n=Math.sqrt((e/i)**2+((t-(.05-r))/r)**2);return Math.abs(n-1)*i<s&&t<.05&&!(t<.05-1.8*r&&Math.abs(e)<.03)},n)}o.seg(0,-.2,-.2,0,-.18,.06,t*.8,t*.8,n),o.ell(0,-.13,-.08,.05,.035,.09,dp(123));for(let e of[1,-1])o.seg(e*.07,.07,-.03,e*.085,-.03,.04,t*1.3,t*.7,n);o.seg(0,.05,.06,0,.14,.2,t*.9,t*.9,n);for(let e=.2;e<1;e+=.3)o.ell(0,.05+.09*e,.06+.14*e,t*1.3,t*1.3,t*.6,n);let c=fp(124,.6);o.fill(-.08,.02,.06,.08,.2,.2,(e,t,n)=>{let r=[0,.1,.13],i=Math.hypot(e,t-r[1]);return Math.abs(n-r[2]+(t-r[1])*.6)<.025&&i>.035&&i<.068},c);for(let e of[.4,1.3,2.2,-.5,-1.4,-2.3])o.seg(Math.sin(e)*.06,.1+Math.cos(e)*.06,.13-Math.cos(e)*.035,Math.sin(e)*.1,.1+Math.cos(e)*.1,.13-Math.cos(e)*.06,.012,.004,$.ironLight);o.box(-.025,-.05,.14,.025,0,.16,pp(e,-.02,125));let l=new Z;l.ell(0,.02,-.01,.075,.07,.095,n),l.seg(0,.045,-.08,0,.075,.03,.012,.012,n),l.rbox(0,0,.12,.045,.038,.09,2.4,n);for(let e of[1,-1])l.ell(e*.058,0,.03,.02,.022,.035,n),l.ell(e*.035,.035,.06,.022,.018,.02,$.charcoal,`paint`),l.ell(e*.035,.035,.085,.018,.015,.018,0,`carve`),l.ell(e*.035,.034,.058,Math.max(.009,Y*.5),Math.max(.008,Y*.5),Y*.6,$.skTeal),l.seg(e*.03,-.02,.17,e*.03,-.075,.175,.01,.004,$.skBone),l.seg(e*.025,-.08,.14,e*.026,-.035,.145,.009,.004,$.skBone);l.box(-.05,-.04,.06,.05,-.03,.22,$.charcoal,`paint`),l.seg(0,-.06,-.02,0,-.09,.16,.022,.014,n);for(let e of[1,-1])l.seg(e*.045,-.02,-.02,e*.02,-.08,.1,.012,.01,n);if(Y>.03)for(let e of[1,-1])l.ell(e*.04,.04,.08,Y*.5,Y*.5,Y*1.2,$.skTeal,`paint`);let u=[{bone:`hips`,part:a},{bone:`torso`,part:o},{bone:`head`,part:l}],d=(e,n,i)=>{for(let a=-1;a<=1;a++)e.seg(a*t*.9,n+.02,i,a*t*1.2,n+Y*.5,i+.075,t*.6,t*.45,r)};for(let e of[`L`,`R`]){let a=new Z;a.seg(i,0,i,i,-pm.upperLen+.02,i+.01,t*1.1,t*.9,n),a.ell(0,-.005,0,t*1.5,t*1.5,t*1.5,n),a.ell(0,-pm.upperLen+.01,.005,t*1.3,t*1.2,t*1.3,n);let o=new Z;o.seg(i,-.01,i,i,-pm.handLen-.025,i,t*.85,t*.8,r),o.ell(0,-pm.handLen+.02,0,t*1.2,t*1,t*1.2,r),d(o,-pm.handLen-.04,0),u.push({bone:e===`L`?`armL`:`armR`,part:a},{bone:e===`L`?`foreL`:`foreR`,part:o});let s=new Z;s.seg(i,0,i,i,-pm.thighLen+.02,.03+i,t*1.2,t,n),s.ell(0,0,0,t*1.6,t*1.6,t*1.6,n);let c=new Z,l=pm.hips[1]+pm.hip[1]-pm.thighLen;c.seg(i,-.01,i,i,-.17,-.08+i,t*.95,t*.85,r),c.ell(0,-.17,-.08,t*1.2,t*1.2,t*1.4,r),c.seg(i,-.17,-.08+i,i,-l+.03,-.03+i,t*.85,t*.78,r),d(c,-l,-.03),u.push({bone:e===`L`?`thighL`:`thighR`,part:s},{bone:e===`L`?`shinL`:`shinR`,part:c})}let f=new Z,p=0,m=0,h=0;for(let e=0;e<7;e++){let r=.25+e*.14,i=m+Math.sin(r)*.055,a=h-Math.cos(r)*.055;f.seg(p,m,h,0,i,a,t*Math.max(.78,.9-e*.03),t*Math.max(.76,.88-e*.03),n),f.ell(0,i,a,t*(1.1-e*.1),t*(1.1-e*.1),t*.6,n),p=0,m=i,h=a}return u.push({bone:`cape`,part:f}),u}function hm(e,t){let n=fu(Q(t,0,.22)),r=pu(Q(t,.22,.36)),i=mu(Q(t,.5,.75)),a=n*(1-r),o=r*(1-i);e[J.hZ]+=-.08*a+.3*o,e[J.hY]+=-.06*a+.03*o,e[J.hRX]+=.1*a-.06*o,e[J.nRX]+=-.3*a+.2*o-.4*gu(t,.34,.38,.5),e[J.kL]+=.6*a,e[J.kR]+=.6*a,e[J.lLX]+=-.3*a+.5*o,e[J.lRX]+=-.3*a+.45*o,e[J.aLX]+=.2*a-1.1*o,e[J.aRX]+=.2*a-.95*o,e[J.fL]+=.25*a,e[J.fR]+=.25*a,e[J.cape]+=.3*a-.2*o}var gm={kind:`skeleton_hound`,defaultTint:$.skRag,height:.9,rig:pm,parts:mm,gait:`quad`,hunch:0,stance:.03,loco:{walkHz:1.5,runHz:2.2,stride:.38,runStride:.6,knee:.7,runKnee:1,bob:.03,armSwing:0,lean:.1},carry:[0,.12,.42,0,0,0],drop:[0,.12,.42,0,0,0],gripL:null,gripR:null,muzzle:{bone:`weapon`,p:[0,0,0]},attackDur:.75,attack:hm,deathDepth:.12},_m={hips:[0,1.6,0],torso:[0,.18,0],head:[0,.8,.14],shoulder:[.36,.7,0],upperLen:.5,handLen:.5,hip:[.15,-.06,0],thighLen:.72,cape:[0,.74,-.2]},vm=8356481,ym=(e,t,n)=>{let r=Iu(e,t,n,.08,151);return r>.7?5596735:r<.3?X(vm,.8):vm};function bm(e){let t=_p({rig:_m,seed:141,r:.05,skull:1.6,stain:.6,ooze:1.8,ribW:.3,veins:1}),n=fp(142,.65);vp(t.hips,e,.24,.62,143);let r=t.hips;r.seg(.26,-.02,.08,.28,-.2,.12,.012,.012,$.ironDark),r.box(.2,-.42,.06,.36,-.2,.2,(e,t,r)=>Math.abs(e-.28)<.05&&Math.abs(r-.13)<.05&&t>-.38&&t<-.24?$.skTealHot:n(e,t,r)),r.fill(.2,-.42,.06,.36,-.2,.2,(e,t,n)=>Math.abs(e-.28)<.05&&t>-.37&&t<-.25&&(n<.08||n>.18),$.skTealHot,`paint`);let i=t.torso;i.fill(-.4,.05,-.5,.4,1.28,-.24,(e,t,n)=>{let r=.98+Math.sqrt(Math.max(0,.33*.33-e*e))*.9;return Math.abs(e)<.33&&t<r&&Math.abs(n+.35)<.07},(e,t,n)=>n>-.3&&Math.abs(e)<.03&&t>.5&&t<1.1||n>-.3&&Math.abs(t-.92)<.03&&Math.abs(e)<.14?X(vm,.5):ym(e,t,n));let a=(e,t,r,a,o,s)=>{let c=Math.ceil(Math.hypot(a-e,o-t,s-r)/.05);for(let l=0;l<=c;l++){let u=l/c,d=e+(a-e)*u,f=t+(o-t)*u,p=r+(s-r)*u;l%2?i.ell(d,f,p,.022,.022,.022,$.ironLight):i.ell(d,f,p,.03,.018,.03,n)}};a(.34,.72,-.28,-.24,.12,.26),a(-.34,.72,-.28,.24,.12,.26),a(-.3,.3,-.3,.3,.3,-.3);let o=new Z;o.fill(-.5,-1.35,-.14,.5,.05,.02,(e,t,n)=>{let r=.34+.12*Math.min(1,-t);if(Math.abs(e)>r)return!1;let i=e/r*-.08*(e/r)-.04*-t;return n>i-Math.max(.05,Y*1.1)&&n<=i+.001},pp(e,-1.1,144));let s=t.head;for(let e=0;e<9;e++){let t=e/9*Math.PI*2,r=Math.sin(t)*.15,i=Math.cos(t)*.16-.02,a=.12+.08*ou(e,3,5);s.seg(r,.3,i,r*1.2,.3+a,i*1.2,.022,.01,n)}s.tubeY(0,-.02,.27,.33,.165,.18,1,$.skRust),s.fill(-.1,-.1,.05,.1,0,.2,(e,t,n)=>Iu(e,t,n,.03,145)>.6,$.skOoze,`paint`);let c=new Z;return c.jitter=.05,c.seg(0,-.55,0,0,1.12,0,.042,.04,(e,t,n)=>Math.abs(t)<.1||Math.abs(t-.45)<.1?$.leatherDark:Iu(e,t,n,.08,146)>.6?$.timber:$.timberDark),c.fill(-.13,-.8,-.03,.13,-.52,.03,(e,t)=>{let n=Math.hypot(e/.12,(t+.66)/.13);return n<1&&n>.62},$.timberDark),c.fill(-.25,1.08,-.08,.25,1.75,.06,(e,t,n)=>{let r=(t-1.08)/.67,i=.16+.07*Math.min(1,r*3)-.06*Math.max(0,r-.8)/.2,a=e/i*-.03*(e/i);return Math.abs(e)<i&&Math.abs(n-a)<.022&&!(r>.93&&ou(e/.03|0,9,1)>.6)},(e,t,r)=>t>1.68?$.ironLight:n(e,t,r)),c.box(-.06,1.02,-.05,.06,1.14,.05,$.ironDark),bp(t,[{bone:`weapon`,part:c},{bone:`cape`,part:o}])}var xm=[-.1,1.05,-.1,-.5,0,.1],Sm=[-.02,-.05,.75,2.1,0,0],Cm=[0,.2,.62,Math.PI-.12,0,0];function wm(e,t){let n=fu(Q(t,0,.5)),r=pu(Q(t,.5,.66)),i=mu(Q(t,.95,1.5));_u(e,xm,n*(1-r)),_u(e,Sm,r*(1-i));let a=n*(1-r),o=r*(1-i);e[J.tRX]+=-.35*a+.5*o,e[J.nRX]+=.25*a-.3*o,e[J.hY]+=.05*a-.22*o,e[J.hZ]+=.1*o,e[J.kL]+=.2*a+.7*o,e[J.kR]+=.2*a+.6*o,e[J.lLX]-=.1*a+.5*o,e[J.lRX]+=.3*o,e[J.cape]+=.5*o-.15*a,e[J.bS]-=.05*gu(t,.64,.67,.9)}function Tm(e,t){let n=mu(Q(t,0,.18))*(1-mu(Q(t,.9,1)));_u(e,Cm,n);let r=Math.sin(t*90)*.012*n;e[J.tRX]+=-.35*n+r,e[J.nRX]+=-.5*n,e[J.hY]+=.06*n,e[J.tRZ]+=r,e[J.aLZ]+=.2*n,e[J.aRZ]-=.2*n,e[J.cape]+=.35*n+Math.sin(t*23)*.08*n,e[J.glow]=hu(Q(t,.1,.3))*(1-hu(Q(t,.85,1)))}var Em={warden:wd,warden_shotgun:Ad,warden_sniper:qd,warden_knight:Id,warden_engineer:$d,warden_digger:uf,warden_sniper_xbow:Xd,warden_knight_great:Ud,warden_engineer_hammer:of,warden_digger_spray:pf,orc_grunt:bf,orc_brute:Ef,orc_archer:Pf,orc_shaman:Hf,orc_warchief:Xf,orc_bomber:lp,skeleton_warrior:Dp,skeleton_archer:Ip,skeleton_demolisher:Wp,skeleton_builder:Qp,skeleton_carver:am,skeleton_necromancer:fm,skeleton_hound:gm,skeleton_gravekeeper:{kind:`skeleton_gravekeeper`,defaultTint:2044721,height:3.4,rig:_m,parts:bm,hunch:.3,stance:.12,loco:{walkHz:.55,runHz:.85,stride:.36,runStride:.6,knee:.6,runKnee:1.05,bob:.07,armSwing:.25,lean:.15},carry:[-.2,.16,.4,-.9,0,.25],drop:[-.8,-.1,0,0,0,0],gripL:[0,.45,0],gripR:[0,0,0],poleL:[.9,-.5,-.3],poleR:[-.9,-.5,-.3],muzzle:{bone:`weapon`,p:[0,1.45,0]},attackDur:1.5,attack:wm,reload:Tm,deathDepth:.35}},Dm=(e,t)=>{let n=Em[e];if(!n)throw Error(`createCharacter: unknown kind ${e}`);return hd(n,t)};export{Be as $,vn as A,U as B,bi as C,Gt as D,ca as E,Mi as F,i as G,Jr as H,Hr as I,ua as J,co as K,Ka as L,_ as M,qa as N,nr as O,la as P,da as Q,Li as R,bt as S,Ke as T,wa as U,oi as V,Ca as W,pt as X,so as Y,Sa as Z,mr as _,yu as a,wr as at,Ao as b,lu as c,B as ct,ou as d,Ue as et,Ql as f,$n as g,ta as h,$ as i,Rr as it,un as j,yn as k,Y as l,V as lt,Fn as m,Em as n,xa as nt,eu as o,go as ot,Yl as p,ao as q,gd as r,fa as rt,$l as s,va as st,Dm as t,bn as tt,Z as u,Nt as ut,Zi as v,uo as w,W as x,na as y,Yi as z};